...
echo "".$ming."API微视短视频".$hh."";
echo "━━━━━━━━━".$hh."";
echo "标题：".$bt."".$hh."";
echo "作者：".$json["rsp_body"]["recommendfeeds"][$s]["poster"]["nick"]."".$hh."";
echo "图片：".$json["rsp_body"]["recommendfeeds"][$s]["images"][0]["url"]."".$hh."";
echo "播放链接：".$json["rsp_body"]["recommendfeeds"][$s]["video_url"]."".$hh."";
echo "━━━━━━━━━".$hh."";
