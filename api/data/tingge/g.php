...
$group=$_GET["group"];
$qq=$_GET["qq"];
$url="https://web.qun.qq.com/cgi-bin/media/set_media_state?t=0.7452077988770318&g_tk=".getGTK($skey)."&state=0&gcode={$group}&qua=V1_AND_SQ_8.4.8_1492_YYB_D&uin={$qq}&format=json&inCharset=utf-8&outCharset=utf-8";
