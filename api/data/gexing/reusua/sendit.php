...
$token=$_GET['token'];
$get=getGTK($skey);
$txt=file_get_contents("http://".$_SERVER['HTTP_HOST']."/api/data/gexing/reusut/mryy.php");
$url="https://mobile.qzone.qq.com/mood/publish_mood?qzonetoken=".$token."&g_tk=".$get;
$post='opr_type=publish_shuoshuo&res_uin='.$qq.'&content='.$txt.'&richval=&lat=0&lon=0&lbsid=&issyncweibo=0&format=json';
