...
preg_match_all('/"curlikekey":"(.*?)"/',$data,$tid);
$tid=$tid[1][0];
$url="https://h5.qzone.qq.com/proxy/domain/w.qzone.qq.com/cgi-bin/likes/internal_dolike_app?qzonetoken=&g_tk=".$get;
$post='opuin='.$qq.'&unikey='.$tid.'&curkey='.$tid.'&appid=311&opr_type=like&format=purejson';
$cookie='uin=o'.$qq.'; skey='.$skey.'; p_uin=o'.$qq.'; p_skey='.$pskey.';';
$data=post_result($url,$post,$cookie);
...
function post_result($url,$post,$cookie)
{
$ch = curl_init();
curl_setopt($ch, CURLOPT_URL, $url);
$header = array(
