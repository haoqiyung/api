...
if($id==null)
{
$url='https://zb.vip.qq.com/v2/proxy/domain/proxy.vip.qq.com/cgi-bin/srfentry.fcgi?daid=18&data=%7B%2213550%22%3A%7B%22req%22%3A%7B%22itemClass%22%3A22%2C%22platform%22%3A2%2C%22searchKey%22%3A%22'.$msg.'%22%2C%22writeHistoryFlag%22%3A0%2C%22pageIndex%22%3A0%2C%22pageItemNUm%22%3A40%7D%7D%7D&g_tk='.$gey;
...
if($result=="0")
{
echo "抱歉，没有找到[".$msg."]的相关浮屏，请修改关键词再试！";
}
else
{
echo "---浮屏搜索结果---\n";
...
{
$url='https://g.vip.qq.com/suspend_effect/setUserSuspendEffect?t=1588376026466&g_tk='.$get.'&p_tk='.$token.'&iSuspendId='.$id.'&opplat=2&version=8.3.5';
