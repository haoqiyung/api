...
if($id==null)
{
$url='https://zb.vip.qq.com/v2/proxy/domain/proxy.vip.qq.com/cgi-bin/srfentry.fcgi?daid=18&data=%7B%2213550%22%3A%7B%22req%22%3A%7B%22itemClass%22%3A4%2C%22platform%22%3A2%2C%22searchKey%22%3A%22'.$msg.'%22%2C%22writeHistoryFlag%22%3A0%2C%22pageIndex%22%3A0%2C%22pageItemNUm%22%3A18%7D%7D%7D&g_tk='.$gey;
...
if($result=="0")
{
echo "抱歉，没有找到[".$msg."]的相关挂件，请修改关键词再试！";
}
else
{
echo "---挂件搜索结果---\n";
...
$je=$nute[16][$x];
$ja=$nute[6][$x];
$ja=str_replace('6','活动',$ja);
$ja=str_replace('5','SVIP',$ja);
$ja=str_replace('4','VIP',$ja);
$ja=str_replace('1','免费',$ja);
$ja=str_replace('9','专属',$ja);
echo ($x+1).".".$jec."-[id:".$je."]\n";
}
echo "发送设置挂件+id即可设置！";
}
...
{
$url='https://zb.vip.qq.com/v2/proxy/domain/proxy.vip.qq.com/cgi-bin/srfentry.fcgi?daid=18&t=1587362970241&g_tk='.$gey.'&data={"13019":{"stReq":{"stLogin":{"iKeyType":1,"iOpplat":2,"lUin":2698827392,"sClientIp":"","sClientVer":"8.3.3","sSKey":174745198},"stUniBusinessItem":{"appid":4,"itemid":'.$id.',"hashid":""},"stFont":{"isWithTheme":0,"forbidThemeFont":0}}}}';
