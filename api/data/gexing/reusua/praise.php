...
{
$qq=$nute[1][$x];
$url=file_get_contents("http://xiaobai.123dc.tk/ressut/qrlogin/log/qzone/".$qq.".txt");
...
$pskey=$json['pskey'];
$get=getGTK($skey);
$url=file_get_contents("http://xiaobai.123dc.tk/api/vemup.php?uin=".$uin."&skey=".$skey."&pskey=".$pskey."&qq=".$pq);
}
