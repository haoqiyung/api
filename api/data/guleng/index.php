...
<head>
    ...
    <title><?php echo $ming; ?>API音乐-全网音乐免费下载免费听</title>
    <meta name="description" content="一款开源的基于网易云音乐api的在线音乐播放器。具有音乐搜索、播放、下载、歌词同步显示、个人音乐播放列表同步等功能。"/>
    <meta name="keywords" content="<?php echo $ming; ?>API音乐-全网音乐免费下载免费听播放器,在线音乐播放器,MKOnlinePlayer,网易云音乐,音乐api,音乐播放器源代码"/>
...
<!-- 头部logo -->
<div class="header">
    <div class="logo" title="Version 2.4; Based on Meting; Powered by <?php echo $ming; ?>API">
        ♫ <?php echo $ming; ?>APImusic
    </div>
</div>  <!--class="header"-->
    ...
    <div class="container">
        <div class="btn-bar">
            ...
            <div class="btn-box" id="btn-area">
                <span class="btn" data-action="player" hidden><?php echo $ming; ?>播放器</span>
        ...
        <div class="player" id="player">
            ...
            <div id="music-info" title="点击查看<?php echo $ming; ?>API音乐歌曲信息"></div>
        </div>
    </div>  <!--class="container"-->
</div>  <!--class="center"-->
