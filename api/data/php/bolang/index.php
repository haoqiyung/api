...
<h2 style="font-size:15px;word-break:break-all;padding:20px 32px;margin:0;text-align:center">网站添加波浪</h2>
</div>
...
<div id="hans-bolang"></div>
<script src="http://<?php echo $_SERVER['HTTP_HOST'];?>/api/data/php/bolang/api.php"></script>
