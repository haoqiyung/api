...
<h2 style="font-size:15px;word-break:break-all;padding:20px 32px;margin:0;text-align:center">网站添加雪花</h2>
</div>
...
代码1
<script src="http://<?php echo $_SERVER['HTTP_HOST'];?>/api/data/php/xuehua/api.php">

代码2
<script src='http://<?php echo $_SERVER['HTTP_HOST'];?>/api/data/php/xuehua/api.php'></script>
