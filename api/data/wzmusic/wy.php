...
echo $e="showGreeting = 1,defaultAlbum = 1,siteName = 'API',background = 1,playerWidth = -1,coverWidth = -1,showNotes = 1,autoPopupPlayer = -1;";
...
$json='{"songSheetName":"API","author":"API","songIds":[],"songNames":[],"songTypes":[],"albumNames":[],"artistNames":[],"albumCovers":[]}';
