...
<?php @$xsd = intval(file_get_contents("../api/tongji/jiekou/xsd.dat")); ?>
<?php @$xsdx = intval(file_get_contents("../api/tongji/jinri/".date("Y-m-d")."/xsd.dat")); ?>
...
<title>文字相似度检测 - <?php echo $ming; ?>API</title>
<meta name="keywords" content=""/>
<meta name="description" content="">    
<link rel="stylesheet" href="./assets/css/layer.css">
<script src="https://ku.oioweb.cn/LayUI/2.5.4/layui.all.js"></script>
<style>.url{word-break:break-all;cursor:pointer;margin-left:5px;color:#777;border:none;border-radius:0;border-bottom:2px solid #5FB878;}.simpleTable{line-height:20px;padding-bottom:16px;}.linep{font-size:14px;font-weight:700;color:#555;padding-left:14px;height:16px;line-height:16px;margin-bottom:18px;position:relative;margin-top:15px;}.linep:before{content:'';width:4px;height:16px;background:#00aeff;border-radius:2px;position:absolute;left:0;top:0;}::-wexsdit-scrollbar{width:9px;height:9px}::-wexsdit-scrollbar-track-piece{background-color:#ebebeb;-wexsdit-border-radius:4px}::-wexsdit-scrollbar-thumb:vertical{height:32px;background-color:#ccc;-wexsdit-border-radius:4px}::-wexsdit-scrollbar-thumb:horizontal{width:32px;background-color:#ccc;-wexsdit-border-radius:4px}</style>
</head>
<body>
<div class="layui-container">
<div class="layui-row">
<fieldset class="layui-elem-field layui-field-title" style="margin-top: 20px;">
<legend>文字相似度检测API</legend>
</fieldset>
<blockquote class="layui-elem-quote">本接口总调用：<?php echo $xsd; ?>次·今日调用：<?php echo $xsdx; ?>次</blockquote>
</div>
...
<span class="url" data-clipboard-text="http://<?php echo $_SERVER['HTTP_HOST'];?>/api/xsd.php">http://<?php echo $_SERVER['HTTP_HOST'];?>/api/xsd.php</span>
</p>
<p class="simpleTable">
...
<span class="url" data-clipboard-text="http://<?php echo $_SERVER['HTTP_HOST'];?>/api/xsd.php?bjc=吉云&xjc=星猫">http://<?php echo $_SERVER['HTTP_HOST'];?>/api/xsd.php?bjc=吉云&xjc=星猫</span>
</p>
...
<tbody>
<tr><td>bjc</td><td>是</td><td>被检测的文字段(相当于被除数)</td></tr>
<tr><td>xjc</td><td>是</td><td>需要检测的文字段(相当于除数)</td></tr>
</tbody>
</table>
...
$result = file_get_contents("http://".$_SERVER['HTTP_HOST']."/api/xsd.php?bjc=吉云&xjc=星猫");
echo $result;
?></pre>
</div>
...
<pre class="layui-code"><a style="color:#fd4b5c;text-decoration:none；" target="_blank">文字相似度检测
<?php echo $ming; ?>API文字相似度检测\n
━━━━━━━━━\n
用户:@%昵称%\n
━━━━━━━━━\n
文字相似度检测 [被除] [除]\n
━━━━━━━━━\n
请求示例：http://<?php echo $_SERVER['HTTP_HOST'];?>/tianyi/xsd.php\n
━━━━━━━━━\n
...
用户:@%昵称%\n
━━━━━━━━━\n
$访问 http://<?php echo $_SERVER['HTTP_HOST'];?>/api/xsd.php?bjc=%参数1%&xjc=%参数2%$\n
━━━━━━━━━\n
