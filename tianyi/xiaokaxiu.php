...
<?php @$weibo = intval(file_get_contents("../api/tongji/jiekou/xiaokaxiu.dat")); ?>
<?php @$weibox = intval(file_get_contents("../api/tongji/jinri/".date("Y-m-d")."/xiaokaxiu.dat")); ?>
...
<title>小咖秀无水印解析 - <?php echo $ming; ?>API</title>
...
<legend>小咖秀无水印解析API</legend>
</fieldset>
<blockquote class="layui-elem-quote">本接口总调用：<?php echo $weibo; ?>次·今日调用：<?php echo $weibox; ?>次</blockquote>
</div>
...
<span class="url" data-clipboard-text="http://<?php echo $_SERVER['HTTP_HOST'];?>/api/xiaokaxiu.php">http://<?php echo $_SERVER['HTTP_HOST'];?>/api/xiaokaxiu.php</span>
</p>
<p class="simpleTable">
...
<span class="url" data-clipboard-text="http://<?php echo $_SERVER['HTTP_HOST'];?>/api/xiaokaxiu.php?url=https://mobile.xiaokaxiu.com/video?id=6816651669661601792">http://<?php echo $_SERVER['HTTP_HOST'];?>/api/xiaokaxiu.php?url=https://mobile.xiaokaxiu.com/video?id=6816651669661601792</span>
</p>
...
<tbody>
<tr><td>url</td><td>是</td><td>需要解析的视频链接</td></tr>
...
$result = file_get_contents("http://".$_SERVER['HTTP_HOST']."/api/xiaokaxiu.php?url=https://mobile.xiaokaxiu.com/video?id=6816651669661601792");
echo $result;
?></pre>
</div>
...
<pre class="layui-code"><a style="color:#fd4b5c;text-decoration:none；" target="_blank">小咖秀无水印解析
<?php echo $ming; ?>API小咖秀无水印解析\n
━━━━━━━━━\n
用户:@%昵称%\n
━━━━━━━━━\n
小咖秀无水印解析 [链接]\n
━━━━━━━━━\n
请求示例：http://<?php echo $_SERVER['HTTP_HOST'];?>/tianyi/xiaokaxiu.php\n
━━━━━━━━━\n
Tips:<?php echo $ming; ?>API技术支持

小咖秀无水印解析 .*
$访问 http://<?php echo $_SERVER['HTTP_HOST'];?>/api/xiaokaxiu.php?url=%参数1%$</per>
</div>
</div>
</div>
</div>
