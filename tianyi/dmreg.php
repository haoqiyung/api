...
<?php @$dmreg = intval(file_get_contents("../api/tongji/jiekou/dmreg.dat")); ?>
<?php @$dmregx = intval(file_get_contents("../api/tongji/jinri/".date("Y-m-d")."/dmreg.dat")); ?>
...
<title>域名注册查询 - <?php echo $ming; ?>API</title>
...
<legend>域名注册查询API</legend>
</fieldset>
<blockquote class="layui-elem-quote">本接口总调用：<?php echo $dmreg; ?>次·今日调用：<?php echo $dmregx; ?>次</blockquote>
</div>
...
<span class="url" data-clipboard-text="http://<?php echo $_SERVER['HTTP_HOST'];?>/api/dmreg.php">http://<?php echo $_SERVER['HTTP_HOST'];?>/api/dmreg.php</span>
</p>
<p class="simpleTable">
...
<span class="url" data-clipboard-text="http://<?php echo $_SERVER['HTTP_HOST'];?>/api/dmreg.php?url=https://cloud.vpsidc.com.cn">http://<?php echo $_SERVER['HTTP_HOST'];?>/api/dmreg.php?url=https://cloud.vpsidc.com.cn</span>
</p>
...
$result = file_get_contents("http://".$_SERVER['HTTP_HOST']."/api/dmreg.php?url=https://cloud.vpsidc.com.cn");
echo $result;
?></pre>
</div>
...
<pre class="layui-code"><a style="color:#fd4b5c;text-decoration:none；" target="_blank">域名注册查询
<?php echo $ming; ?>API域名注册查询\n
━━━━━━━━━\n
用户:@%昵称%\n
━━━━━━━━━\n
域名注册查询 [网址]\n
━━━━━━━━━\n
请求示例：http://<?php echo $_SERVER['HTTP_HOST'];?>/tianyi/dmreg.php\n
━━━━━━━━━\n
Tips:<?php echo $ming; ?>API技术支持

域名注册查询 .*
$访问 http://<?php echo $_SERVER['HTTP_HOST'];?>/api/dmreg.php?url=%参数1%$</per>
</div>
</div>
</div>
</div>
