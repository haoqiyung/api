...
<?php @$zt2 = intval(file_get_contents("../api/tongji/jiekou/zt2.dat")); ?>
<?php @$zt2x = intval(file_get_contents("../api/tongji/jinri/".date("Y-m-d")."/zt2.dat")); ?>
...
<title>网站状态码查询 - <?php echo $ming; ?>API</title>
...
<legend>网站状态码查询API</legend>
</fieldset>
<blockquote class="layui-elem-quote">本接口总调用：<?php echo $zt2; ?>次·今日调用：<?php echo $zt2x; ?>次</blockquote>
</div>
...
<span class="url" data-clipboard-text="http://<?php echo $_SERVER['HTTP_HOST'];?>/api/zt2.php">http://<?php echo $_SERVER['HTTP_HOST'];?>/api/zt2.php</span>
</p>
<p class="simpleTable">
...
<span class="url" data-clipboard-text="http://<?php echo $_SERVER['HTTP_HOST'];?>/api/zt2.php?url=https://cloud.vpsidc.com.cn">http://<?php echo $_SERVER['HTTP_HOST'];?>/api/zt2.php?url=https://cloud.vpsidc.com.cn</span>
</p>
...
<tbody>
<tr><td>url</td><td>是</td><td>需要查询的IP/域名</td></tr>
...
$result = file_get_contents("http://".$_SERVER['HTTP_HOST']."/api/zt2.php?url=https://cloud.vpsidc.com.cn");
echo $result;
?></pre>
</div>
...
<pre class="layui-code"><a style="color:#fd4b5c;text-decoration:none；" target="_blank">网站状态码查询
<?php echo $ming; ?>API网站状态码查询\n
━━━━━━━━━\n
用户:@%昵称%\n
━━━━━━━━━\n
网站状态码查询 [域名/IP]\n
━━━━━━━━━\n
请求示例：http://<?php echo $_SERVER['HTTP_HOST'];?>/tianyi/zt2.php\n
━━━━━━━━━\n
Tips:<?php echo $ming; ?>API技术支持

网站状态码查询
$访问 http://<?php echo $_SERVER['HTTP_HOST'];?>/api/zt2.php?url=%参数1%$</per>
</div>
</div>
</div>
</div>
