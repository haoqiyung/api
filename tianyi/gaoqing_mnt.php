...
<?php @$gaoqing_mnt = intval(file_get_contents("../api/tongji/jiekou/gaoqing_mnt.dat")); ?>
<?php @$gaoqing_mntx = intval(file_get_contents("../api/tongji/jinri/".date("Y-m-d")."/gaoqing_mnt.dat")); ?>
...
<title>高清妹子图 - <?php echo $ming; ?>API</title>
...
<legend>高清妹子图API</legend>
</fieldset>
<blockquote class="layui-elem-quote">本接口总调用：<?php echo $gaoqing_mnt; ?>次·今日调用：<?php echo $gaoqing_mntx; ?>次</blockquote>
</div>
...
<span class="url" data-clipboard-text="http://<?php echo $_SERVER['HTTP_HOST'];?>/api/gaoqing_mnt.php">http://<?php echo $_SERVER['HTTP_HOST'];?>/api/gaoqing_mnt.php</span>
</p>
<p class="simpleTable">
...
<pre class="layui-code"><img src="../api/gaoqing_mnt.php" style="width: 45%;"></pre>
</div>
...
<pre class="layui-code"><a style="color:#fd4b5c;text-decoration:none；" target="_blank">高清妹子图
<?php echo $ming; ?>API高清妹子图\n
━━━━━━━━━\n
用户:@%昵称%\n
━━━━━━━━━\n
±img=http://<?php echo $_SERVER['HTTP_HOST'];?>/api/gaoqing_mnt.php±\n
━━━━━━━━━\n
请求示例：http://<?php echo $_SERVER['HTTP_HOST'];?>/tianyi/gaoqing_mnt.php\n
━━━━━━━━━\n
