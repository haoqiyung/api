...
<?php @$yanzheng = intval(file_get_contents("../api/tongji/jiekou/yanzheng.dat")); ?>
<?php @$yanzhengx = intval(file_get_contents("../api/tongji/jinri/".date("Y-m-d")."/yanzheng.dat")); ?>
...
<title>随机验证码 - <?php echo $ming; ?>API</title>
...
<legend>随机验证码API</legend>
</fieldset>
<blockquote class="layui-elem-quote">本接口总调用：<?php echo $yanzheng; ?>次·今日调用：<?php echo $yanzhengx; ?>次</blockquote>
</div>
...
<span class="url" data-clipboard-text="http://<?php echo $_SERVER['HTTP_HOST'];?>/api/yanzheng.php">http://<?php echo $_SERVER['HTTP_HOST'];?>/api/yanzheng.php</span>
</p>
<p class="simpleTable">
...
$result = file_get_contents("http://".$_SERVER['HTTP_HOST']."/api/yanzheng.php");
echo $result;
?></pre>
</pre>
</div>
...
<pre class="layui-code"><a style="color:#fd4b5c;text-decoration:none；" target="_blank">随机验证码
<?php echo $ming; ?>API随机验证码\n
━━━━━━━━━\n
用户:@%昵称%\n
━━━━━━━━━\n
$访问 http://<?php echo $_SERVER['HTTP_HOST'];?>/api/yanzheng.php$\n
━━━━━━━━━\n
请求示例：http://<?php echo $_SERVER['HTTP_HOST'];?>/tianyi/yanzheng.php\n
━━━━━━━━━\n
