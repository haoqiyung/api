...
<?php @$shouji = intval(file_get_contents("../api/tongji/jiekou/shouji.dat")); ?>
<?php @$shoujix = intval(file_get_contents("../api/tongji/jinri/".date("Y-m-d")."/shouji.dat")); ?>
...
<title>随机谜语 - <?php echo $ming; ?>API</title>
...
<legend>随机谜语API</legend>
</fieldset>
<blockquote class="layui-elem-quote">本接口总调用：<?php echo $shouji; ?>次·今日调用：<?php echo $shoujix; ?>次</blockquote>
</div>
...
<span class="url" data-clipboard-text="http://<?php echo $_SERVER['HTTP_HOST'];?>/api/shouji/shouji.php">http://<?php echo $_SERVER['HTTP_HOST'];?>/api/shouji/shouji.php</span>
</p>
<p class="simpleTable">
...
<span class="url" data-clipboard-text="http://<?php echo $_SERVER['HTTP_HOST'];?>/api/shouji.php">http://<?php echo $_SERVER['HTTP_HOST'];?>/api/shouji.php</span>
</p>
...
$result = file_get_contents("http://".$_SERVER['HTTP_HOST']."/api/shouji.php");
echo $result;
?></pre>
</div>
...
<pre class="layui-code"><a style="color:#fd4b5c;text-decoration:none；" target="_blank">随机谜语
$访问 http://<?php echo $_SERVER['HTTP_HOST'];?>/api/shouji.php$</per>
</div>
</div>
</div>
</div>
