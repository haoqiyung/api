...
<?php @$renjian = intval(file_get_contents("../api/tongji/jiekou/renjian.dat")); ?>
<?php @$renjianx = intval(file_get_contents("../api/tongji/jinri/".date("Y-m-d")."/renjian.dat")); ?>
...
<title>我在人间凑数的日子 - <?php echo $ming; ?>API</title>
...
<legend>我在人间凑数的日子API</legend>
</fieldset>
<blockquote class="layui-elem-quote">本接口总调用：<?php echo $renjian; ?>次·今日调用：<?php echo $renjianx; ?>次</blockquote>
</div>
...
<span class="url" data-clipboard-text="http://<?php echo $_SERVER['HTTP_HOST'];?>/api/renjian.php">http://<?php echo $_SERVER['HTTP_HOST'];?>/api/renjian.php</span>
</p>
<p class="simpleTable">
...
$result = file_get_contents("http://".$_SERVER['HTTP_HOST']."/api/renjian.php");
echo $result;
?></pre>
</div>
...
<pre class="layui-code"><a style="color:#fd4b5c;text-decoration:none；" target="_blank">我在人间凑数的日子
$访问 http://<?php echo $_SERVER['HTTP_HOST'];?>/api/renjian.php$</per>
</div>
</div>
</div>
</div>
