...
<title>个人主页生成 - <?php echo $ming; ?>API</title>
...
<span class="url" data-clipboard-text="http://<?php echo $_SERVER['HTTP_HOST'];?>/api/data/zhuye/zhuye.php">http://<?php echo $_SERVER['HTTP_HOST'];?>/api/data/zhuye/zhuye.php</span>
</p>
<p class="simpleTable">
...
<span class="url" data-clipboard-text="http://<?php echo $_SERVER['HTTP_HOST'];?>/api/data/zhuye/zhuye.php?name=<?php echo $ming; ?>API&msg=生而为人 我很抱歉&ua=吉云服务器&url=https://cloud.vpsidc.com.cn&qq=<?php echo $kefu; ?>">http://<?php echo $_SERVER['HTTP_HOST'];?>/api/data/zhuye/zhuye.php?name=<?php echo $ming; ?>API&msg=生而为人 我很抱歉&ua=吉云服务器&url=https://cloud.vpsidc.com.cn&qq=<?php echo $kefu; ?></span>
</p>
...
<tr><td>msg</td><td>是</td><td>介绍语</td></tr>
<tr><td>ua</td><td>是</td><td>按钮名称</td></tr>
<tr><td>url</td><td>是</td><td>按钮链接</td></tr>
<tr><td>qq</td><td>是</td><td>QQ号</td></tr>
</tbody>
</table>
