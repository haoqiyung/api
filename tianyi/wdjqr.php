...
<?php @$wdjqr = intval(file_get_contents("../api/tongji/jiekou/wdjqr.dat")); ?>
<?php @$wdjqrx = intval(file_get_contents("../api/tongji/jinri/".date("Y-m-d")."/wdjqr.dat")); ?>
...
<title>茉莉机器人 - <?php echo $ming; ?>API</title>
...
<legend>茉莉机器人API</legend>
</fieldset>
<blockquote class="layui-elem-quote">本接口总调用：<?php echo $wdjqr; ?>次·今日调用：<?php echo $wdjqrx; ?>次</blockquote>
</div>
...
<span class="url" data-clipboard-text="http://<?php echo $_SERVER['HTTP_HOST'];?>/api/wdjqr.php">http://<?php echo $_SERVER['HTTP_HOST'];?>/api/wdjqr.php</span>
</p>
<p class="simpleTable">
...
<span class="url" data-clipboard-text="http://<?php echo $_SERVER['HTTP_HOST'];?>/api/wdjqr.php?msg=吉云">http://<?php echo $_SERVER['HTTP_HOST'];?>/api/wdjqr.php?msg=吉云</span>
</p>
...
$result = file_get_contents("http://".$_SERVER['HTTP_HOST']."/api/wdjqr.php?msg=吉云");
echo $result;
?></pre>
</div>
...
<pre class="layui-code"><a style="color:#fd4b5c;text-decoration:none；" target="_blank">茉莉机器人
<?php echo $ming; ?>API茉莉机器人\n
━━━━━━━━━\n
用户:@%昵称%\n
━━━━━━━━━\n
茉莉机器人 [内容]\n
━━━━━━━━━\n
请求示例：http://<?php echo $_SERVER['HTTP_HOST'];?>/tianyi/wdjqr.php\n
━━━━━━━━━\n
Tips:<?php echo $ming; ?>API技术支持

茉莉机器人 .*
$访问 http://<?php echo $_SERVER['HTTP_HOST'];?>/api/wdjqr.php?msg=%参数1%$</per>
</div>
</div>
</div>
</div>
