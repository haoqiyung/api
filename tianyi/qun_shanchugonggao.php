...
<?php @$qun_shanchugonggao = intval(file_get_contents("../api/tongji/jiekou/qun_shanchugonggao.dat")); ?>
<?php @$qun_shanchugonggaox = intval(file_get_contents("../api/tongji/jinri/".date("Y-m-d")."/qun_shanchugonggao.dat")); ?>
...
<title>QQ群公告删除 - <?php echo $ming; ?>API</title>
...
<legend>QQ群公告删除API</legend>
</fieldset>
<blockquote class="layui-elem-quote">本接口总调用：<?php echo $qun_shanchugonggao; ?>次·今日调用：<?php echo $qun_shanchugonggaox; ?>次</blockquote>
</div>
...
<span class="url" data-clipboard-text="http://<?php echo $_SERVER['HTTP_HOST'];?>/api/qun_shanchugonggao.php">http://<?php echo $_SERVER['HTTP_HOST'];?>/api/qun_shanchugonggao.php</span>
</p>
<p class="simpleTable">
...
<span class="url" data-clipboard-text="http://<?php echo $_SERVER['HTTP_HOST'];?>/api/qun_shanchugonggao.php?qq=[QQ]&skey=[SKEY]&pskey=[PSKEY]&group=[群号]&fid=[公告的fid]">http://<?php echo $_SERVER['HTTP_HOST'];?>/api/qun_shanchugonggao.php?qq=[QQ]&skey=[SKEY]&pskey=[PSKEY]&group=[群号]&fid=[公告的fid]</span>
</p>
...
<tr><td>pskey</td><td>是</td><td>登录者的pskey</td></tr>
<tr><td>group</td><td>是</td><td>操作群号</td></tr>
<tr><td>fid</td><td>是</td><td>公告的fid</td></tr>
...
<pre class="layui-code"><a style="color:#fd4b5c;text-decoration:none；" target="_blank">QQ群公告删除
<?php echo $ming; ?>API♧QQ群公告删除\n
━━━━━━━━━\n
用户:@%昵称%\n
━━━━━━━━━\n
QQ群公告删除 [公告的fid]\n
━━━━━━━━━\n
请求示例：http://<?php echo $_SERVER['HTTP_HOST'];?>/tianyi/qun_shanchugonggao.php\n
━━━━━━━━━\n
...
P:@P[pskey]
P:@P[qun.qq.com]
$访问 http://<?php echo $_SERVER['HTTP_HOST'];?>/api/qun_shanchugonggao.php?qq=%Robot%&skey=%Skey%&pskey=%P%&group=%群号%&fid=%参数1%$</per>
</div>
</div>
</div>
</div>
