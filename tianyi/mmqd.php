...
<?php @$mmqd = intval(file_get_contents("../api/tongji/jiekou/mmqd.dat")); ?>
<?php @$mmqdx = intval(file_get_contents("../api/tongji/jinri/".date("Y-m-d")."/mmqd.dat")); ?>
...
<title>密码强度查询 - <?php echo $ming; ?>API</title>
...
<legend>密码强度查询API</legend>
</fieldset>
<blockquote class="layui-elem-quote">本接口总调用：<?php echo $mmqd; ?>次·今日调用：<?php echo $mmqdx; ?>次</blockquote>
</div>
...
<span class="url" data-clipboard-text="http://<?php echo $_SERVER['HTTP_HOST'];?>/api/mmqd.php">http://<?php echo $_SERVER['HTTP_HOST'];?>/api/mmqd.php</span>
</p>
<p class="simpleTable">
...
<span class="url" data-clipboard-text="http://<?php echo $_SERVER['HTTP_HOST'];?>/api/mmqd.php?mm=tianyi719&type=">http://<?php echo $_SERVER['HTTP_HOST'];?>/api/mmqd.php?mm=tianyi719&type=</span>
</p>
...
<tbody>
<tr><td>mm</td><td>是</td><td>需要查询的密码</td></tr>
<tr><td>type</td><td>否</td><td>输json(默认text返回)</td></tr>
...
$result = file_get_contents("http://".$_SERVER['HTTP_HOST']."/api/mmqd.php?mm=tianyi719&type=");
echo $result;
?></pre>
</div>
...
<pre class="layui-code"><a style="color:#fd4b5c;text-decoration:none；" target="_blank">密码强度查询
<?php echo $ming; ?>API密码强度查询\n
━━━━━━━━━\n
用户:@%昵称%\n
━━━━━━━━━\n
密码强度查询 [密码]\n
━━━━━━━━━\n
请求示例：http://<?php echo $_SERVER['HTTP_HOST'];?>/tianyi/mmqd.php\n
━━━━━━━━━\n
...
用户:@%昵称%\n
━━━━━━━━━\n
$访问 http://<?php echo $_SERVER['HTTP_HOST'];?>/api/mmqd.php?mm=%参数1%&type=$\n
━━━━━━━━━\n
