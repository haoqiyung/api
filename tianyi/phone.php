...
<?php @$phone = intval(file_get_contents("../api/tongji/jiekou/phone.dat")); ?>
<?php @$phonex = intval(file_get_contents("../api/tongji/jinri/".date("Y-m-d")."/phone.dat")); ?>
...
<span class="url" data-clipboard-text="http://<?php echo $_SERVER['HTTP_HOST'];?>/api/phone.php">http://<?php echo $_SERVER['HTTP_HOST'];?>/api/phone.php</span>
</p>
<p class="simpleTable">
...
<span class="url" data-clipboard-text="http://<?php echo $_SERVER['HTTP_HOST'];?>/api/phone.php?id=13756953687">http://<?php echo $_SERVER['HTTP_HOST'];?>/api/phone.php?id=13756953687</span>
</p>
...
<tbody>
<tr><td>id</td><td>是</td><td>需要查询的手机号</td></tr>
...
$result = file_get_contents("http://".$_SERVER['HTTP_HOST']."/api/phone.php?id=13756953687");
echo $result;
?></pre>
</div>
...
<pre class="layui-code"><a style="color:#fd4b5c;text-decoration:none；" target="_blank">手机号归属地
<?php echo $ming; ?>API手机号归属地\n
━━━━━━━━━\n
用户:@%昵称%\n
━━━━━━━━━\n
手机号归属地 [手机号]\n
━━━━━━━━━\n
请求示例：http://<?php echo $_SERVER['HTTP_HOST'];?>/tianyi/phone.php\n
━━━━━━━━━\n
Tips:<?php echo $ming; ?>API技术支持

手机号归属地 .*
$访问 http://<?php echo $_SERVER['HTTP_HOST'];?>/api/phone.php?name=%参数1%$</per>
</div>
</div>
</div>
</div>
