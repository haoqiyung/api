...
<?php @$wtqh = intval(file_get_contents("../api/tongji/jiekou/wtqh.dat")); ?>
<?php @$wtqhx = intval(file_get_contents("../api/tongji/jinri/".date("Y-m-d")."/wtqh.dat")); ?>
...
<title>微甜情话 - <?php echo $ming; ?>API</title>
...
<legend>微甜情话API</legend>
</fieldset>
<blockquote class="layui-elem-quote">本接口总调用：<?php echo $wtqh; ?>次·今日调用：<?php echo $wtqhx; ?>次</blockquote>
</div>
...
<span class="url" data-clipboard-text="http://<?php echo $_SERVER['HTTP_HOST'];?>/api/wtqh.php">http://<?php echo $_SERVER['HTTP_HOST'];?>/api/wtqh.php</span>
</p>
<p class="simpleTable">
...
$result = file_get_contents("http://".$_SERVER['HTTP_HOST']."/api/wtqh.php");
echo $result;
?></pre>
</div>
...
<pre class="layui-code"><a style="color:#fd4b5c;text-decoration:none；" target="_blank">微甜情话
<?php echo $ming; ?>API微甜情话\n
━━━━━━━━━\n
用户:@%昵称%\n
━━━━━━━━━\n
$访问 http://<?php echo $_SERVER['HTTP_HOST'];?>/api/wtqh.php$\n
━━━━━━━━━\n
请求示例：http://<?php echo $_SERVER['HTTP_HOST'];?>/tianyi/wtqh.php\n
━━━━━━━━━\n
