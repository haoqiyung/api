...
<?php @$ping = intval(file_get_contents("../api/tongji/jiekou/ping.dat")); ?>
<?php @$pingx = intval(file_get_contents("../api/tongji/jinri/".date("Y-m-d")."/ping.dat")); ?>
...
<span class="url" data-clipboard-text="http://<?php echo $_SERVER['HTTP_HOST'];?>/api/ping.php">http://<?php echo $_SERVER['HTTP_HOST'];?>/api/ping.php</span>
</p>
<p class="simpleTable">
...
<span class="url" data-clipboard-text="http://<?php echo $_SERVER['HTTP_HOST'];?>/api/ping.php?url=http://baidu.com">http://<?php echo $_SERVER['HTTP_HOST'];?>/api/ping.php?url=http://baidu.com</span>
</p>
...
<tbody>
<tr><td>url</td><td>是</td><td>需要查询的域名</td></tr>
...
$result = file_get_contents("http://".$_SERVER['HTTP_HOST']."/api/ping.php?url=http://baidu.com");
echo $result;
?></pre>
</div>
...
<pre class="layui-code"><a style="color:#fd4b5c;text-decoration:none；" target="_blank">Ping网站测速
<?php echo $ming; ?>API♧Ping网站测速\n
━━━━━━━━━\n
用户:@%昵称%\n
━━━━━━━━━\n
Ping网站测速 [链接]\n
━━━━━━━━━\n
请求示例：http://<?php echo $_SERVER['HTTP_HOST'];?>/tianyi/ping.php\n
━━━━━━━━━\n
Tips:<?php echo $ming; ?>API技术支持

Ping网站测速 .*
$访问 http://<?php echo $_SERVER['HTTP_HOST'];?>/api/ping.php?name=%参数1%$</per>
</div>
</div>
</div>
</div>
