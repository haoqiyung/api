...
<?php @$kge = intval(file_get_contents("../api/tongji/jiekou/kge.dat")); ?>
<?php @$kgex = intval(file_get_contents("../api/tongji/jinri/".date("Y-m-d")."/kge.dat")); ?>
...
<title>全民K歌全能解析 - <?php echo $ming; ?>API</title>
...
<legend>全民K歌全能解析API</legend>
</fieldset>
<blockquote class="layui-elem-quote">本接口总调用：<?php echo $kge; ?>次·今日调用：<?php echo $kgex; ?>次</blockquote>
</div>
...
<span class="url" data-clipboard-text="http://<?php echo $_SERVER['HTTP_HOST'];?>/api/kge.php">http://<?php echo $_SERVER['HTTP_HOST'];?>/api/kge.php</span>
</p>
<p class="simpleTable">
...
<span class="url" data-clipboard-text="http://<?php echo $_SERVER['HTTP_HOST'];?>/api/kge.php?url=https://node.kg.qq.com/play?s=Au5DmEAmZfe4iAmS&g_f=personal">http://<?php echo $_SERVER['HTTP_HOST'];?>/api/kge.php?url=https://node.kg.qq.com/play?s=Au5DmEAmZfe4iAmS&g_f=personal</span>
</p>
...
$result = file_get_contents("http://".$_SERVER['HTTP_HOST']."/api/kge.php?url=https://node.kg.qq.com/play?s=Au5DmEAmZfe4iAmS&g_f=personal");
echo $result;
?></pre>
</div>
