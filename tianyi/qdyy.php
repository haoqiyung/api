...
<?php @$qdyy = intval(file_get_contents("../api/tongji/jiekou/qdyy.dat")); ?>
<?php @$qdyyx = intval(file_get_contents("../api/tongji/jinri/".date("Y-m-d")."/qdyy.dat")); ?>
...
<title>应用启动 - <?php echo $ming; ?>API</title>
...
<legend>应用启动API</legend>
</fieldset>
<blockquote class="layui-elem-quote">本接口总调用：<?php echo $qdyy; ?>次·今日调用：<?php echo $qdyyx; ?>次</blockquote>
</div>
...
<span class="url" data-clipboard-text="http://<?php echo $_SERVER['HTTP_HOST'];?>/api/qdyy.php">http://<?php echo $_SERVER['HTTP_HOST'];?>/api/qdyy.php</span>
</p>
<p class="simpleTable">
...
<span class="url" data-clipboard-text="http://<?php echo $_SERVER['HTTP_HOST'];?>/api/qdyy.php?msg=吉云">http://<?php echo $_SERVER['HTTP_HOST'];?>/api/qdyy.php?msg=吉云</span>
</p>
...
<tbody>
<tr><td>msg</td><td>是</td><td>需要启动的应用名</td></tr>
</tbody>
</table>
...
<pre class="layui-code"><a style="color:#fd4b5c;text-decoration:none；" target="_blank">应用启动
<?php echo $ming; ?>API应用启动\n
━━━━━━━━━\n
用户:@%昵称%\n
━━━━━━━━━\n
应用启动 [应用名]\n
━━━━━━━━━\n
请求示例：http://<?php echo $_SERVER['HTTP_HOST'];?>/tianyi/qdyy.php\n
━━━━━━━━━\n
Tips:<?php echo $ming; ?>API技术支持

应用启动 .*
$访问 http://<?php echo $_SERVER['HTTP_HOST'];?>/api/qdyy.php?msg=%参数1%$</per>
</div>
</div>
</div>
</div>
