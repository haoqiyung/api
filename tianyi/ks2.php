...
<?php @$ks2 = intval(file_get_contents("../api/tongji/jiekou/ks2.dat")); ?>
<?php @$ks2x = intval(file_get_contents("../api/tongji/jinri/".date("Y-m-d")."/ks2.dat")); ?>
...
<title>快手推荐视频 - <?php echo $ming; ?>API</title>
...
<legend>快手推荐视频API</legend>
</fieldset>
<blockquote class="layui-elem-quote">本接口总调用：<?php echo $ks2; ?>次·今日调用：<?php echo $ks2x; ?>次</blockquote>
</div>
...
<span class="url" data-clipboard-text="http://<?php echo $_SERVER['HTTP_HOST'];?>/api/ks2.php">http://<?php echo $_SERVER['HTTP_HOST'];?>/api/ks2.php</span>
</p>
<p class="simpleTable">
...
$result = file_get_contents("http://".$_SERVER['HTTP_HOST']."/api/ks2.php");
echo $result;
?></pre>
</div>
...
<pre class="layui-code"><a style="color:#fd4b5c;text-decoration:none；" target="_blank">快手推荐视频
<?php echo $ming; ?>API快手推荐视频\n
━━━━━━━━━\n
用户:@%昵称%\n
━━━━━━━━━\n
$访问 http://<?php echo $_SERVER['HTTP_HOST'];?>/api/ks2.php$
━━━━━━━━━\n
请求示例：http://<?php echo $_SERVER['HTTP_HOST'];?>/tianyi/ks2.php\n
━━━━━━━━━\n
