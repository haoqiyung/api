...
<?php @$Ren = intval(file_get_contents("../api/tongji/jiekou/Ren.dat")); ?>
<?php @$Renx = intval(file_get_contents("../api/tongji/jinri/".date("Y-m-d")."/Ren.dat")); ?>
...
<span class="url" data-clipboard-text="http://<?php echo $_SERVER['HTTP_HOST'];?>/api/Ren.php">http://<?php echo $_SERVER['HTTP_HOST'];?>/api/Ren.php</span>
</p>
<p class="simpleTable">
...
<span class="url" data-clipboard-text="http://<?php echo $_SERVER['HTTP_HOST'];?>/api/Ren.php?name=吉云">http://<?php echo $_SERVER['HTTP_HOST'];?>/api/Ren.php?name=吉云</span>
</p>
...
<tbody>
<tr><td>name</td><td>String</td><td>是</td><td>评定名字</td></tr>
<tr><td>type</td><td>String</td><td>否</td><td>返回格式默认text可选json</td></tr>
...
$result = file_get_contents("http://".$_SERVER['HTTP_HOST']."/api/Ren.php?name=吉云");
echo $result;
?></pre>
</div>
...
<tr><td>-1</td><td>缺少参数name</td></tr>
</tbody>
</table>
</div>
<div class="layui-tab-item">
<p class="linep">机器人词库示例：</p>
<pre class="layui-code"><a style="color:#fd4b5c;text-decoration:none；" target="_blank">人品走势
<?php echo $ming; ?>API人品走势\n
━━━━━━━━━\n
用户:@%昵称%\n
━━━━━━━━━\n
人品走势 [内容]\n
━━━━━━━━━\n
请求示例：http://<?php echo $_SERVER['HTTP_HOST'];?>/tianyi/Ren.php\n
━━━━━━━━━\n
Tips:<?php echo $ming; ?>API技术支持

人品走势 .*
$访问 http://<?php echo $_SERVER['HTTP_HOST'];?>/api/Ren.php?name=%参数1%$</per>
</div>
</div>
</div>
</div>
