...
<?php @$myzml = intval(file_get_contents("../api/tongji/jiekou/myzml.dat")); ?>
<?php @$myzmlx = intval(file_get_contents("../api/tongji/jinri/".date("Y-m-d")."/myzml.dat")); ?>
...
<title>每日正能量 - <?php echo $ming; ?>API</title>
...
<legend>每日正能量API</legend>
</fieldset>
<blockquote class="layui-elem-quote">本接口总调用：<?php echo $myzml; ?>次·今日调用：<?php echo $myzmlx; ?>次</blockquote>
</div>
...
<span class="url" data-clipboard-text="http://<?php echo $_SERVER['HTTP_HOST'];?>/api/myzml.php">http://<?php echo $_SERVER['HTTP_HOST'];?>/api/myzml.php</span>
</p>
<p class="simpleTable">
...
$result = file_get_contents("http://".$_SERVER['HTTP_HOST']."/api/myzml.php");
echo $result;
?></pre>
</div>
...
<pre class="layui-code"><a style="color:#fd4b5c;text-decoration:none；" target="_blank">每日正能量
$访问 http://<?php echo $_SERVER['HTTP_HOST'];?>/api/myzml.php$</per>
</div>
</div>
</div>
</div>
