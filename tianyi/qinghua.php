...
<?php @$qinghua = intval(file_get_contents("../api/tongji/jiekou/qinghua.dat")); ?>
<?php @$qinghuax = intval(file_get_contents("../api/tongji/jinri/".date("Y-m-d")."/qinghua.dat")); ?>
...
<title>土豆情话 - <?php echo $ming; ?>API</title>
...
<legend>土豆情话API</legend>
</fieldset>
<blockquote class="layui-elem-quote">本接口总调用：<?php echo $qinghua; ?>次·今日调用：<?php echo $qinghuax; ?>次</blockquote>
</div>
...
<span class="url" data-clipboard-text="http://<?php echo $_SERVER['HTTP_HOST'];?>/api/qinghua.php">http://<?php echo $_SERVER['HTTP_HOST'];?>/api/qinghua.php</span>
</p>
<p class="simpleTable">
...
$result = file_get_contents("http://".$_SERVER['HTTP_HOST']."/api/qinghua.php");
echo $result;
?></pre>
</div>
...
<pre class="layui-code"><a style="color:#fd4b5c;text-decoration:none；" target="_blank">土豆情话
$访问 http://<?php echo $_SERVER['HTTP_HOST'];?>/api/qinghua.php$</per>
</div>
</div>
</div>
</div>
