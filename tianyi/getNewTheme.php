...
<?php @$getNewTheme = intval(file_get_contents("../api/tongji/jiekou/getNewTheme.dat")); ?>
<?php @$getNewThemex = intval(file_get_contents("../api/tongji/jinri/".date("Y-m-d")."/getNewTheme.dat")); ?>
...
<title>早安语录 - <?php echo $ming; ?>API</title>
...
<legend>早安语录API</legend>
</fieldset>
<blockquote class="layui-elem-quote">本接口总调用：<?php echo $getNewTheme; ?>次·今日调用：<?php echo $getNewThemex; ?>次</blockquote>
</div>
...
<span class="url" data-clipboard-text="http://<?php echo $_SERVER['HTTP_HOST'];?>/api/getNewTheme.php">http://<?php echo $_SERVER['HTTP_HOST'];?>/api/getNewTheme.php</span>
</p>
<p class="simpleTable">
...
$result = file_get_contents("http://".$_SERVER['HTTP_HOST']."/api/getNewTheme.php");
echo $result;
?></pre>
</div>
...
<pre class="layui-code"><a style="color:#fd4b5c;text-decoration:none；" target="_blank">早安语录
$访问 http://<?php echo $_SERVER['HTTP_HOST'];?>/api/getNewTheme.php$</per>
</div>
</div>
</div>
</div>
