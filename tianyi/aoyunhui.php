...
<?php @$aoyunhui = intval(file_get_contents("../api/tongji/jiekou/aoyunhui.dat")); ?>
<?php @$aoyunhuix = intval(file_get_contents("../api/tongji/jinri/".date("Y-m-d")."/aoyunhui.dat")); ?>
...
<title>奥运会排行榜 - <?php echo $ming; ?>API</title>
...
<legend>奥运会排行榜API</legend>
</fieldset>
<blockquote class="layui-elem-quote">本接口总调用：<?php echo $aoyunhui; ?>次·今日调用：<?php echo $aoyunhuix; ?>次</blockquote>
</div>
...
<span class="url" data-clipboard-text="http://<?php echo $_SERVER['HTTP_HOST'];?>/api/aoyunhui.php">http://<?php echo $_SERVER['HTTP_HOST'];?>/api/aoyunhui.php</span>
</p>
<p class="simpleTable">
...
$result = file_get_contents("http://".$_SERVER['HTTP_HOST']."/api/aoyunhui.php");
echo $result;
?></pre>
</div>
...
<pre class="layui-code"><a style="color:#fd4b5c;text-decoration:none；" target="_blank">奥运会排行榜
$访问 http://<?php echo $_SERVER['HTTP_HOST'];?>/api/aoyunhui.php</per>
</div>
</div>
</div>
</div>
