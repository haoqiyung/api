...
<?php @$yhyl = intval(file_get_contents("../api/tongji/jiekou/yhyl.dat")); ?>
<?php @$yhylx = intval(file_get_contents("../api/tongji/jinri/".date("Y-m-d")."/yhyl.dat")); ?>
...
<title>英汉语录 - <?php echo $ming; ?>API</title>
...
<legend>英汉语录API</legend>
</fieldset>
<blockquote class="layui-elem-quote">本接口总调用：<?php echo $yhyl; ?>次·今日调用：<?php echo $yhylx; ?>次</blockquote>
</div>
...
<span class="url" data-clipboard-text="http://<?php echo $_SERVER['HTTP_HOST'];?>/api/yhyl.php">http://<?php echo $_SERVER['HTTP_HOST'];?>/api/yhyl.php</span>
</p>
<p class="simpleTable">
...
$result = file_get_contents("http://".$_SERVER['HTTP_HOST']."/api/yhyl.php");
echo $result;
?></pre></div>
...
<pre class="layui-code"><a style="color:#fd4b5c;text-decoration:none；" target="_blank">英汉语录
$访问 http://<?php echo $_SERVER['HTTP_HOST'];?>/api/yhyl.php$</per>
</div>
</div>
</div>
</div>
