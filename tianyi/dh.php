...
<title>导航页生成 - <?php echo $ming; ?>API</title>
...
<span class="url" data-clipboard-text="http://<?php echo $_SERVER['HTTP_HOST'];?>/api/data/dh/dh.php">http://<?php echo $_SERVER['HTTP_HOST'];?>/api/data/dh/dh.php</span>
</p>
<p class="simpleTable">
...
<span class="url" data-clipboard-text="http://<?php echo $_SERVER['HTTP_HOST'];?>/api/data/dh/dh.php?name=<?php echo $ming; ?>API&ua=百度一下&url=http://www.baidu.com&qq=3189402257">http://<?php echo $_SERVER['HTTP_HOST'];?>/api/data/dh/dh.php?name=<?php echo $ming; ?>API&ua=百度一下&url=http://www.baidu.com&qq=3189402257</span>
</p>
...
<tbody>
<tr><td>name</td><td>是</td><td>昵称</td></tr>
<tr><td>url</td><td>是</td><td>链接1</td></tr>
<tr><td>url1</td><td>是</td><td>链接2</td></tr>
<tr><td>url2</td><td>是</td><td>链接3</td></tr>
<tr><td>ua</td><td>是</td><td>按钮1</td></tr>
<tr><td>ua1</td><td>是</td><td>按钮2</td></tr>
<tr><td>ua2</td><td>是</td><td>按钮3</td></tr>
</tbody>
</table>
...
<table class="layui-table" lay-size="sm">
<thead><tr><th>名称</th><th>类型</th><th>说明</th>
</tr>
</thead>
<tbody>
