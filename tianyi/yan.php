...
<?php @$yan = intval(file_get_contents("../api/tongji/jiekou/yan.dat")); ?>
<?php @$yanx = intval(file_get_contents("../api/tongji/jinri/".date("Y-m-d")."/yan.dat")); ?>
...
<title>随机一言 - <?php echo $ming; ?>API</title>
...
<legend>随机一言API</legend>
</fieldset>
<blockquote class="layui-elem-quote">本接口总调用：<?php echo $yan; ?>次·今日调用：<?php echo $yanx; ?>次</blockquote>
</div>
...
<span class="url" data-clipboard-text="http://<?php echo $_SERVER['HTTP_HOST'];?>/api/yan.php">http://<?php echo $_SERVER['HTTP_HOST'];?>/api/yan.php</span>
</p>
<p class="simpleTable">
...
<pre class="layui-code"><a style="color:#fd4b5c;text-decoration:none；" target="_blank">随机一言
<?php echo $ming; ?>API随机一言\n
━━━━━━━━━\n
用户:@%昵称%\n
━━━━━━━━━\n
$访问 http://<?php echo $_SERVER['HTTP_HOST'];?>/api/yan.php$\n
━━━━━━━━━\n
请求示例：http://<?php echo $_SERVER['HTTP_HOST'];?>/tianyi/yan.php\n
━━━━━━━━━\n
