...
<?php @$check_mi_url = intval(file_get_contents("../api/tongji/jiekou/check_mi_url.dat")); ?>
<?php @$check_mi_urlx = intval(file_get_contents("../api/tongji/jinri/".date("Y-m-d")."/check_mi_url.dat")); ?>
...
<title>小米域名检测 - <?php echo $ming; ?>API</title>
...
<legend>小米域名检测API</legend>
</fieldset>
<blockquote class="layui-elem-quote">本接口总调用：<?php echo $check_mi_url; ?>次·今日调用：<?php echo $check_mi_urlx; ?>次</blockquote>
</div>
...
<span class="url" data-clipboard-text="http://<?php echo $_SERVER['HTTP_HOST'];?>/api/check_mi_url.php">http://<?php echo $_SERVER['HTTP_HOST'];?>/api/check_mi_url.php</span>
</p>
<p class="simpleTable">
...
<span class="url" data-clipboard-text="http://<?php echo $_SERVER['HTTP_HOST'];?>/api/check_mi_url.php?url=https://cloud.vpsidc.com.cn">http://<?php echo $_SERVER['HTTP_HOST'];?>/api/check_mi_url.php?url=https://cloud.vpsidc.com.cn</span>
</p>
...
$result = file_get_contents("http://".$_SERVER['HTTP_HOST']."/api/check_mi_url.php?url=https://cloud.vpsidc.com.cn");
echo $result;
?></pre>
</div>
...
<pre class="layui-code"><a style="color:#fd4b5c;text-decoration:none；" target="_blank">小米域名检测
<?php echo $ming; ?>API小米域名检测\n
━━━━━━━━━\n
用户:@%昵称%\n
━━━━━━━━━\n
小米域名检测 [网址]\n
━━━━━━━━━\n
请求示例：http://<?php echo $_SERVER['HTTP_HOST'];?>/tianyi/check_mi_url.php\n
━━━━━━━━━\n
Tips:<?php echo $ming; ?>API技术支持

小米域名检测 .*
$访问 http://<?php echo $_SERVER['HTTP_HOST'];?>/api/check_mi_url.php?url=%参数1%$</per>
</div>
</div>
</div>
</div>
