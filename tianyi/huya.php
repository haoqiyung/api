...
<?php @$huya = intval(file_get_contents("../api/tongji/jiekou/huya.dat")); ?>
<?php @$huyax = intval(file_get_contents("../api/tongji/jinri/".date("Y-m-d")."/huya.dat")); ?>
...
<title>虎牙直播 - <?php echo $ming; ?>API</title>
...
<legend>虎牙直播API</legend>
</fieldset>
<blockquote class="layui-elem-quote">本接口总调用：<?php echo $huya; ?>次·今日调用：<?php echo $huyax; ?>次</blockquote>
</div>
...
<span class="url" data-clipboard-text="http://<?php echo $_SERVER['HTTP_HOST'];?>/api/huya.php">http://<?php echo $_SERVER['HTTP_HOST'];?>/api/huya.php</span>
</p>
<p class="simpleTable">
...
<span class="url" data-clipboard-text="http://<?php echo $_SERVER['HTTP_HOST'];?>/api/huya.php?msg=吉云&b=1">http://<?php echo $_SERVER['HTTP_HOST'];?>/api/huya.php?msg=吉云&b=1</span>
</p>
...
$result = file_get_contents("http://".$_SERVER['HTTP_HOST']."/api/huya.php?msg=吉云&b=1");
echo $result;
?></pre>
</div>
...
<pre class="layui-code"><a style="color:#fd4b5c;text-decoration:none；" target="_blank">虎牙直播
<?php echo $ming; ?>API虎牙直播\n
━━━━━━━━━\n
用户:@%昵称%\n
━━━━━━━━━\n
虎牙直播 [名字]\n
━━━━━━━━━\n
请求示例：http://<?php echo $_SERVER['HTTP_HOST'];?>/tianyi/huya.php\n
━━━━━━━━━\n
Tips:<?php echo $ming; ?>API技术支持

虎牙直播 .*
$写 <?php echo $ming; ?>API/%群号%/%QQ% 虎牙直播 %参数1%$
$访问 http://<?php echo $_SERVER['HTTP_HOST'];?>/api/huya.php?msg=%参数1%$

选虎牙直播 .*
E:$读 <?php echo $ming; ?>API/%群号%/%QQ% 虎牙直播 %参数1%$
$访问 http://<?php echo $_SERVER['HTTP_HOST'];?>/api/huya.php?msg=%E%&b=%参数1%$</per>
</div>
</div>
</div>
</div>
