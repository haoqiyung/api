...
<?php @$fanyi2 = intval(file_get_contents("../api/tongji/jiekou/fanyi2.dat")); ?>
<?php @$fanyi2x = intval(file_get_contents("../api/tongji/jinri/".date("Y-m-d")."/fanyi2.dat")); ?>

<!doctype html>
<html lang="zh">
<head>
<meta charset="UTF-8">
<meta name="viewport" content="wifanyi2h=device-wifanyi2h, user-scalable=no, initial-scale=1.0, maximum-scale=1.0, minimum-scale=1.0">
<meta http-equiv="X-UA-Compatible" content="ie=edge">
<title>语言翻译 - <?php echo $ming; ?>API</title>
<meta name="keywords" content=""/>
<meta name="description" content="">    
<link rel="stylesheet" href="./assets/css/layer.css">
<script src="https://ku.oioweb.cn/LayUI/2.5.4/layui.all.js"></script>
<style>.url{word-break:break-all;cursor:pointer;margin-left:5px;color:#777;border:none;border-radius:0;border-bottom:2px solid #5FB878;}.simpleTable{line-height:20px;padding-bottom:16px;}.linep{font-size:14px;font-weight:700;color:#555;padding-left:14px;height:16px;line-height:16px;margin-bottom:18px;position:relative;margin-top:15px;}.linep:before{content:'';wifanyi2h:4px;height:16px;background:#00aeff;border-radius:2px;position:absolute;left:0;top:0;}::-webkit-scrollbar{wifanyi2h:9px;height:9px}::-webkit-scrollbar-track-piece{background-color:#ebebeb;-webkit-border-radius:4px}::-webkit-scrollbar-thumb:vertical{height:32px;background-color:#ccc;-webkit-border-radius:4px}::-webkit-scrollbar-thumb:horizontal{wifanyi2h:32px;background-color:#ccc;-webkit-border-radius:4px}</style>
</head>
<body>
<div class="layui-container">
<div class="layui-row">
<fieldset class="layui-elem-field layui-field-title" style="margin-top: 20px;">
<legend>语言翻译API</legend>
</fieldset>
<blockquote class="layui-elem-quote">本接口总调用：<?php echo $fanyi2; ?>次·今日调用：<?php echo $fanyi2x; ?>次</blockquote>
</div>
...
<span class="url" data-clipboard-text="http://<?php echo $_SERVER['HTTP_HOST'];?>/api/fanyi2.php">http://<?php echo $_SERVER['HTTP_HOST'];?>/api/fanyi2.php</span>
</p>
<p class="simpleTable">
...
<span class="url" data-clipboard-text="http://<?php echo $_SERVER['HTTP_HOST'];?>/api/fanyi2.php?msg=吉云">http://<?php echo $_SERVER['HTTP_HOST'];?>/api/fanyi2.php?msg=吉云</span>
</p>
...
<tbody>
<tr><td>msg</td><td>是</td><td>需要翻译的内容</td></tr>
...
$result = file_get_contents("http://".$_SERVER['HTTP_HOST']."/api/fanyi2.php?msg=吉云");
echo $result;
?></pre>
</div>
...
<pre class="layui-code"><a style="color:#fd4b5c;text-decoration:none；" target="_blank">语言翻译
<?php echo $ming; ?>API语言翻译\n
━━━━━━━━━\n
用户:@%昵称%\n
━━━━━━━━━\n
语言翻译 [内容]\n
━━━━━━━━━\n
请求示例：http://<?php echo $_SERVER['HTTP_HOST'];?>/tianyi/fanyi2.php\n
━━━━━━━━━\n
Tips:<?php echo $ming; ?>API技术支持

语言翻译 .*
$访问 http://<?php echo $_SERVER['HTTP_HOST'];?>/api/fanyi2.php?msg=%参数1%$</per>
</div>
</div>
</div>
</div>
