...
<title>网页跳转 - <?php echo $ming; ?>API</title>
...
<span class="url" data-clipboard-text="http://<?php echo $_SERVER['HTTP_HOST'];?>/api/wztz.php">http://<?php echo $_SERVER['HTTP_HOST'];?>/api/wztz.php</span>
</p>
<p class="simpleTable">
...
<span class="url" data-clipboard-text="http://<?php echo $_SERVER['HTTP_HOST'];?>/api/wztz.php?url=https://cloud.vpsidc.com.cn">http://<?php echo $_SERVER['HTTP_HOST'];?>/api/wztz.php?url=https://cloud.vpsidc.com.cn</span>
</p>
...
<tbody>
<tr><td>url</td><td>是</td><td>需要跳转的链接</td></tr>
</tbody>
</table>
