...
<?php @$xztq = intval(file_get_contents("../api/tongji/jiekou/xztq.dat")); ?>
<?php @$xztqx = intval(file_get_contents("../api/tongji/jinri/".date("Y-m-d")."/xztq.dat")); ?>
...
<title>心知天气 - <?php echo $ming; ?>API</title>
...
<legend>心知天气API</legend>
</fieldset>
<blockquote class="layui-elem-quote">本接口总调用：<?php echo $xztq; ?>次·今日调用：<?php echo $xztqx; ?>次</blockquote>
</div>
...
<span class="url" data-clipboard-text="http://<?php echo $_SERVER['HTTP_HOST'];?>/api/xztq.php">http://<?php echo $_SERVER['HTTP_HOST'];?>/api/xztq.php</span>
</p>
<p class="simpleTable">
...
<span class="url" data-clipboard-text="http://<?php echo $_SERVER['HTTP_HOST'];?>/api/xztq.php?msg=长春&type=text">http://<?php echo $_SERVER['HTTP_HOST'];?>/api/xztq.php?msg=长春&type=text</span>
</p>
...
<tbody>
<tr><td>msg</td><td>是</td><td>需要查询的地区名</td></tr>
<tr><td>type</td><td>是</td><td>返回格式(可选预报或yb)(默认text)</td></tr>
</tbody>
</table>
...
$result = file_get_contents("http://".$_SERVER['HTTP_HOST']."/api/xztq.php?msg=长春&type=text");
echo $result;
?></pre>
</div>
...
<pre class="layui-code"><a style="color:#fd4b5c;text-decoration:none；" target="_blank">心知天气
<?php echo $ming; ?>API心知天气\n
━━━━━━━━━\n
用户:@%昵称%\n
━━━━━━━━━\n
心知天气 [地区名]\n
━━━━━━━━━\n
请求示例：http://<?php echo $_SERVER['HTTP_HOST'];?>/tianyi/xztq.php\n
━━━━━━━━━\n
...
用户:@%昵称%\n
━━━━━━━━━\n
$访问 http://<?php echo $_SERVER['HTTP_HOST'];?>/api/xztq.php?msg=%参数1%&type=text$\n
━━━━━━━━━\n
