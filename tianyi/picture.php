...
<?php @$picture = intval(file_get_contents("../api/tongji/jiekou/picture.dat")); ?>
<?php @$picturex = intval(file_get_contents("../api/tongji/jinri/".date("Y-m-d")."/picture.dat")); ?>
...
<title>背景图片大全 - <?php echo $ming; ?>API</title>
...
<legend>背景图片大全API</legend>
</fieldset>
<blockquote class="layui-elem-quote">本接口总调用：<?php echo $picture; ?>次·今日调用：<?php echo $picturex; ?>次</blockquote>
</div>
...
<span class="url" data-clipboard-text="http://<?php echo $_SERVER['HTTP_HOST'];?>/api/picture.php">http://<?php echo $_SERVER['HTTP_HOST'];?>/api/picture.php</span>
</p>
<p class="simpleTable">
...
<span class="url" data-clipboard-text="http://<?php echo $_SERVER['HTTP_HOST'];?>/api/picture.php?msg=美女">http://<?php echo $_SERVER['HTTP_HOST'];?>/api/picture.php?msg=美女</span>
</p>
...
<tbody>
<tr><td>msg</td><td>是</td><td>输(美女，爱情，风景，清新，动漫，明星，萌宠，游戏，汽车，时尚，日历，影视，军事，体育，萌娃，格言)</td></tr>
</tbody>
</table>
...
$result = file_get_contents("http://".$_SERVER['HTTP_HOST']."/api/picture.php?msg=美女");
echo $result;
?></pre>
</div>
...
<pre class="layui-code"><a style="color:#fd4b5c;text-decoration:none；" target="_blank">背景图片大全
<?php echo $ming; ?>API背景图片大全\n
━━━━━━━━━\n
用户:@%昵称%\n
━━━━━━━━━\n
背景图片大全 [输(背景，爱情，风景，清新，动漫，明星，萌宠，游戏，汽车，时尚，日历，影视，军事，体育，萌娃，格言)]\n
━━━━━━━━━\n
请求示例：http://<?php echo $_SERVER['HTTP_HOST'];?>/tianyi/picture.php\n
━━━━━━━━━\n
...
用户:@%昵称%\n
━━━━━━━━━\n
±img=$访问 http://<?php echo $_SERVER['HTTP_HOST'];?>/api/picture.php?msg=%参数1%$±\n
━━━━━━━━━\n
