...
<?php @$qqxt = intval(file_get_contents("../api/tongji/jiekou/qqxt.dat")); ?>
<?php @$qqxtx = intval(file_get_contents("../api/tongji/jinri/".date("Y-m-d")."/qqxt.dat")); ?>
...
<title>获取QQ昵称和头像 - <?php echo $ming; ?>API</title>
...
<legend>获取QQ昵称和头像API</legend>
</fieldset>
<blockquote class="layui-elem-quote">本接口总调用：<?php echo $qqxt; ?>次·今日调用：<?php echo $qqxtx; ?>次</blockquote>
</div>
...
<span class="url" data-clipboard-text="http://<?php echo $_SERVER['HTTP_HOST'];?>/api/qqxt.php">http://<?php echo $_SERVER['HTTP_HOST'];?>/api/qqxt.php</span>
</p>
<p class="simpleTable">
...
<span class="url" data-clipboard-text="http://<?php echo $_SERVER['HTTP_HOST'];?>/api/qqxt.php?qq=3189402257">http://<?php echo $_SERVER['HTTP_HOST'];?>/api/qqxt.php?qq=3189402257</span>
</p>
...
<tr><td>imgurl</td><td>QQ头像</td></tr>
<tr><td>name</td><td>QQ名称</td></tr>
</tbody>
</table>
<p class="linep">返回示例：</p>
<pre class="layui-code"><?php
//header("Content-Type:text/html;charset=UTF-8");
$result = file_get_contents("http://".$_SERVER['HTTP_HOST']."/api/qqxt.php?qq=3189402257");
echo $result;
?></pre>
</div>
