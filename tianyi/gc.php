...
<?php @$gc = intval(file_get_contents("../api/tongji/jiekou/gc.dat")); ?>
<?php @$gcx = intval(file_get_contents("../api/tongji/jinri/".date("Y-m-d")."/gc.dat")); ?>
...
<title>酷狗歌词 - <?php echo $ming; ?>API</title>
...
<legend>酷狗歌词API</legend>
</fieldset>
<blockquote class="layui-elem-quote">本接口总调用：<?php echo $gc; ?>次·今日调用：<?php echo $gcx; ?>次</blockquote>
</div>
...
<span class="url" data-clipboard-text="http://<?php echo $_SERVER['HTTP_HOST'];?>/api/gc.php">http://<?php echo $_SERVER['HTTP_HOST'];?>/api/gc.php</span>
</p>
<p class="simpleTable">
...
<span class="url" data-clipboard-text="http://<?php echo $_SERVER['HTTP_HOST'];?>/api/gc.php?msg=我和你&b=1">http://<?php echo $_SERVER['HTTP_HOST'];?>/api/gc.php?msg=我和你&b=1</span>
</p>
...
$result = file_get_contents("http://".$_SERVER['HTTP_HOST']."/api/gc.php?msg=我和你&b=1");
echo $result;
?></pre>
</div>
...
<pre class="layui-code"><a style="color:#fd4b5c;text-decoration:none；" target="_blank">酷狗歌词
<?php echo $ming; ?>API酷狗歌词\n
━━━━━━━━━\n
用户:@%昵称%\n
━━━━━━━━━\n
酷狗歌词 [内容]\n
━━━━━━━━━\n
请求示例：http://<?php echo $_SERVER['HTTP_HOST'];?>/tianyi/gc.php\n
━━━━━━━━━\n
Tips:<?php echo $ming; ?>API技术支持

酷狗歌词 .*
$写 <?php echo $ming; ?>API/%群号%/%QQ% 酷狗歌词 %参数1%$
$访问 http://<?php echo $_SERVER['HTTP_HOST'];?>/api/gc.php?msg=%参数1%$

选酷狗歌词 .*
e:$读 <?php echo $ming; ?>API/%群号%/%QQ% 酷狗歌词 %参数1%$
$访问 http://<?php echo $_SERVER['HTTP_HOST'];?>/api/gc.php?msg=%e%&b=%参数1%$</per>
</div>
</div>
</div>
</div>
