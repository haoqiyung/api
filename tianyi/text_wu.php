...
<?php @$text_wu = intval(file_get_contents("../api/tongji/jiekou/text_wu.dat")); ?>
<?php @$text_wux = intval(file_get_contents("../api/tongji/jinri/".date("Y-m-d")."/text_wu.dat")); ?>
...
<title>污句子 - <?php echo $ming; ?>API</title>
...
<legend>污句子API</legend>
</fieldset>
<blockquote class="layui-elem-quote">本接口总调用：<?php echo $text_wu; ?>次·今日调用：<?php echo $text_wux; ?>次</blockquote>
</div>
...
<span class="url" data-clipboard-text="http://<?php echo $_SERVER['HTTP_HOST'];?>/api/text_wu.php">http://<?php echo $_SERVER['HTTP_HOST'];?>/api/text_wu.php</span>
</p>
<p class="simpleTable">
...
$result = file_get_contents("http://".$_SERVER['HTTP_HOST']."/api/text_wu.php");
echo $result;
?></pre>
</div>
...
<pre class="layui-code"><a style="color:#fd4b5c;text-decoration:none；" target="_blank">污句子
$访问 http://<?php echo $_SERVER['HTTP_HOST'];?>/api/text_wu.php$</per>
</div>
</div>
</div>
</div>
