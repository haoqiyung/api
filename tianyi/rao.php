...
<?php @$rao = intval(file_get_contents("../api/tongji/jiekou/rao.dat")); ?>
<?php @$raox = intval(file_get_contents("../api/tongji/jinri/".date("Y-m-d")."/rao.dat")); ?>
...
<title>绕口令 - <?php echo $ming; ?>API</title>
...
<legend>绕口令API</legend>
</fieldset>
<blockquote class="layui-elem-quote">本接口总调用：<?php echo $rao; ?>次·今日调用：<?php echo $raox; ?>次</blockquote>
</div>
...
<span class="url" data-clipboard-text="http://<?php echo $_SERVER['HTTP_HOST'];?>/api/rao.php">http://<?php echo $_SERVER['HTTP_HOST'];?>/api/rao.php</span>
</p>
<p class="simpleTable">
...
$result = file_get_contents("http://".$_SERVER['HTTP_HOST']."/api/rao.php");
echo $result;
?></pre>
</div>
...
<pre class="layui-code"><a style="color:#fd4b5c;text-decoration:none；" target="_blank">绕口令
$访问 http://<?php echo $_SERVER['HTTP_HOST'];?>/api/rao.php$</per>
</div>
</div>
</div>
</div>
