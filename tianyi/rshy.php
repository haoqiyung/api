...
<?php @$rshy = intval(file_get_contents("../api/tongji/jiekou/rshy.dat")); ?>
<?php @$rshyx = intval(file_get_contents("../api/tongji/jinri/".date("Y-m-d")."/rshy.dat")); ?>
...
<title>人生话语 - <?php echo $ming; ?>API</title>
...
<legend>人生话语API</legend>
</fieldset>
<blockquote class="layui-elem-quote">本接口总调用：<?php echo $rshy; ?>次·今日调用：<?php echo $rshyx; ?>次</blockquote>
</div>
...
<span class="url" data-clipboard-text="http://<?php echo $_SERVER['HTTP_HOST'];?>/api/rshy.php">http://<?php echo $_SERVER['HTTP_HOST'];?>/api/rshy.php</span>
</p>
<p class="simpleTable">
...
$result = file_get_contents("http://".$_SERVER['HTTP_HOST']."/api/rshy.php");
echo $result;
?></pre>
</div>
...
<pre class="layui-code"><a style="color:#fd4b5c;text-decoration:none；" target="_blank">人生话语
<?php echo $ming; ?>API人生话语\n
━━━━━━━━━\n
用户:@%昵称%\n
━━━━━━━━━\n
$访问 http://<?php echo $_SERVER['HTTP_HOST'];?>/api/rshy.php$\n
━━━━━━━━━\n
请求示例：http://<?php echo $_SERVER['HTTP_HOST'];?>/tianyi/rshy.php\n
━━━━━━━━━\n
