...
<?php @$shangpin = intval(file_get_contents("../api/tongji/jiekou/shangpin.dat")); ?>
<?php @$shangpinx = intval(file_get_contents("../api/tongji/jinri/".date("Y-m-d")."/shangpin.dat")); ?>
...
<title>商品搜索 - <?php echo $ming; ?>API</title>
...
<legend>商品搜索API</legend>
</fieldset>
<blockquote class="layui-elem-quote">本接口总调用：<?php echo $shangpin; ?>次·今日调用：<?php echo $shangpinx; ?>次</blockquote>
</div>
...
<span class="url" data-clipboard-text="http://<?php echo $_SERVER['HTTP_HOST'];?>/api/shangpin.php">http://<?php echo $_SERVER['HTTP_HOST'];?>/api/shangpin.php</span>
</p>
<p class="simpleTable">
...
<span class="url" data-clipboard-text="http://<?php echo $_SERVER['HTTP_HOST'];?>/api/shangpin.php?msg=吉云&b=1">http://<?php echo $_SERVER['HTTP_HOST'];?>/api/shangpin.php?msg=吉云&b=1</span>
</p>
...
<tbody>
<tr><td>msg</td><td>是</td><td>需要搜索的商品名</td></tr>
...
$result = file_get_contents("http://".$_SERVER['HTTP_HOST']."/api/shangpin.php?msg=吉云&b=1");
echo $result;
?></pre></div>
...
<pre class="layui-code"><a style="color:#fd4b5c;text-decoration:none；" target="_blank">商品搜索
<?php echo $ming; ?>API商品搜索\n
━━━━━━━━━\n
用户:@%昵称%\n
━━━━━━━━━\n
商品搜索 [名字]\n
━━━━━━━━━\n
请求示例：http://<?php echo $_SERVER['HTTP_HOST'];?>/tianyi/shangpin.php\n
━━━━━━━━━\n
Tips:<?php echo $ming; ?>API技术支持

商品搜索 .*
$写 <?php echo $ming; ?>API/%群号%/%QQ% 商品搜索 %参数1%$
$访问 http://<?php echo $_SERVER['HTTP_HOST'];?>/api/shangpin.php?msg=%参数1%$

选商品搜索 .*
I:$读 <?php echo $ming; ?>API/%群号%/%QQ% 商品搜索 %参数1%$
$访问 http://<?php echo $_SERVER['HTTP_HOST'];?>/api/shangpin.php?msg=%I%&b=%参数1%$</per>
</div>
</div>
</div>
</div>
