...
<?php @$lishi = intval(file_get_contents("../api/tongji/jiekou/lishi.dat")); ?>
<?php @$lishix = intval(file_get_contents("../api/tongji/jinri/".date("Y-m-d")."/lishi.dat")); ?>
...
<title>历史上的今天 - <?php echo $ming; ?>API</title>
...
<legend>历史上的今天API</legend>
</fieldset>
<blockquote class="layui-elem-quote">本接口总调用：<?php echo $lishi; ?>次·今日调用：<?php echo $lishix; ?>次</blockquote>
</div>
...
<span class="url" data-clipboard-text="http://<?php echo $_SERVER['HTTP_HOST'];?>/api/lishi.php">http://<?php echo $_SERVER['HTTP_HOST'];?>/api/lishi.php</span>
</p>
<p class="simpleTable">
...
$result = file_get_contents("http://".$_SERVER['HTTP_HOST']."/api/lishi.php");
echo $result;
?></pre>
</div>
...
<pre class="layui-code"><a style="color:#fd4b5c;text-decoration:none；" target="_blank">历史上的今天
$访问 http://<?php echo $_SERVER['HTTP_HOST'];?>/api/lishi.php$</per>
</div>
</div>
</div>
</div>
