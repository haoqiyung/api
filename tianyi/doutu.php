...
<?php @$doutu = intval(file_get_contents("../api/tongji/jiekou/doutu.dat")); ?>
<?php @$doutux = intval(file_get_contents("../api/tongji/jinri/".date("Y-m-d")."/doutu.dat")); ?>
...
<title>斗图搜索 - <?php echo $ming; ?>API</title>
...
<legend>斗图搜索API</legend>
</fieldset>
<blockquote class="layui-elem-quote">本接口总调用：<?php echo $doutu; ?>次·今日调用：<?php echo $doutux; ?>次</blockquote>
</div>
...
<span class="url" data-clipboard-text="http://<?php echo $_SERVER['HTTP_HOST'];?>/api/doutu.php">http://<?php echo $_SERVER['HTTP_HOST'];?>/api/doutu.php</span>
</p>
<p class="simpleTable">
...
<span class="url" data-clipboard-text="http://<?php echo $_SERVER['HTTP_HOST'];?>/api/doutu.php?msg=你好">http://<?php echo $_SERVER['HTTP_HOST'];?>/api/doutu.php?msg=你好</span>
</p>
...
<tbody>
<tr><td>msg</td><td>是</td><td>需要查询的内容</td></tr>
</tbody>
</table>
...
$result = file_get_contents("http://".$_SERVER['HTTP_HOST']."/api/doutu.php?msg=你好");
echo $result;
?></pre>
</div>
...
<pre class="layui-code"><a style="color:#fd4b5c;text-decoration:none；" target="_blank">斗图搜索
<?php echo $ming; ?>API斗图搜索\n
━━━━━━━━━\n
用户:@%昵称%\n
━━━━━━━━━\n
斗图搜索 [内容]\n
━━━━━━━━━\n
请求示例：http://<?php echo $_SERVER['HTTP_HOST'];?>/tianyi/doutu.php\n
━━━━━━━━━\n
...
用户:@%昵称%\n
━━━━━━━━━\n
±img=$访问 http://<?php echo $_SERVER['HTTP_HOST'];?>/api/doutu.php?msg=%参数1%$±\n
━━━━━━━━━\n
