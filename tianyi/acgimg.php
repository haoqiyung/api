...
<?php @$acgimg = intval(file_get_contents("../api/tongji/jiekou/acgimg.dat")); ?>
<?php @$acgimgx = intval(file_get_contents("../api/tongji/jinri/".date("Y-m-d")."/acgimg.dat")); ?>
...
<title>随机二次元图片 - <?php echo $ming; ?>API</title>
...
<legend>随机二次元图片API</legend>
</fieldset>
<blockquote class="layui-elem-quote">本接口总调用：<?php echo $acgimg; ?>次·今日调用：<?php echo $acgimgx; ?>次</blockquote>
</div>
...
<span class="url" data-clipboard-text="http://<?php echo $_SERVER['HTTP_HOST'];?>/api/acgimg.php">http://<?php echo $_SERVER['HTTP_HOST'];?>/api/acgimg.php</span>
</p>
<p class="simpleTable">
...
<pre class="layui-code"><img src="../api/acgimg.php" style="width: 45%;"></pre>
</div>
...
<pre class="layui-code"><a style="color:#fd4b5c;text-decoration:none；" target="_blank">随机二次元图片
<?php echo $ming; ?>API随机二次元图片\n
━━━━━━━━━\n
用户:@%昵称%\n
━━━━━━━━━\n
±img=http://<?php echo $_SERVER['HTTP_HOST'];?>/api/acgimg.php±\n
━━━━━━━━━\n
请求示例：http://<?php echo $_SERVER['HTTP_HOST'];?>/tianyi/acgimg.php\n
━━━━━━━━━\n
