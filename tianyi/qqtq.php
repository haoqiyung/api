...
<?php @$qqtq = intval(file_get_contents("../api/tongji/jiekou/qqtq.dat")); ?>
<?php @$qqtqx = intval(file_get_contents("../api/tongji/jinri/".date("Y-m-d")."/qqtq.dat")); ?>
...
<title>QQ天气 - <?php echo $ming; ?>API</title>
...
<legend>QQ天气API</legend>
</fieldset>
<blockquote class="layui-elem-quote">本接口总调用：<?php echo $qqtq; ?>次·今日调用：<?php echo $qqtqx; ?>次</blockquote>
</div>
...
<span class="url" data-clipboard-text="http://<?php echo $_SERVER['HTTP_HOST'];?>/api/qqtq.php">http://<?php echo $_SERVER['HTTP_HOST'];?>/api/qqtq.php</span>
</p>
<p class="simpleTable">
...
<span class="url" data-clipboard-text="http://<?php echo $_SERVER['HTTP_HOST'];?>/api/qqtq.php?msg=长春">http://<?php echo $_SERVER['HTTP_HOST'];?>/api/qqtq.php?msg=长春</span>
</p>
...
$result = file_get_contents("http://".$_SERVER['HTTP_HOST']."/api/qqtq.php?msg=长春");
echo $result;
?></pre>
</div>
...
<pre class="layui-code"><a style="color:#fd4b5c;text-decoration:none；" target="_blank">QQ天气
<?php echo $ming; ?>API♧QQ天气\n
━━━━━━━━━\n
用户:@%昵称%\n
━━━━━━━━━\n
QQ天气 [地区名]\n
━━━━━━━━━\n
请求示例：http://<?php echo $_SERVER['HTTP_HOST'];?>/tianyi/qqtq.php\n
━━━━━━━━━\n
Tips:<?php echo $ming; ?>API技术支持

QQ天气 .*
$访问 http://<?php echo $_SERVER['HTTP_HOST'];?>/api/qqtq.php?msg=%参数1%$</per>
</div>
</div>
</div>
</div>
