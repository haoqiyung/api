...
<?php @$bilirand = intval(file_get_contents("../api/tongji/jiekou/bilirand.dat")); ?>
<?php @$bilirandx = intval(file_get_contents("../api/tongji/jinri/".date("Y-m-d")."/bilirand.dat")); ?>
...
<title>哔哩哔哩随机视频 - <?php echo $ming; ?>API</title>
...
<legend>哔哩哔哩随机视频API</legend>
</fieldset>
<blockquote class="layui-elem-quote">本接口总调用：<?php echo $bilirand; ?>次·今日调用：<?php echo $bilirandx; ?>次</blockquote>
</div>
...
<span class="url" data-clipboard-text="http://<?php echo $_SERVER['HTTP_HOST'];?>/api/bilirand.php">http://<?php echo $_SERVER['HTTP_HOST'];?>/api/bilirand.php</span>
</p>
<p class="simpleTable">
...
$result = file_get_contents("http://".$_SERVER['HTTP_HOST']."/api/bilirand.php");
echo $result;
?></pre>
</div>
...
<pre class="layui-code"><a style="color:#fd4b5c;text-decoration:none；" target="_blank">哔哩哔哩随机视频
$访问 http://<?php echo $_SERVER['HTTP_HOST'];?>/api/bilirand.php$</per>
</div>
</div>
</div>
</div>
