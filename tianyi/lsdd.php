...
<?php @$lsdd = intval(file_get_contents("../api/tongji/jiekou/lsdd.dat")); ?>
<?php @$lsddx = intval(file_get_contents("../api/tongji/jinri/".date("Y-m-d")."/lsdd.dat")); ?>
...
<blockquote class="layui-elem-quote">本接口总调用：<?php echo $lsdd; ?>次·今日调用：<?php echo $lsddx; ?>次</blockquote>
</div>
...
<span class="url" data-clipboard-text="http://<?php echo $_SERVER['HTTP_HOST'];?>/api/lsdd.php">http://<?php echo $_SERVER['HTTP_HOST'];?>/api/lsdd.php</span>
</p>
<p class="simpleTable">
...
<span class="url" data-clipboard-text="http://<?php echo $_SERVER['HTTP_HOST'];?>/api/lsdd.php?msg=最新">http://<?php echo $_SERVER['HTTP_HOST'];?>/api/lsdd.php?msg=最新</span>
</p>
...
<tbody>
<tr><td>msg</td><td>是</td><td>输(最新/最热/搞笑/情感/动漫/最嗨/来电/流行)</td></tr>
<tr><td>type</td><td>否</td><td>输出方式(xml)(默认为text)</td></tr>
...
$result = file_get_contents("http://".$_SERVER['HTTP_HOST']."/api/lsdd.php?msg=最新");
echo $result;
?></pre>
</div>
...
来电铃声\n
━━━━━━━━━\n
请求示例：http://<?php echo $_SERVER['HTTP_HOST'];?>/tianyi/lsdd.php\n
━━━━━━━━━\n
Tips:<?php echo $ming; ?>API技术支持

(最新|最热|搞笑|情感|动漫|最嗨|来电|流行)铃声
$访问 http://<?php echo $_SERVER['HTTP_HOST'];?>/api/lsdd.php?msg=%括号1%$</per>
</div>
</div>
</div>
</div>
