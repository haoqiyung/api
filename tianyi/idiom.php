...
<?php @$idiom = intval(file_get_contents("../api/tongji/jiekou/idiom.dat")); ?>
<?php @$idiomx = intval(file_get_contents("../api/tongji/jinri/".date("Y-m-d")."/idiom.dat")); ?>
...
<title>成语查询 - <?php echo $ming; ?>API</title>
...
<legend>成语查询API</legend>
</fieldset>
<blockquote class="layui-elem-quote">本接口总调用：<?php echo $idiom; ?>次·今日调用：<?php echo $idiomx; ?>次</blockquote>
</div>
...
<span class="url" data-clipboard-text="http://<?php echo $_SERVER['HTTP_HOST'];?>/api/idom.php">http://<?php echo $_SERVER['HTTP_HOST'];?>/api/idom.php</span>
</p>
<p class="simpleTable">
...
<span class="url" data-clipboard-text="http://<?php echo $_SERVER['HTTP_HOST'];?>/api/idiom.php?msg=一心一意&b=1">http://<?php echo $_SERVER['HTTP_HOST'];?>/api/idiom.php?msg=一心一意&b=1</span>
</p>
...
<tbody>
<tr><td>msg</td><td>是</td><td>需要查询的成语</td></tr>
...
$result = file_get_contents("http://".$_SERVER['HTTP_HOST']."/api/idiom.php?msg=一心一意&b=1");
echo $result;
?></pre>
</div>
...
<pre class="layui-code"><a style="color:#fd4b5c;text-decoration:none；" target="_blank">成语查询
<?php echo $ming; ?>API成语查询\n
━━━━━━━━━\n
用户:@%昵称%\n
━━━━━━━━━\n
成语查询 [名字]\n
━━━━━━━━━\n
请求示例：http://<?php echo $_SERVER['HTTP_HOST'];?>/tianyi/idiom.php\n
━━━━━━━━━\n
Tips:<?php echo $ming; ?>API技术支持

成语查询 .*
$写 <?php echo $ming; ?>API/%群号%/%QQ% 成语查询 %参数1%$
$访问 http://<?php echo $_SERVER['HTTP_HOST'];?>/api/idiom.php?msg=%参数1%$

选成语查询 .*
r:$读 <?php echo $ming; ?>API/%群号%/%QQ% 成语查询 %参数1%$
$访问 http://<?php echo $_SERVER['HTTP_HOST'];?>/api/idiom.php?msg=%r%&b=%参数1%$</per>
</div>
</div>
</div>
</div>
