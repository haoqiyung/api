...
<?php @$view = intval(file_get_contents("../api/tongji/jiekou/view.dat")); ?>
<?php @$viewx = intval(file_get_contents("../api/tongji/jinri/".date("Y-m-d")."/view.dat")); ?>
...
<title>随机风景图片 - <?php echo $ming; ?>API</title>
...
<legend>随机风景图片API</legend>
</fieldset>
<blockquote class="layui-elem-quote">本接口总调用：<?php echo $view; ?>次·今日调用：<?php echo $viewx; ?>次</blockquote>
</div>
...
<span class="url" data-clipboard-text="http://<?php echo $_SERVER['HTTP_HOST'];?>/api/view.php">http://<?php echo $_SERVER['HTTP_HOST'];?>/api/view.php</span>
</p>
<p class="simpleTable">
...
<pre class="layui-code"><img src="../api/view.php" style="width: 45%;"></pre>
</div>
...
<pre class="layui-code"><a style="color:#fd4b5c;text-decoration:none；" target="_blank">随机风景图片
<?php echo $ming; ?>API随机风景图片\n
━━━━━━━━━\n
用户:@%昵称%\n
━━━━━━━━━\n
±img=http://<?php echo $_SERVER['HTTP_HOST'];?>/api/view.php±\n
━━━━━━━━━\n
请求示例：http://<?php echo $_SERVER['HTTP_HOST'];?>/tianyi/view.php\n
━━━━━━━━━\n
