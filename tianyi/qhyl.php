...
<?php @$qhyl = intval(file_get_contents("../api/tongji/jiekou/qhyl.dat")); ?>
<?php @$qhylx = intval(file_get_contents("../api/tongji/jinri/".date("Y-m-d")."/qhyl.dat")); ?>
...
<title>爱情语录 - <?php echo $ming; ?>API</title>
...
<legend>爱情语录API</legend>
</fieldset>
<blockquote class="layui-elem-quote">本接口总调用：<?php echo $qhyl; ?>次·今日调用：<?php echo $qhylx; ?>次</blockquote>
</div>
...
<span class="url" data-clipboard-text="http://<?php echo $_SERVER['HTTP_HOST'];?>/api/qhyl.php">http://<?php echo $_SERVER['HTTP_HOST'];?>/api/qhyl.php</span>
</p>
<p class="simpleTable">
...
$result = file_get_contents("http://".$_SERVER['HTTP_HOST']."/api/qhyl.php");
echo $result;
?></pre>
</div>
...
<pre class="layui-code"><a style="color:#fd4b5c;text-decoration:none；" target="_blank">爱情语录
$访问 http://<?php echo $_SERVER['HTTP_HOST'];?>/api/qhyl.php$</per>
</div>
</div>
</div>
</div>
