...
<?php @$today = intval(file_get_contents("../api/tongji/jiekou/today.dat")); ?>
<?php @$todayx = intval(file_get_contents("../api/tongji/jinri/".date("Y-m-d")."/today.dat")); ?>
...
<blockquote class="layui-elem-quote">本接口总调用：<?php echo $today; ?>次·今日调用：<?php echo $todayx; ?>次</blockquote>
</div>
...
<span class="url" data-clipboard-text="http://<?php echo $_SERVER['HTTP_HOST'];?>/api/today.php">http://<?php echo $_SERVER['HTTP_HOST'];?>/api/today.php</span>
</p>
<p class="simpleTable">
...
$result = file_get_contents("http://".$_SERVER['HTTP_HOST']."/api/today.php");
echo $result;
?></pre>
</div>
