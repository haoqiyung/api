...
<?php @$QuanminHotsearch = intval(file_get_contents("../api/tongji/jiekou/QuanminHotsearch.dat")); ?>
<?php @$QuanminHotsearchx = intval(file_get_contents("../api/tongji/jinri/".date("Y-m-d")."/QuanminHotsearch.dat")); ?>
...
<title>百度热搜榜获取 - <?php echo $ming; ?>API</title>
...
<legend>百度热搜榜获取API</legend>
</fieldset>
<blockquote class="layui-elem-quote">本接口总调用：<?php echo $QuanminHotsearch; ?>次·今日调用：<?php echo $QuanminHotsearchx; ?>次</blockquote>
</div>
...
<span class="url" data-clipboard-text="http://<?php echo $_SERVER['HTTP_HOST'];?>/api/QuanminHotsearch.php">http://<?php echo $_SERVER['HTTP_HOST'];?>/api/QuanminHotsearch.php</span>
</p>
<p class="simpleTable">
...
$result = file_get_contents("http://".$_SERVER['HTTP_HOST']."/api/QuanminHotsearch.php");
echo $result;
?></pre>
</div>
...
<pre class="layui-code"><a style="color:#fd4b5c;text-decoration:none；" target="_blank">百度热搜榜获取
$访问 http://<?php echo $_SERVER['HTTP_HOST'];?>/api/QuanminHotsearch.php$</per>
</div>
</div>
</div>
</div>
