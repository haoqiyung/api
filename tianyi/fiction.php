...
<?php @$fiction = intval(file_get_contents("../api/tongji/jiekou/fiction.dat")); ?>
<?php @$fictionx = intval(file_get_contents("../api/tongji/jinri/".date("Y-m-d")."/fiction.dat")); ?>
...
<title>搜狗小说 - <?php echo $ming; ?>API</title>
...
<legend>搜狗小说API</legend>
</fieldset>
<blockquote class="layui-elem-quote">本接口总调用：<?php echo $fiction; ?>次·今日调用：<?php echo $fictionx; ?>次</blockquote>
</div>
...
<span class="url" data-clipboard-text="http://<?php echo $_SERVER['HTTP_HOST'];?>/api/fiction.php">http://<?php echo $_SERVER['HTTP_HOST'];?>/api/fiction.php</span>
</p>
<p class="simpleTable">
...
<span class="url" data-clipboard-text="http://<?php echo $_SERVER['HTTP_HOST'];?>/api/fiction.php?msg=吉云&b=1">http://<?php echo $_SERVER['HTTP_HOST'];?>/api/fiction.php?msg=吉云&b=1</span>
</p>
...
<tbody>
<tr><td>msg</td><td>是</td><td>需要查询的小说名</td></tr>
...
$result = file_get_contents("http://".$_SERVER['HTTP_HOST']."/api/fiction.php?msg=吉云&b=1");
echo $result;
?></pre>
</div>
...
<pre class="layui-code"><a style="color:#fd4b5c;text-decoration:none；" target="_blank">搜狗小说
<?php echo $ming; ?>API搜狗小说\n
━━━━━━━━━\n
用户:@%昵称%\n
━━━━━━━━━\n
搜狗小说 [名字]\n
━━━━━━━━━\n
请求示例：http://<?php echo $_SERVER['HTTP_HOST'];?>/tianyi/fiction.php\n
━━━━━━━━━\n
Tips:<?php echo $ming; ?>API技术支持

搜狗小说 .*
$写 <?php echo $ming; ?>API/%群号%/%QQ% 搜狗小说 %参数1%$
$访问 http://<?php echo $_SERVER['HTTP_HOST'];?>/api/fiction.php?msg=%参数1%$

选搜狗小说 .*
W:$读 <?php echo $ming; ?>API/%群号%/%QQ% 搜狗小说 %参数1%$
$访问 http://<?php echo $_SERVER['HTTP_HOST'];?>/api/fiction.php?msg=%W%&b=%参数1%$</per>
</div>
</div>
</div>
</div>
