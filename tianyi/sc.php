...
<?php @$sc = intval(file_get_contents("../api/tongji/jiekou/sc.dat")); ?>
<?php @$scx = intval(file_get_contents("../api/tongji/jinri/".date("Y-m-d")."/sc.dat")); ?>
...
<title>诗词搜索 - <?php echo $ming; ?>API</title>
...
<legend>诗词搜索API</legend>
</fieldset>
<blockquote class="layui-elem-quote">本接口总调用：<?php echo $sc; ?>次·今日调用：<?php echo $scx; ?>次</blockquote>
</div>
...
<span class="url" data-clipboard-text="http://<?php echo $_SERVER['HTTP_HOST'];?>/api/sc.php">http://<?php echo $_SERVER['HTTP_HOST'];?>/api/sc.php</span>
</p>
<p class="simpleTable">
...
<span class="url" data-clipboard-text="http://<?php echo $_SERVER['HTTP_HOST'];?>/api/sc.php?msg=吉云&b=1">http://<?php echo $_SERVER['HTTP_HOST'];?>/api/sc.php?msg=吉云&b=1</span>
</p>
...
<tbody>
<tr><td>msg</td><td>是</td><td>需要搜索的古诗名</td></tr>
...
$result = file_get_contents("http://".$_SERVER['HTTP_HOST']."/api/sc.php?msg=吉云&b=1");
echo $result;
?></pre>
</div>
...
<pre class="layui-code"><a style="color:#fd4b5c;text-decoration:none；" target="_blank">诗词搜索
<?php echo $ming; ?>API诗词搜索\n
━━━━━━━━━\n
用户:@%昵称%\n
━━━━━━━━━\n
诗词搜索 [内容]\n
━━━━━━━━━\n
请求示例：http://<?php echo $_SERVER['HTTP_HOST'];?>/tianyi/sc.php\n
━━━━━━━━━\n
Tips:<?php echo $ming; ?>API技术支持

诗词搜索 .*
$写 <?php echo $ming; ?>API/%群号%/%QQ% 诗词搜索 %参数1%$
$访问 http://<?php echo $_SERVER['HTTP_HOST'];?>/api/sc.php?msg=%参数1%$

选诗词搜索 .*
i:$读 <?php echo $ming; ?>API/%群号%/%QQ% 诗词搜索 %参数1%$
$访问 http://<?php echo $_SERVER['HTTP_HOST'];?>/api/sc.php?msg=%i%&b=%参数1%$</per>
</div>
</div>
</div>
</div>
