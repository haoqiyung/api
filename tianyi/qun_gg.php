...
<?php @$qun_gg = intval(file_get_contents("../api/tongji/jiekou/qun_gg.dat")); ?>
<?php @$qun_ggx = intval(file_get_contents("../api/tongji/jinri/".date("Y-m-d")."/qun_gg.dat")); ?>
...
<title>QQ群公告查询 - <?php echo $ming; ?>API</title>
...
<legend>QQ群公告查询API</legend>
</fieldset>
<blockquote class="layui-elem-quote">本接口总调用：<?php echo $qun_gg; ?>次·今日调用：<?php echo $qun_ggx; ?>次</blockquote>
</div>
...
<span class="url" data-clipboard-text="http://<?php echo $_SERVER['HTTP_HOST'];?>/api/qun_gg.php">http://<?php echo $_SERVER['HTTP_HOST'];?>/api/qun_gg.php</span>
</p>
<p class="simpleTable">
...
<span class="url" data-clipboard-text="http://<?php echo $_SERVER['HTTP_HOST'];?>/api/qun_gg.php?qq=[QQ]&skey=[SKEY]&pskey=[PSKEY]&group=[群号]">http://<?php echo $_SERVER['HTTP_HOST'];?>/api/qun_gg.php?qq=[QQ]&skey=[SKEY]&pskey=[PSKEY]&group=[群号]</span>
</p>
...
P:@P[pskey]
P:@P[qun.qq.com]
<?php echo $ming; ?>API♧QQ群公告查询\n
━━━━━━━━━\n
用户:@%昵称%\n
━━━━━━━━━\n
$访问 http://<?php echo $_SERVER['HTTP_HOST'];?>/api/qun_gg.php?qq=%Robot%&skey=%Skey%&pskey=%P%&group=%群号%$\n
━━━━━━━━━\n
请求示例：http://<?php echo $_SERVER['HTTP_HOST'];?>/tianyi/qun_gg.php\n
━━━━━━━━━\n
