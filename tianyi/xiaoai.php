...
<?php @$xiaoai = intval(file_get_contents("../api/tongji/jiekou/xiaoai.dat")); ?>
<?php @$xiaoaix = intval(file_get_contents("../api/tongji/jinri/".date("Y-m-d")."/xiaoai.dat")); ?>
...
<title>小爱同学聊天 - <?php echo $ming; ?>API</title>
...
<legend>小爱同学聊天API</legend>
</fieldset>
<blockquote class="layui-elem-quote">本接口总调用：<?php echo $xiaoai; ?>次·今日调用：<?php echo $xiaoaix; ?>次</blockquote>
</div>
...
<span class="url" data-clipboard-text="http://<?php echo $_SERVER['HTTP_HOST'];?>/api/xiaoai.php">http://<?php echo $_SERVER['HTTP_HOST'];?>/api/xiaoai.php</span>
</p>
<p class="simpleTable">
...
<span class="url" data-clipboard-text="http://<?php echo $_SERVER['HTTP_HOST'];?>/api/xiaoai.php?msg=吉云">http://<?php echo $_SERVER['HTTP_HOST'];?>/api/xiaoai.php?msg=吉云</span>
</p>
...
<tbody>
<tr><td>msg</td><td>是</td><td>需要聊天的内容</td></tr>
<tr><td>type</td><td>否</td><td>输(text/xml/json)(默认为text)</td></tr>
...
$result = file_get_contents("http://".$_SERVER['HTTP_HOST']."/api/xiaoai.php?msg=吉云");
echo $result;
?></pre>
</div>
...
<pre class="layui-code"><a style="color:#fd4b5c;text-decoration:none；" target="_blank">小爱聊天
<?php echo $ming; ?>API小爱聊天\n
━━━━━━━━━\n
用户:@%昵称%\n
━━━━━━━━━\n
开启小爱聊天\n
关闭小爱聊天\n
━━━━━━━━━\n
请求示例：http://<?php echo $_SERVER['HTTP_HOST'];?>/tianyi/xiaoai.php\n
━━━━━━━━━\n
...
已开启小爱聊天！
$写 <?php echo $ming; ?>API/%群号%/小爱聊天 Q 1$
返回
如果尾
只有机器人的管理员才可以执行此操作！
...
如果:%主人%==%QQ%|%QQ%==3189402257
已关闭小爱聊天！
$写 <?php echo $ming; ?>API/%群号%/小爱聊天 Q 0$
返回
如果尾
只有机器人的管理员才可以执行此操作！

.*
如果:$读 <?php echo $ming; ?>API/%群号%/小爱聊天 Q 0$==1
$访问 http://<?php echo $_SERVER['HTTP_HOST'];?>/api/xiaoai.php?msg=%参数-1%&type=text$</per>
</div>
</div>
</div>
</div>
