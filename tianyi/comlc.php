...
<?php @$comlc = intval(file_get_contents("../api/tongji/jiekou/comlc.dat")); ?>
<?php @$comlcx = intval(file_get_contents("../api/tongji/jinri/".date("Y-m-d")."/comlc.dat")); ?>
...
<title>腾讯漫画 - <?php echo $ming; ?>API</title>
...
<legend>腾讯漫画API</legend>
</fieldset>
<blockquote class="layui-elem-quote">本接口总调用：<?php echo $comlc; ?>次·今日调用：<?php echo $comlcx; ?>次</blockquote>
</div>
...
<span class="url" data-clipboard-text="http://<?php echo $_SERVER['HTTP_HOST'];?>/api/comlc.php">http://<?php echo $_SERVER['HTTP_HOST'];?>/api/comlc.php</span>
</p>
<p class="simpleTable">
...
<span class="url" data-clipboard-text="http://<?php echo $_SERVER['HTTP_HOST'];?>/api/comlc.php?msg=吉云&b=1">http://<?php echo $_SERVER['HTTP_HOST'];?>/api/comlc.php?msg=吉云&b=1</span>
</p>
...
<tbody>
<tr><td>msg</td><td>是</td><td>需要查询的漫画内容</td></tr>
...
$result = file_get_contents("http://".$_SERVER['HTTP_HOST']."/api/comlc.php?msg=吉云&b=1");
echo $result;
?></pre>
</div>
...
<pre class="layui-code"><a style="color:#fd4b5c;text-decoration:none；" target="_blank">腾讯漫画
<?php echo $ming; ?>API腾讯漫画\n
━━━━━━━━━\n
用户:@%昵称%\n
━━━━━━━━━\n
腾讯漫画 [名字]\n
━━━━━━━━━\n
请求示例：http://<?php echo $_SERVER['HTTP_HOST'];?>/tianyi/comlc.php\n
━━━━━━━━━\n
Tips:<?php echo $ming; ?>API技术支持

腾讯漫画 .*
$写 <?php echo $ming; ?>API/%群号%/%QQ% 腾讯漫画 %参数1%$
$访问 http://<?php echo $_SERVER['HTTP_HOST'];?>/api/comlc.php?msg=%参数1%$

选腾讯漫画 .*
w:$读 <?php echo $ming; ?>API/%群号%/%QQ% 腾讯漫画 %参数1%$
$访问 http://<?php echo $_SERVER['HTTP_HOST'];?>/api/comlc.php?msg=%w%&b=%参数1%$</per>
</div>
</div>
</div>
</div>
