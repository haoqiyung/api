...
<?php @$wangzhe = intval(file_get_contents("../api/tongji/jiekou/wangzhe.dat")); ?>
<?php @$wangzhex = intval(file_get_contents("../api/tongji/jinri/".date("Y-m-d")."/wangzhe.dat")); ?>
...
<title>王者人物 - <?php echo $ming; ?>API</title>
...
<legend>王者人物API</legend>
</fieldset>
<blockquote class="layui-elem-quote">本接口总调用：<?php echo $wangzhe; ?>次·今日调用：<?php echo $wangzhex; ?>次</blockquote>
</div>
...
<span class="url" data-clipboard-text="http://<?php echo $_SERVER['HTTP_HOST'];?>/api/wangzhe.php">http://<?php echo $_SERVER['HTTP_HOST'];?>/api/wangzhe.php</span>
</p>
<p class="simpleTable">
...
<span class="url" data-clipboard-text="http://<?php echo $_SERVER['HTTP_HOST'];?>/api/wangzhe.php?msg=妲己">http://<?php echo $_SERVER['HTTP_HOST'];?>/api/wangzhe.php?msg=妲己</span>
</p>
...
<tbody>
<tr><td>msg</td><td>是</td><td>需要查询的人物名</td></tr>
...
$result = file_get_contents("http://".$_SERVER['HTTP_HOST']."/api/wangzhe.php?msg=妲己");
echo $result;
?></pre>
</div>
...
<pre class="layui-code"><a style="color:#fd4b5c;text-decoration:none；" target="_blank">王者人物
<?php echo $ming; ?>API王者人物\n
━━━━━━━━━\n
用户:@%昵称%\n
━━━━━━━━━\n
王者人物 [内容]\n
━━━━━━━━━\n
请求示例：http://<?php echo $_SERVER['HTTP_HOST'];?>/tianyi/wangzhe.php\n
━━━━━━━━━\n
...
用户:@%昵称%\n
━━━━━━━━━\n
$访问 http://<?php echo $_SERVER['HTTP_HOST'];?>/api/wangzhe.php?msg=%参数1%$\n
━━━━━━━━━\n
