...
<?php @$daan = intval(file_get_contents("../api/tongji/jiekou/daan.dat")); ?>
<?php @$daanx = intval(file_get_contents("../api/tongji/jinri/".date("Y-m-d")."/daan.dat")); ?>
...
<title>答案之书 - <?php echo $ming; ?>API</title>
...
<legend>答案之书API</legend>
</fieldset>
<blockquote class="layui-elem-quote">本接口总调用：<?php echo $daan; ?>次·今日调用：<?php echo $daanx; ?>次</blockquote>
</div>
...
<span class="url" data-clipboard-text="http://<?php echo $_SERVER['HTTP_HOST'];?>/api/daan.php">http://<?php echo $_SERVER['HTTP_HOST'];?>/api/daan.php</span>
</p>
<p class="simpleTable">
...
$result = file_get_contents("http://".$_SERVER['HTTP_HOST']."/api/daan.php");
echo $result;
?></pre>
</div>
...
<pre class="layui-code"><a style="color:#fd4b5c;text-decoration:none；" target="_blank">答案之书
$访问 http://<?php echo $_SERVER['HTTP_HOST'];?>/api/daan.php$</per>
</div>
</div>
</div>
</div>
