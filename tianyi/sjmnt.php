...
<?php @$sjmnt = intval(file_get_contents("../api/tongji/jiekou/sjmnt.dat")); ?>
<?php @$sjmntx = intval(file_get_contents("../api/tongji/jinri/".date("Y-m-d")."/sjmnt.dat")); ?>
...
<blockquote class="layui-elem-quote">本接口总调用：<?php echo $sjmnt; ?>次·今日调用：<?php echo $sjmntx; ?>次</blockquote>
</div>
...
<span class="url" data-clipboard-text="http://<?php echo $_SERVER['HTTP_HOST'];?>/api/sjmnt.php">http://<?php echo $_SERVER['HTTP_HOST'];?>/api/sjmnt.php</span>
</p>
<p class="simpleTable">
...
<pre class="layui-code"><img src="../api/sjmnt.php" style="width: 45%;"></pre>
</div>
...
用户:@%昵称%\n
━━━━━━━━━\n
±img=http://<?php echo $_SERVER['HTTP_HOST'];?>/api/sjmnt.php±\n
━━━━━━━━━\n
请求示例：http://<?php echo $_SERVER['HTTP_HOST'];?>/tianyi/sjmnt.php\n
━━━━━━━━━\n
