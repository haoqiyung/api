...
<?php @$zuowen = intval(file_get_contents("../api/tongji/jiekou/zuowen.dat")); ?>
<?php @$zuowenx = intval(file_get_contents("../api/tongji/jinri/".date("Y-m-d")."/zuowen.dat")); ?>
...
<title>作文搜索 - <?php echo $ming; ?>API</title>
...
<legend>作文搜索API</legend>
</fieldset>
<blockquote class="layui-elem-quote">本接口总调用：<?php echo $zuowen; ?>次·今日调用：<?php echo $zuowenx; ?>次</blockquote>
</div>
...
<span class="url" data-clipboard-text="http://<?php echo $_SERVER['HTTP_HOST'];?>/api/zuowen.php">http://<?php echo $_SERVER['HTTP_HOST'];?>/api/zuowen.php</span>
</p>
<p class="simpleTable">
...
<span class="url" data-clipboard-text="http://<?php echo $_SERVER['HTTP_HOST'];?>/api/zuowen.php?msg=吉云&b=1">http://<?php echo $_SERVER['HTTP_HOST'];?>/api/zuowen.php?msg=吉云&b=1</span>
</p>
...
<tbody>
<tr><td>msg</td><td>是</td><td>需要搜索的作文名</td></tr>
...
$result = file_get_contents("http://".$_SERVER['HTTP_HOST']."/api/zuowen.php?msg=吉云&b=1");
echo $result;
?></pre>
</div>
...
<pre class="layui-code"><a style="color:#fd4b5c;text-decoration:none；" target="_blank">作文搜索
<?php echo $ming; ?>API作文搜索\n
━━━━━━━━━\n
用户:@%昵称%\n
━━━━━━━━━\n
作文搜索 [内容]\n
━━━━━━━━━\n
请求示例：http://<?php echo $_SERVER['HTTP_HOST'];?>/tianyi/zuowen.php\n
━━━━━━━━━\n
Tips:<?php echo $ming; ?>API技术支持

作文搜索 .*
$写 <?php echo $ming; ?>API/%群号%/%QQ% 作文搜索 %参数1%$
$访问 http://<?php echo $_SERVER['HTTP_HOST'];?>/api/zuowen.php?msg=%参数1%$

选作文搜索 .*
P:$读 <?php echo $ming; ?>API/%群号%/%QQ% 作文搜索 %参数1%$
$访问 http://<?php echo $_SERVER['HTTP_HOST'];?>/api/zuowen.php?msg=%P%&b=%参数1%$</per>
</div>
</div>
</div>
</div>
