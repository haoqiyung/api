...
<?php @$lingsheng = intval(file_get_contents("../api/tongji/jiekou/lingsheng.dat")); ?>
<?php @$lingshengx = intval(file_get_contents("../api/tongji/jinri/".date("Y-m-d")."/lingsheng.dat")); ?>
...
<title>铃声多多 - <?php echo $ming; ?>API</title>
...
<legend>铃声多多API</legend>
</fieldset>
<blockquote class="layui-elem-quote">本接口总调用：<?php echo $lingsheng; ?>次·今日调用：<?php echo $lingshengx; ?>次</blockquote>
</div>
...
<span class="url" data-clipboard-text="http://<?php echo $_SERVER['HTTP_HOST'];?>/api/lingsheng.php">http://<?php echo $_SERVER['HTTP_HOST'];?>/api/lingsheng.php</span>
</p>
<p class="simpleTable">
...
<span class="url" data-clipboard-text="http://<?php echo $_SERVER['HTTP_HOST'];?>/api/lingsheng.php?msg=9420&b=1">http://<?php echo $_SERVER['HTTP_HOST'];?>/api/lingsheng.php?msg=9420&b=1</span>
</p>
...
<tbody>
<tr><td>msg</td><td>是</td><td>需要查询的歌曲名</td></tr>
<tr><td>b</td><td>是</td><td>选择(序号)</td></tr>
<tr><td>c</td><td>否</td><td>搜索歌曲页数(默认10页)</td></tr>
...
$result = file_get_contents("http://".$_SERVER['HTTP_HOST']."/api/lingsheng.php?msg=9420&b=1");
echo $result;
?></pre>
</div>
...
<pre class="layui-code"><a style="color:#fd4b5c;text-decoration:none；" target="_blank">铃声多多
<?php echo $ming; ?>API铃声多多\n
━━━━━━━━━\n
用户:@%昵称%\n
━━━━━━━━━\n
铃声多多 [名字]\n
...
铃声多多 .*
$写 <?php echo $ming; ?>API/%群号%/%QQ% 铃声多多 %参数1%$
$访问 http://<?php echo $_SERVER['HTTP_HOST'];?>/api/lingsheng.php?msg=%参数1%$

选铃声多多 .*
Y:$读 <?php echo $ming; ?>API/%群号%/%QQ% 铃声多多 %参数1%$
$访问 http://<?php echo $_SERVER['HTTP_HOST'];?>/api/lingsheng.php?msg=%Y%&b=%参数1%$</per>
</div>
</div>
</div>
</div>
