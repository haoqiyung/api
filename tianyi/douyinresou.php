...
<?php @$douyinresou = intval(file_get_contents("../api/tongji/jiekou/douyinresou.dat")); ?>
<?php @$douyinresoux = intval(file_get_contents("../api/tongji/jinri/".date("Y-m-d")."/douyinresou.dat")); ?>
...
<title>抖音热搜榜获取 - <?php echo $ming; ?>API</title>
...
<legend>抖音热搜榜获取API</legend>
</fieldset>
<blockquote class="layui-elem-quote">本接口总调用：<?php echo $douyinresou; ?>次·今日调用：<?php echo $douyinresoux; ?>次</blockquote>
</div>
...
<span class="url" data-clipboard-text="http://<?php echo $_SERVER['HTTP_HOST'];?>/api/douyinresou.php">http://<?php echo $_SERVER['HTTP_HOST'];?>/api/douyinresou.php</span>
</p>
<p class="simpleTable">
...
$result = file_get_contents("http://".$_SERVER['HTTP_HOST']."/api/douyinresou.php");
echo $result;
?></pre>
</div>
...
<pre class="layui-code"><a style="color:#fd4b5c;text-decoration:none；" target="_blank">抖音热搜榜获取
$访问 http://<?php echo $_SERVER['HTTP_HOST'];?>/api/douyinresou.php$</per>
</div>
</div>
</div>
</div>
