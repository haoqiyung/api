...
<title>快手颜值视频 - <?php echo $ming; ?>API</title>
...
<span class="url" data-clipboard-text="http://<?php echo $_SERVER['HTTP_HOST'];?>/api/ks_yanzhi.php">http://<?php echo $_SERVER['HTTP_HOST'];?>/api/ks_yanzhi.php</span>
</p>
<p class="simpleTable">
...
<tbody>
<tr><td>lx</td><td>否</td><td>输(推荐/美女/帅哥)(默认推荐)</td></tr>
...
$result = file_get_contents("http://".$_SERVER['HTTP_HOST']."/api/ks_yanzhi.php");
echo $result;
?></pre>
</div>
...
<pre class="layui-code"><a style="color:#fd4b5c;text-decoration:none；" target="_blank">快手颜值视频
<?php echo $ming; ?>API快手颜值视频\n
━━━━━━━━━\n
用户:@%昵称%\n
━━━━━━━━━\n
$访问 http://<?php echo $_SERVER['HTTP_HOST'];?>/api/ks_yanzhi.php$\n
━━━━━━━━━\n
请求示例：http://<?php echo $_SERVER['HTTP_HOST'];?>/tianyi/ks_yanzhi.php\n
━━━━━━━━━\n
