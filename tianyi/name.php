...
<?php @$name = intval(file_get_contents("../api/tongji/jiekou/name.dat")); ?>
<?php @$namex = intval(file_get_contents("../api/tongji/jinri/".date("Y-m-d")."/name.dat")); ?>
...
<title>你是由什么组成的 - <?php echo $ming; ?>API</title>
...
<legend>你是由什么组成的API</legend>
</fieldset>
<blockquote class="layui-elem-quote">本接口总调用：<?php echo $name; ?>次·今日调用：<?php echo $namex; ?>次</blockquote>
</div>
...
<span class="url" data-clipboard-text="http://<?php echo $_SERVER['HTTP_HOST'];?>/api/name.php">http://<?php echo $_SERVER['HTTP_HOST'];?>/api/name.php</span>
</p>
<p class="simpleTable">
...
<span class="url" data-clipboard-text="http://<?php echo $_SERVER['HTTP_HOST'];?>/api/name.php?msg=吉云">http://<?php echo $_SERVER['HTTP_HOST'];?>/api/name.php?msg=吉云</span>
</p>
...
<tbody>
<tr><td>msg</td><td>是</td><td>需要生成的名字</td></tr>
...
$result = file_get_contents("http://".$_SERVER['HTTP_HOST']."/api/name.php?msg=吉云");
echo $result;
?></pre>
</div>
...
<pre class="layui-code"><a style="color:#fd4b5c;text-decoration:none；" target="_blank">你是由什么组成的
<?php echo $ming; ?>API你是由什么组成的\n
━━━━━━━━━\n
用户:@%昵称%\n
━━━━━━━━━\n
你是由什么组成的 [名字]\n
━━━━━━━━━\n
请求示例：http://<?php echo $_SERVER['HTTP_HOST'];?>/tianyi/name.php\n
━━━━━━━━━\n
Tips:<?php echo $ming; ?>API技术支持

你是由什么组成的 .*
$访问 http://<?php echo $_SERVER['HTTP_HOST'];?>/api/name.php?msg=%参数1%$</per>
</div>
</div>
</div>
</div>
