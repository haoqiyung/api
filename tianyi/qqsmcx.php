...
<?php @$qqsmcx = intval(file_get_contents("../api/tongji/jiekou/qqsmcx.dat")); ?>
<?php @$qqsmcxx = intval(file_get_contents("../api/tongji/jinri/".date("Y-m-d")."/qqsmcx.dat")); ?>
...
<title>QQ号(实名/成年)查询 - <?php echo $ming; ?>API</title>
<meta name="keywords" content=""/>
<meta name="description" content="">    
<link rel="stylesheet" href="./assets/css/layer.css">
<script src="https://ku.oioweb.cn/LayUI/2.5.4/layui.all.js"></script>
<style>.url{word-break:break-all;cursor:pointer;margin-left:5px;color:#777;border:none;border-radius:0;border-bottom:2px solid #5FB878;}.simpleTable{line-height:20px;padding-bottom:16px;}.linep{font-size:14px;font-weight:700;color:#555;padding-left:14px;height:16px;line-height:16px;margin-bottom:18px;position:relative;margin-top:15px;}.linep:before{content:'';width:4px;height:16px;background:#00aeff;border-radius:2px;position:absolute;left:0;top:0;}::-weqqsmcxit-scrollbar{width:9px;height:9px}::-weqqsmcxit-scrollbar-track-piece{background-color:#ebebeb;-weqqsmcxit-border-radius:4px}::-weqqsmcxit-scrollbar-thumb:vertical{height:32px;background-color:#ccc;-weqqsmcxit-border-radius:4px}::-weqqsmcxit-scrollbar-thumb:horizontal{width:32px;background-color:#ccc;-weqqsmcxit-border-radius:4px}</style>
</head>
<body>
<div class="layui-container">
<div class="layui-row">
<fieldset class="layui-elem-field layui-field-title" style="margin-top: 20px;">
<legend>QQ号(实名/成年)查询API</legend>
</fieldset>
<blockquote class="layui-elem-quote">本接口总调用：<?php echo $qqsmcx; ?>次·今日调用：<?php echo $qqsmcxx; ?>次</blockquote>
</div>
...
<span class="url" data-clipboard-text="http://<?php echo $_SERVER['HTTP_HOST'];?>/api/qqsmcx.php">http://<?php echo $_SERVER['HTTP_HOST'];?>/api/qqsmcx.php</span>
</p>
<p class="simpleTable">
...
<span class="url" data-clipboard-text="http://<?php echo $_SERVER['HTTP_HOST'];?>/api/qqsmcx.php?qq=3189402257">http://<?php echo $_SERVER['HTTP_HOST'];?>/api/qqsmcx.php?qq=3189402257</span>
</p>
...
<tbody>
<tr><td>qq</td><td>是</td><td>需要查询的QQ号</td></tr>
...
$result = file_get_contents("http://".$_SERVER['HTTP_HOST']."/api/qqsmcx.php?qq=3189402257");
echo $result;
?></pre>
</div>
...
<pre class="layui-code"><a style="color:#fd4b5c;text-decoration:none；" target="_blank">QQ号(实名/成年)查询
<?php echo $ming; ?>API♧QQ号(实名/成年)查询\n
━━━━━━━━━\n
用户:@%昵称%\n
━━━━━━━━━\n
QQ号(实名/成年)查询 [QQ号]\n
━━━━━━━━━\n
请求示例：http://<?php echo $_SERVER['HTTP_HOST'];?>/tianyi/qqsmcx.php\n
━━━━━━━━━\n
Tips:<?php echo $ming; ?>API技术支持

QQ号(实名/成年)查询 .*
$访问 http://<?php echo $_SERVER['HTTP_HOST'];?>/api/qqsmcx.php?qq=%参数1%$</per>
</div>
</div>
</div>
</div>
