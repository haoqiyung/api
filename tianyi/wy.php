...
<?php @$wy = intval(file_get_contents("../api/tongji/jiekou/wy.dat")); ?>
<?php @$wyx = intval(file_get_contents("../api/tongji/jinri/".date("Y-m-d")."/wy.dat")); ?>
...
<title>网易云音乐 - <?php echo $ming; ?>API</title>
...
<legend>网易云音乐API</legend>
</fieldset>
<blockquote class="layui-elem-quote">本接口总调用：<?php echo $wy; ?>次·今日调用：<?php echo $wyx; ?>次</blockquote>
</div>
...
<span class="url" data-clipboard-text="http://<?php echo $_SERVER['HTTP_HOST'];?>/api/wy.php">http://<?php echo $_SERVER['HTTP_HOST'];?>/api/wy.php</span>
</p>
<p class="simpleTable">
...
<span class="url" data-clipboard-text="http://<?php echo $_SERVER['HTTP_HOST'];?>/api/wy.php?msg=吉云&b=1">http://<?php echo $_SERVER['HTTP_HOST'];?>/api/wy.php?msg=吉云&b=1</span>
</p>
...
$result = file_get_contents("http://".$_SERVER['HTTP_HOST']."/api/wy.php?msg=吉云&b=1");
echo $result;
?></pre>
</div>
...
<pre class="layui-code"><a style="color:#fd4b5c;text-decoration:none；" target="_blank">网易云音乐
<?php echo $ming; ?>API网易云音乐\n
━━━━━━━━━\n
用户:@%昵称%\n
━━━━━━━━━\n
网易云音乐 [名字]\n
━━━━━━━━━\n
请求示例：http://<?php echo $_SERVER['HTTP_HOST'];?>/tianyi/wy.php\n
━━━━━━━━━\n
Tips:<?php echo $ming; ?>API技术支持

网易云音乐 .*
$写 <?php echo $ming; ?>API/%群号%/网易云音乐 %QQ% %参数1%$
$访问 http://<?php echo $_SERVER['HTTP_HOST'];?>/api/wy.php?msg=%参数1%$

选网易云音乐 .*
O:$读 <?php echo $ming; ?>API/%群号%/网易云音乐 %QQ% %参数1%$
$访问 http://<?php echo $_SERVER['HTTP_HOST'];?>/api/wy.php?msg=%O%&b=%参数1%$</per>
</div>
</div>
</div>
</div>
