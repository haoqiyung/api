...
<?php @$mima = intval(file_get_contents("../api/tongji/jiekou/mima.dat")); ?>
<?php @$mimax = intval(file_get_contents("../api/tongji/jinri/".date("Y-m-d")."/mima.dat")); ?>
...
<title>随机密码 - <?php echo $ming; ?>API</title>
...
<legend>随机密码API</legend>
</fieldset>
<blockquote class="layui-elem-quote">本接口总调用：<?php echo $mima; ?>次·今日调用：<?php echo $mimax; ?>次</blockquote>
</div>
...
<span class="url" data-clipboard-text="http://<?php echo $_SERVER['HTTP_HOST'];?>/api/mima.php">http://<?php echo $_SERVER['HTTP_HOST'];?>/api/mima.php</span>
</p>
<p class="simpleTable">
...
<span class="url" data-clipboard-text="http://<?php echo $_SERVER['HTTP_HOST'];?>/api/mima.php?msg=9">http://<?php echo $_SERVER['HTTP_HOST'];?>/api/mima.php?msg=9</span>
</p>
...
<tbody>
<tr><td>msg</td><td>是</td><td>输数字</td></tr>
</tbody>
</table>
...
$result = file_get_contents("http://".$_SERVER['HTTP_HOST']."/api/mima.php?msg=9");
echo $result;
?></pre>
</div>
...
<pre class="layui-code"><a style="color:#fd4b5c;text-decoration:none；" target="_blank">随机密码
<?php echo $ming; ?>API随机密码\n
━━━━━━━━━\n
用户:@%昵称%\n
━━━━━━━━━\n
随机密码 [数字]\n
━━━━━━━━━\n
请求示例：http://<?php echo $_SERVER['HTTP_HOST'];?>/tianyi/mima.php\n
━━━━━━━━━\n
...
用户:@%昵称%\n
━━━━━━━━━\n
$访问 http://<?php echo $_SERVER['HTTP_HOST'];?>/api/mima.php?msg=%参数1%$\n
━━━━━━━━━\n
