...
<?php @$tianqi = intval(file_get_contents("../api/tongji/jiekou/tianqi.dat")); ?>
<?php @$tianqix = intval(file_get_contents("../api/tongji/jinri/".date("Y-m-d")."/tianqi.dat")); ?>
...
<title>墨迹天气 - <?php echo $ming; ?>API</title>
...
<legend>墨迹天气API</legend>
</fieldset>
<blockquote class="layui-elem-quote">本接口总调用：<?php echo $tianqi; ?>次·今日调用：<?php echo $tianqix; ?>次</blockquote>
</div>
...
<span class="url" data-clipboard-text="http://<?php echo $_SERVER['HTTP_HOST'];?>/api/tianqi.php">http://<?php echo $_SERVER['HTTP_HOST'];?>/api/tianqi.php</span>
</p>
<p class="simpleTable">
...
<span class="url" data-clipboard-text="http://<?php echo $_SERVER['HTTP_HOST'];?>/api/tianqi.php?msg=农安&b=1">http://<?php echo $_SERVER['HTTP_HOST'];?>/api/tianqi.php?msg=农安&b=1</span>
</p>
...
<tbody>
<tr><td>msg</td><td>是</td><td>需要查询的城市名</td></tr>
...
$result = file_get_contents("http://".$_SERVER['HTTP_HOST']."/api/tianqi.php?msg=农安&b=1");
echo $result;
?></pre>
</div>
...
<pre class="layui-code"><a style="color:#fd4b5c;text-decoration:none；" target="_blank">墨迹天气
<?php echo $ming; ?>API墨迹天气\n
━━━━━━━━━\n
用户:@%昵称%\n
━━━━━━━━━\n
墨迹天气 [名字]\n
━━━━━━━━━\n
请求示例：http://<?php echo $_SERVER['HTTP_HOST'];?>/tianyi/tianqi.php\n
━━━━━━━━━\n
Tips:<?php echo $ming; ?>API技术支持

墨迹天气 .*
$写 <?php echo $ming; ?>API/%群号%/%QQ% 墨迹天气 %参数1%$
$访问 http://<?php echo $_SERVER['HTTP_HOST'];?>/api/tianqi.php?msg=%参数1%$

选墨迹天气 .*
o:$读 <?php echo $ming; ?>API/%群号%/%QQ% 墨迹天气 %参数1%$
$访问 http://<?php echo $_SERVER['HTTP_HOST'];?>/api/tianqi.php?msg=%o%&b=%参数1%$</per>
</div>
</div>
</div>
</div>
