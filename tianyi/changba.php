...
<?php @$changba = intval(file_get_contents("../api/tongji/jiekou/changba.dat")); ?>
<?php @$changbax = intval(file_get_contents("../api/tongji/jinri/".date("Y-m-d")."/changba.dat")); ?>
...
<title>唱吧音视频 - <?php echo $ming; ?>API</title>
...
<legend>唱吧音视频API</legend>
</fieldset>
<blockquote class="layui-elem-quote">本接口总调用：<?php echo $changba; ?>次·今日调用：<?php echo $changbax; ?>次</blockquote>
</div>
...
<span class="url" data-clipboard-text="http://<?php echo $_SERVER['HTTP_HOST'];?>/api/changba.php">http://<?php echo $_SERVER['HTTP_HOST'];?>/api/changba.php</span>
</p>
<p class="simpleTable">
...
<tbody>
<tr><td>type</td><td>否</td><td>输出方式text.xml.json.json1(默认text)</td></tr>
...
$result = file_get_contents("http://".$_SERVER['HTTP_HOST']."/api/changba.php");
echo $result;
?></pre>
</div>
...
<pre class="layui-code"><a style="color:#fd4b5c;text-decoration:none；" target="_blank">唱吧音视频
$访问 http://<?php echo $_SERVER['HTTP_HOST'];?>/api/changba.php$</per>
</div>
</div>
</div>
</div>
