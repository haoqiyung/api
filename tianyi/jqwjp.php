...
<?php @$jqwjp = intval(file_get_contents("../api/tongji/jiekou/jqwjp.dat")); ?>
<?php @$jqwjpx = intval(file_get_contents("../api/tongji/jinri/".date("Y-m-d")."/jqwjp.dat")); ?>
...
<title>发光字图 - <?php echo $ming; ?>API</title>
...
<legend>发光字图API</legend>
</fieldset>
<blockquote class="layui-elem-quote">本接口总调用：<?php echo $jqwjp; ?>次·今日调用：<?php echo $jqwjpx; ?>次</blockquote>
</div>
...
<span class="url" data-clipboard-text="http://<?php echo $_SERVER['HTTP_HOST'];?>/api/st.php">http://<?php echo $_SERVER['HTTP_HOST'];?>/api/st.php</span>
</p>
<p class="simpleTable">
...
<span class="url" data-clipboard-text="http://<?php echo $_SERVER['HTTP_HOST'];?>/api/jqwjp.php?id=1&msg=吉云">http://<?php echo $_SERVER['HTTP_HOST'];?>/api/jqwjp.php?id=1&msg=吉云</span>
</p>
...
<tbody>
<tr><td>id</td><td>是</td><td>输数字(1/手写荧光字、2/手写火焰字、3/手写炫彩字、4/连笔荧光字、5/连笔火焰字、6/连笔黑色字、7/连笔玉雕字、8/连笔刻雕字、9/艺术花鸟签)</td></tr>
<tr><td>msg</td><td>是</td><td>需要生成的内容</td></tr>
</tbody>
</table>
...
$result = file_get_contents("http://".$_SERVER['HTTP_HOST']."/api/jqwjp.php?id=9&msg=吉云");
echo $result;
?></pre>
</div>
...
<pre class="layui-code"><a style="color:#fd4b5c;text-decoration:none；" target="_blank">发光字图
<?php echo $ming; ?>API发光字图\n
━━━━━━━━━\n
用户:@%昵称%\n
━━━━━━━━━\n
手写荧光字 [内容]\n
...
艺术花鸟签 [内容]\n
━━━━━━━━━\n
请求示例：http://<?php echo $_SERVER['HTTP_HOST'];?>/tianyi/jqwjp.php\n
━━━━━━━━━\n
...
用户:@%昵称%\n
━━━━━━━━━\n
±img=$访问 http://<?php echo $_SERVER['HTTP_HOST'];?>/api/jqwjp.php?id=1&msg=%参数1%$±\n
━━━━━━━━━\n
Tips:<?php echo $ming; ?>API技术支持
...
用户:@%昵称%\n
━━━━━━━━━\n
±img=$访问 http://<?php echo $_SERVER['HTTP_HOST'];?>/api/jqwjp.php?id=2&msg=%参数1%$±\n
━━━━━━━━━\n
Tips:<?php echo $ming; ?>API技术支持
...
用户:@%昵称%\n
━━━━━━━━━\n
±img=$访问 http://<?php echo $_SERVER['HTTP_HOST'];?>/api/jqwjp.php?id=3&msg=%参数1%$±\n
━━━━━━━━━\n
Tips:<?php echo $ming; ?>API技术支持
...
用户:@%昵称%\n
━━━━━━━━━\n
±img=$访问 http://<?php echo $_SERVER['HTTP_HOST'];?>/api/jqwjp.php?id=4&msg=%参数1%$±\n
━━━━━━━━━\n
Tips:<?php echo $ming; ?>API技术支持
...
用户:@%昵称%\n
━━━━━━━━━\n
±img=$访问 http://<?php echo $_SERVER['HTTP_HOST'];?>/api/jqwjp.php?id=5&msg=%参数1%$±\n
━━━━━━━━━\n
Tips:<?php echo $ming; ?>API技术支持
...
用户:@%昵称%\n
━━━━━━━━━\n
±img=$访问 http://<?php echo $_SERVER['HTTP_HOST'];?>/api/jqwjp.php?id=6&msg=%参数1%$±\n
━━━━━━━━━\n
Tips:<?php echo $ming; ?>API技术支持
...
用户:@%昵称%\n
━━━━━━━━━\n
±img=$访问 http://<?php echo $_SERVER['HTTP_HOST'];?>/api/jqwjp.php?id=7&msg=%参数1%$±\n
━━━━━━━━━\n
Tips:<?php echo $ming; ?>API技术支持
...
用户:@%昵称%\n
━━━━━━━━━\n
±img=$访问 http://<?php echo $_SERVER['HTTP_HOST'];?>/api/jqwjp.php?id=8&msg=%参数1%$±\n
━━━━━━━━━\n
Tips:<?php echo $ming; ?>API技术支持
...
用户:@%昵称%\n
━━━━━━━━━\n
±img=$访问 http://<?php echo $_SERVER['HTTP_HOST'];?>/api/jqwjp.php?id=9&msg=%参数1%$±\n
━━━━━━━━━\n
