...
<?php @$tipcx = intval(file_get_contents("../api/tongji/jiekou/tipcx.dat")); ?>
<?php @$tipcxx = intval(file_get_contents("../api/tongji/jinri/".date("Y-m-d")."/tipcx.dat")); ?>
...
<title>同IP域名绑定查询 - <?php echo $ming; ?>API</title>
...
<legend>同IP域名绑定查询API</legend>
</fieldset>
<blockquote class="layui-elem-quote">本接口总调用：<?php echo $tipcx; ?>次·今日调用：<?php echo $tipcxx; ?>次</blockquote>
</div>
...
<span class="url" data-clipboard-text="http://<?php echo $_SERVER['HTTP_HOST'];?>/api/tipcx.php">http://<?php echo $_SERVER['HTTP_HOST'];?>/api/tipcx.php</span>
</p>
<p class="simpleTable">
...
<span class="url" data-clipboard-text="http://<?php echo $_SERVER['HTTP_HOST'];?>/api/tipcx.php?ip=111.173.114.208">http://<?php echo $_SERVER['HTTP_HOST'];?>/api/tipcx.php?ip=111.173.114.208</span>
</p>
...
$result = file_get_contents("http://".$_SERVER['HTTP_HOST']."/api/tipcx.php?ip=111.173.114.208");
echo $result;
?></pre>
</div>
...
<pre class="layui-code"><a style="color:#fd4b5c;text-decoration:none；" target="_blank">同IP域名绑定查询
<?php echo $ming; ?>API同IP域名绑定查询\n
━━━━━━━━━\n
用户:@%昵称%\n
━━━━━━━━━\n
同IP域名绑定查询 [IP]\n
━━━━━━━━━\n
请求示例：http://<?php echo $_SERVER['HTTP_HOST'];?>/tianyi/tipcx.php\n
━━━━━━━━━\n
...
用户:@%昵称%\n
━━━━━━━━━\n
$访问 http://<?php echo $_SERVER['HTTP_HOST'];?>/api/tipcx.php?ip=%参数1%$\n
━━━━━━━━━\n
