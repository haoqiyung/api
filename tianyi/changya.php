...
<?php @$changya = intval(file_get_contents("../api/tongji/jiekou/changya.dat")); ?>
<?php @$changyax = intval(file_get_contents("../api/tongji/jinri/".date("Y-m-d")."/changya.dat")); ?>
...
<title>随机唱鸭 - <?php echo $ming; ?>API</title>
...
<legend>随机唱鸭API</legend>
</fieldset>
<blockquote class="layui-elem-quote">本接口总调用：<?php echo $changya; ?>次·今日调用：<?php echo $changyax; ?>次</blockquote>
</div>
...
<span class="url" data-clipboard-text="http://<?php echo $_SERVER['HTTP_HOST'];?>/api/changya.php">http://<?php echo $_SERVER['HTTP_HOST'];?>/api/changya.php</span>
</p>
<p class="simpleTable">
...
$result = file_get_contents("http://".$_SERVER['HTTP_HOST']."/api/changya.php");
echo $result;
?></pre>
</div>
...
<pre class="layui-code"><a style="color:#fd4b5c;text-decoration:none；" target="_blank">随机唱鸭
$访问 http://<?php echo $_SERVER['HTTP_HOST'];?>/api/changya.php$</per>
</div>
</div>
</div>
</div>
