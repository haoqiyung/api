...
<?php @$qqmv = intval(file_get_contents("../api/tongji/jiekou/qqmv.dat")); ?>
<?php @$qqmvx = intval(file_get_contents("../api/tongji/jinri/".date("Y-m-d")."/qqmv.dat")); ?>
...
<title>QQ音乐MV - <?php echo $ming; ?>API</title>
...
<legend>QQ音乐MVAPI</legend>
</fieldset>
<blockquote class="layui-elem-quote">本接口总调用：<?php echo $qqmv; ?>次·今日调用：<?php echo $qqmvx; ?>次</blockquote>
</div>
...
<span class="url" data-clipboard-text="http://<?php echo $_SERVER['HTTP_HOST'];?>/api/qqmv.php">http://<?php echo $_SERVER['HTTP_HOST'];?>/api/qqmv.php</span>
</p>
<p class="simpleTable">
...
<span class="url" data-clipboard-text="http://<?php echo $_SERVER['HTTP_HOST'];?>/api/qqmv.php?msg=9420&b=1">http://<?php echo $_SERVER['HTTP_HOST'];?>/api/qqmv.php?msg=9420&b=1</span>
</p>
...
<pre class="layui-code">本API直接返回卡片</pre>
</div>
...
<pre class="layui-code"><a style="color:#fd4b5c;text-decoration:none；" target="_blank">QQ音乐MV
<?php echo $ming; ?>API♧QQ音乐MV\n
━━━━━━━━━\n
用户:@%昵称%\n
━━━━━━━━━\n
QQ音乐MV [歌曲名]\n
━━━━━━━━━\n
请求示例：http://<?php echo $_SERVER['HTTP_HOST'];?>/tianyi/qqmv.php\n
━━━━━━━━━\n
Tips:<?php echo $ming; ?>API技术支持

QQ音乐MV .*
$写 <?php echo $ming; ?>API/%群号%/%QQ% QQ音乐MV %参数1%$
$访问 http://<?php echo $_SERVER['HTTP_HOST'];?>/api/pamro.php?msg=%参数1%$

选QQ音乐MV .*
U:$读 <?php echo $ming; ?>API/%群号%/%QQ% QQ音乐MV %参数1%$
$访问 http://<?php echo $_SERVER['HTTP_HOST'];?>/api/qqmv.php?msg=%U%&b=%参数1%$</per>
</div>
</div>
</div>
</div>
