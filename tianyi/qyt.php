...
<?php @$qyt = intval(file_get_contents("../api/tongji/jiekou/qyt.dat")); ?>
<?php @$qytx = intval(file_get_contents("../api/tongji/jinri/".date("Y-m-d")."/qyt.dat")); ?>
...
<title>爱奇艺视频热搜词 - <?php echo $ming; ?>API</title>
...
<legend>爱奇艺视频热搜词API</legend>
</fieldset>
<blockquote class="layui-elem-quote">本接口总调用：<?php echo $qyt; ?>次·今日调用：<?php echo $qytx; ?>次</blockquote>
</div>
...
<span class="url" data-clipboard-text="http://<?php echo $_SERVER['HTTP_HOST'];?>/api/qyt.php">http://<?php echo $_SERVER['HTTP_HOST'];?>/api/qyt.php</span>
</p>
<p class="simpleTable">
...
$result = file_get_contents("http://".$_SERVER['HTTP_HOST']."/api/qyt.php");
echo $result;
?></pre></div>
