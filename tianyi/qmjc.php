...
<?php @$qmjc = intval(file_get_contents("../api/tongji/jiekou/qmjc.dat")); ?>
<?php @$qmjcx = intval(file_get_contents("../api/tongji/jinri/".date("Y-m-d")."/qmjc.dat")); ?>
...
<title>域名拦截检测 - <?php echo $ming; ?>API</title>
...
<legend>域名拦截检测API</legend>
</fieldset>
<blockquote class="layui-elem-quote">本接口总调用：<?php echo $qmjc; ?>次·今日调用：<?php echo $qmjcx; ?>次</blockquote>
</div>
...
<span class="url" data-clipboard-text="http://<?php echo $_SERVER['HTTP_HOST'];?>/api/qmjc.php">http://<?php echo $_SERVER['HTTP_HOST'];?>/api/qmjc.php</span>
</p>
<p class="simpleTable">
...
<span class="url" data-clipboard-text="http://<?php echo $_SERVER['HTTP_HOST'];?>/api/qmjc.php?url=https://cloud.vpsidc.com.cn">http://<?php echo $_SERVER['HTTP_HOST'];?>/api/qmjc.php?url=https://cloud.vpsidc.com.cn</span>
</p>
...
<tr><td>hh</td><td>否</td><td>换行符号(默认为\n)</td></tr>
</tbody>
</table>
...
$result = file_get_contents("http://".$_SERVER['HTTP_HOST']."/api/qmjc.php?url=https://cloud.vpsidc.com.cn");
echo $result;
?></pre>
</div>
...
<pre class="layui-code"><a style="color:#fd4b5c;text-decoration:none；" target="_blank">域名拦截检测
<?php echo $ming; ?>API域名拦截检测\n
━━━━━━━━━\n
用户:@%昵称%\n
━━━━━━━━━\n
域名拦截检测 [网址]\n
━━━━━━━━━\n
请求示例：http://<?php echo $_SERVER['HTTP_HOST'];?>/tianyi/qmjc.php\n
━━━━━━━━━\n
Tips:<?php echo $ming; ?>API技术支持

域名拦截检测 .*
$访问 http://<?php echo $_SERVER['HTTP_HOST'];?>/api/qmjc.php?url=%参数1%$</per>
</div>
</div>
</div>
</div>
