...
<?php @$base64 = intval(file_get_contents("../api/tongji/jiekou/base64.dat")); ?>
<?php @$base64x = intval(file_get_contents("../api/tongji/jinri/".date("Y-m-d")."/base64.dat")); ?>
...
<title>base64加解密 - <?php echo $ming; ?>API</title>
...
<legend>base64加解密API</legend>
</fieldset>
<blockquote class="layui-elem-quote">本接口总调用：<?php echo $base64; ?>次·今日调用：<?php echo $base64x; ?>次</blockquote>
</div>
...
<span class="url" data-clipboard-text="http://<?php echo $_SERVER['HTTP_HOST'];?>/api/base64.php">http://<?php echo $_SERVER['HTTP_HOST'];?>/api/base64.php</span>
</p>
<p class="simpleTable">
...
<span class="url" data-clipboard-text="http://<?php echo $_SERVER['HTTP_HOST'];?>/api/base64.php?id=加密&msg=吉云">http://<?php echo $_SERVER['HTTP_HOST'];?>/api/base64.php?id=加密&msg=吉云</span>
</p>
...
<pre class="layui-code">加密结果：5ZCJ5LqR
解密结果：吉云</pre>
</div>
...
<pre class="layui-code"><a style="color:#fd4b5c;text-decoration:none；" target="_blank">base64加解密
<?php echo $ming; ?>API♧base64加解密\n
━━━━━━━━━\n
用户:@%昵称%\n
━━━━━━━━━\n
base64加/解密 [内容]\n
━━━━━━━━━\n
请求示例：http://<?php echo $_SERVER['HTTP_HOST'];?>/tianyi/base64.php\n
━━━━━━━━━\n
...
用户:@%昵称%\n
━━━━━━━━━\n
$访问 http://<?php echo $_SERVER['HTTP_HOST'];?>/api/base64.php?id=%括号1%&msg=%参数1%$\n
━━━━━━━━━\n
