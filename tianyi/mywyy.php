...
<?php @$mywyy = intval(file_get_contents("../api/tongji/jiekou/mywyy.dat")); ?>
<?php @$mywyyx = intval(file_get_contents("../api/tongji/jinri/".date("Y-m-d")."/mywyy.dat")); ?>
...
<title>网易云音乐用户信息获取 - <?php echo $ming; ?>API</title>
...
<legend>网易云音乐用户信息获取API</legend>
</fieldset>
<blockquote class="layui-elem-quote">本接口总调用：<?php echo $mywyy; ?>次·今日调用：<?php echo $mywyyx; ?>次</blockquote>
</div>
...
<span class="url" data-clipboard-text="http://<?php echo $_SERVER['HTTP_HOST'];?>/api/mywyy.php">http://<?php echo $_SERVER['HTTP_HOST'];?>/api/mywyy.php</span>
</p>
<p class="simpleTable">
...
<span class="url" data-clipboard-text="http://<?php echo $_SERVER['HTTP_HOST'];?>/api/mywyy.php?uid=3317133378">http://<?php echo $_SERVER['HTTP_HOST'];?>/api/mywyy.php?uid=3317133378</span>
</p>
...
<tbody>
<tr><td>uid</td><td>是</td><td>需要获取信息的用户ID</td></tr>
...
$result = file_get_contents("http://".$_SERVER['HTTP_HOST']."/api/mywyy.php?uid=3317133378");
echo $result;
?></pre>
</div>
...
<pre class="layui-code"><a style="color:#fd4b5c;text-decoration:none；" target="_blank">网易云音乐用户信息获取
<?php echo $ming; ?>API网易云音乐用户信息获取\n
━━━━━━━━━\n
用户:@%昵称%\n
━━━━━━━━━\n
网易云音乐用户信息获取 [UID]\n
━━━━━━━━━\n
请求示例：http://<?php echo $_SERVER['HTTP_HOST'];?>/tianyi/mywyy.php\n
━━━━━━━━━\n
Tips:<?php echo $ming; ?>API技术支持

网易云音乐用户信息获取 .*
$访问 http://<?php echo $_SERVER['HTTP_HOST'];?>/api/mywyy.php?uid=%参数1%$</per>
</div>
</div>
</div>
</div>
