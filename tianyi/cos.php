...
<?php @$cos = intval(file_get_contents("../api/tongji/jiekou/cos.dat")); ?>
<?php @$cosx = intval(file_get_contents("../api/tongji/jinri/".date("Y-m-d")."/cos.dat")); ?>
...
<title>cos图 - <?php echo $ming; ?>API</title>
...
<legend>cos图API</legend>
</fieldset>
<blockquote class="layui-elem-quote">本接口总调用：<?php echo $cos; ?>次·今日调用：<?php echo $cosx; ?>次</blockquote>
</div>
...
<span class="url" data-clipboard-text="http://<?php echo $_SERVER['HTTP_HOST'];?>/api/cos.php">http://<?php echo $_SERVER['HTTP_HOST'];?>/api/cos.php</span>
</p>
<p class="simpleTable">
...
$result = file_get_contents("http://".$_SERVER['HTTP_HOST']."/api/cos.php");
echo $result;
?></pre>
</div>
...
<pre class="layui-code"><a style="color:#fd4b5c;text-decoration:none；" target="_blank">cos图
<?php echo $ming; ?>API♧cos图\n
━━━━━━━━━\n
用户:@%昵称%\n
━━━━━━━━━\n
±img=$访问 http://<?php echo $_SERVER['HTTP_HOST'];?>/api/cos.php$±\n
━━━━━━━━━\n
请求示例：http://<?php echo $_SERVER['HTTP_HOST'];?>/tianyi/cos.php\n
━━━━━━━━━\n
