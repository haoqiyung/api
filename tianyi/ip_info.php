...
<?php @$ip_info = intval(file_get_contents("../api/tongji/jiekou/ip_info.dat")); ?>
<?php @$ip_infox = intval(file_get_contents("../api/tongji/jinri/".date("Y-m-d")."/ip_info.dat")); ?>
...
<title>查询IP信息 - <?php echo $ming; ?>API</title>
...
<legend>查询IP信息API</legend>
</fieldset>
<blockquote class="layui-elem-quote">本接口总调用：<?php echo $ip_info; ?>次·今日调用：<?php echo $ip_infox; ?>次</blockquote>
</div>
...
<span class="url" data-clipboard-text="http://<?php echo $_SERVER['HTTP_HOST'];?>/api/ip_info.php">http://<?php echo $_SERVER['HTTP_HOST'];?>/api/ip_info.php</span>
</p>
<p class="simpleTable">
...
<span class="url" data-clipboard-text="http://<?php echo $_SERVER['HTTP_HOST'];?>/api/ip_info.php?ip=39.170.178.96">http://<?php echo $_SERVER['HTTP_HOST'];?>/api/ip_info.php?ip=39.170.178.96</span>
</p>
...
$result = file_get_contents("http://".$_SERVER['HTTP_HOST']."/api/ip_info.php?ip=39.170.178.96");
echo $result;
?></pre>
</div>
...
<pre class="layui-code"><a style="color:#fd4b5c;text-decoration:none；" target="_blank">查询IP信息
<?php echo $ming; ?>API查询IP信息\n
━━━━━━━━━\n
用户:@%昵称%\n
━━━━━━━━━\n
查询IP信息 [IP]\n
━━━━━━━━━\n
请求示例：http://<?php echo $_SERVER['HTTP_HOST'];?>/tianyi/ip_info.php\n
━━━━━━━━━\n
Tips:<?php echo $ming; ?>API技术支持

查询IP信息 .*
$访问 http://<?php echo $_SERVER['HTTP_HOST'];?>/api/ip_info.php?key=%参数1%$</per>
</div>
</div>
</div>
</div>
