...
<?php @$acg_pzt = intval(file_get_contents("../api/tongji/jiekou/acg_pzt.dat")); ?>
<?php @$acg_pztx = intval(file_get_contents("../api/tongji/jinri/".date("Y-m-d")."/acg_pzt.dat")); ?>
...
<title>P站随机图 - <?php echo $ming; ?>API</title>
...
<legend>P站随机图API</legend>
</fieldset>
<blockquote class="layui-elem-quote">本接口总调用：<?php echo $acg_pzt; ?>次·今日调用：<?php echo $acg_pztx; ?>次</blockquote>
</div>
...
<span class="url" data-clipboard-text="http://<?php echo $_SERVER['HTTP_HOST'];?>/api/acg_pzt.php">http://<?php echo $_SERVER['HTTP_HOST'];?>/api/acg_pzt.php</span>
</p>
<p class="simpleTable">
...
<pre class="layui-code"><img src="../api/acg_pzt.php" style="width: 45%;"></pre>
</div>
...
<pre class="layui-code"><a style="color:#fd4b5c;text-decoration:none；" target="_blank">P站随机图
<?php echo $ming; ?>API♧P站随机图\n
━━━━━━━━━\n
用户:@%昵称%\n
━━━━━━━━━\n
±img=http://<?php echo $_SERVER['HTTP_HOST'];?>/api/acg_pzt.php±\n
━━━━━━━━━\n
请求示例：http://<?php echo $_SERVER['HTTP_HOST'];?>/tianyi/acg_pzt.php\n
━━━━━━━━━\n
