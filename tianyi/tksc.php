...
<?php @$tksc = intval(file_get_contents("../api/tongji/jiekou/tksc.dat")); ?>
<?php @$tkscx = intval(file_get_contents("../api/tongji/jinri/".date("Y-m-d")."/tksc.dat")); ?>
...
<title>头像框生成 - <?php echo $ming; ?>API</title>
...
<legend>头像框生成API</legend>
</fieldset>
<blockquote class="layui-elem-quote">本接口总调用：<?php echo $tksc; ?>次·今日调用：<?php echo $tkscx; ?>次</blockquote>
</div>
...
<span class="url" data-clipboard-text="http://<?php echo $_SERVER['HTTP_HOST'];?>/api/tksc.php">http://<?php echo $_SERVER['HTTP_HOST'];?>/api/tksc.php</span>
</p>
<p class="simpleTable">
...
<span class="url" data-clipboard-text="http://<?php echo $_SERVER['HTTP_HOST'];?>/api/tksc.php?qq=3189402257">http://<?php echo $_SERVER['HTTP_HOST'];?>/api/tksc.php?qq=3189402257</span>
</p>
...
<tbody>
<tr><td>qq</td><td>是</td><td>需要制作头像的QQ号</td></tr>
<tr><td>type</td><td>否</td><td>输数字(0-34)(默认随机)</td></tr>
<tr><td>imgSize</td><td>否</td><td>图片尺寸，可选 640、140、100、40(默认640)</td></tr>
</tbody>
</table>
...
<pre class="layui-code"><img src="../api/tksc.php?qq=3189402257" style="width: 45%;"></pre>
</div>
...
<pre class="layui-code"><a style="color:#fd4b5c;text-decoration:none；" target="_blank">头像框生成
<?php echo $ming; ?>API头像框生成\n
━━━━━━━━━\n
用户:@%昵称%\n
━━━━━━━━━\n
头像框生成 [QQ号]\n
━━━━━━━━━\n
请求示例：http://<?php echo $_SERVER['HTTP_HOST'];?>/tianyi/tksc.php\n
━━━━━━━━━\n
...
用户:@%昵称%\n
━━━━━━━━━\n
±img=http://<?php echo $_SERVER['HTTP_HOST'];?>/api/tksc.php?qq=%参数1%±\n
━━━━━━━━━\n
Tips:<?php echo $ming; ?>API技术支持</per>
</div>
</div>
