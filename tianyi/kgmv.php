...
<?php @$kgmv = intval(file_get_contents("../api/tongji/jiekou/kgmv.dat")); ?>
<?php @$kgmvx = intval(file_get_contents("../api/tongji/jinri/".date("Y-m-d")."/kgmv.dat")); ?>
...
<title>酷狗音乐MV - <?php echo $ming; ?>API</title>
...
<legend>酷狗音乐MVAPI</legend>
</fieldset>
<blockquote class="layui-elem-quote">本接口总调用：<?php echo $kgmv; ?>次·今日调用：<?php echo $kgmvx; ?>次</blockquote>
</div>
...
<span class="url" data-clipboard-text="http://<?php echo $_SERVER['HTTP_HOST'];?>/api/kgmv.php">http://<?php echo $_SERVER['HTTP_HOST'];?>/api/kgmv.php</span>
</p>
<p class="simpleTable">
...
<span class="url" data-clipboard-text="http://<?php echo $_SERVER['HTTP_HOST'];?>/api/kgmv.php?msg=吉云&b=1">http://<?php echo $_SERVER['HTTP_HOST'];?>/api/kgmv.php?msg=吉云&b=1</span>
</p>
...
$result = file_get_contents("http://".$_SERVER['HTTP_HOST']."/api/kgmv.php?msg=吉云&b=1");
echo $result;
?></pre>
</div>
...
<pre class="layui-code"><a style="color:#fd4b5c;text-decoration:none；" target="_blank">酷狗音乐MV
<?php echo $ming; ?>API酷狗音乐MV\n
━━━━━━━━━\n
用户:@%昵称%\n
━━━━━━━━━\n
酷狗音乐MV [内容]\n
━━━━━━━━━\n
请求示例：http://<?php echo $_SERVER['HTTP_HOST'];?>/tianyi/kgmv.php\n
━━━━━━━━━\n
Tips:<?php echo $ming; ?>API技术支持

酷狗音乐MV .*
$写 <?php echo $ming; ?>API/%群号%/%QQ% 酷狗音乐MV %参数1%$
$访问 http://<?php echo $_SERVER['HTTP_HOST'];?>/api/kgmv.php?msg=%参数1%$

选酷狗音乐MV .*
R:$读 <?php echo $ming; ?>API/%群号%/%QQ% 酷狗音乐MV %参数1%$
$访问 http://<?php echo $_SERVER['HTTP_HOST'];?>/api/kgmv.php?msg=%R%&b=%参数1%$</per>
</div>
</div>
</div>
</div>
