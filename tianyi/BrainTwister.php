...
<?php @$BrainTwister = intval(file_get_contents("../api/tongji/jiekou/BrainTwister.dat")); ?>
<?php @$BrainTwisterx = intval(file_get_contents("../api/tongji/jinri/".date("Y-m-d")."/BrainTwister.dat")); ?>
...
<title>脑筋急转弯 - <?php echo $ming; ?>API</title>
...
<legend>脑筋急转弯API</legend>
</fieldset>
<blockquote class="layui-elem-quote">本接口总调用：<?php echo $BrainTwister; ?>次·今日调用：<?php echo $BrainTwisterx; ?>次</blockquote>
</div>
...
<span class="url" data-clipboard-text="http://<?php echo $_SERVER['HTTP_HOST'];?>/api/BrainTwister.php">http://<?php echo $_SERVER['HTTP_HOST'];?>/api/BrainTwister.php</span>
</p>
<p class="simpleTable">
...
$result = file_get_contents("http://".$_SERVER['HTTP_HOST']."/api/BrainTwister.php");
echo $result;
?></pre>
</div>
...
<pre class="layui-code"><a style="color:#fd4b5c;text-decoration:none；" target="_blank">脑筋急转弯
$访问 http://<?php echo $_SERVER['HTTP_HOST'];?>/api/BrainTwister.php$</per>
</div>
</div>
</div>
</div>
