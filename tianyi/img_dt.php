...
<?php @$img_dt = intval(file_get_contents("../api/tongji/jiekou/img_dt.dat")); ?>
<?php @$img_dtx = intval(file_get_contents("../api/tongji/jinri/".date("Y-m-d")."/img_dt.dat")); ?>
...
<title>堆糖美图 - <?php echo $ming; ?>API</title>
...
<legend>堆糖美图API</legend>
</fieldset>
<blockquote class="layui-elem-quote">本接口总调用：<?php echo $img_dt; ?>次·今日调用：<?php echo $img_dtx; ?>次</blockquote>
</div>
...
<span class="url" data-clipboard-text="http://<?php echo $_SERVER['HTTP_HOST'];?>/api/img_dt.php">http://<?php echo $_SERVER['HTTP_HOST'];?>/api/img_dt.php</span>
</p>
<p class="simpleTable">
...
<span class="url" data-clipboard-text="http://<?php echo $_SERVER['HTTP_HOST'];?>/api/img_dt.php?key=jk">http://<?php echo $_SERVER['HTTP_HOST'];?>/api/img_dt.php?key=jk</span>
</p>
...
<tbody>
<tr><td>key</td><td>否</td><td>搜索关键词,不填写默认写真</td></tr>
</tbody>
</table>
...
<pre class="layui-code"><img src="../api/img_dt.php?key=jk" style="width: 45%;"></pre>
</div>
...
<pre class="layui-code"><a style="color:#fd4b5c;text-decoration:none；" target="_blank">堆糖美图
<?php echo $ming; ?>API堆糖美图\n
━━━━━━━━━\n
用户:@%昵称%\n
━━━━━━━━━\n
堆糖美图 [内容]\n
━━━━━━━━━\n
请求示例：http://<?php echo $_SERVER['HTTP_HOST'];?>/tianyi/img_dt.php\n
━━━━━━━━━\n
...
用户:@%昵称%\n
━━━━━━━━━\n
±img=http://<?php echo $_SERVER['HTTP_HOST'];?>/api/img_dt.php?key=%参数1%±\n
━━━━━━━━━\n
Tips:<?php echo $ming; ?>API技术支持</per>
</div>
</div>
