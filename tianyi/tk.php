...
<?php @$tk = intval(file_get_contents("../api/tongji/jiekou/tk.dat")); ?>
<?php @$tkx = intval(file_get_contents("../api/tongji/jinri/".date("Y-m-d")."/tk.dat")); ?>
...
<title>腿控图 - <?php echo $ming; ?>API</title>
...
<legend>腿控图API</legend>
</fieldset>
<blockquote class="layui-elem-quote">本接口总调用：<?php echo $tk; ?>次·今日调用：<?php echo $tkx; ?>次</blockquote>
</div>
...
<span class="url" data-clipboard-text="http://<?php echo $_SERVER['HTTP_HOST'];?>/api/tk.php">http://<?php echo $_SERVER['HTTP_HOST'];?>/api/tk.php</span>
</p>
<p class="simpleTable">
...
<pre class="layui-code"><img src="../api/tk.php" style="width: 45%;"></pre>
</div>
...
<pre class="layui-code"><a style="color:#fd4b5c;text-decoration:none；" target="_blank">腿控图
<?php echo $ming; ?>API腿控图\n
━━━━━━━━━\n
用户:@%昵称%\n
━━━━━━━━━\n
±img=http://<?php echo $_SERVER['HTTP_HOST'];?>/api/tk.php±\n
━━━━━━━━━\n
请求示例：http://<?php echo $_SERVER['HTTP_HOST'];?>/tianyi/tk.php\n
━━━━━━━━━\n
