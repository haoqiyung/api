...
<?php @$vs = intval(file_get_contents("../api/tongji/jiekou/vs.dat")); ?>
<?php @$vsx = intval(file_get_contents("../api/tongji/jinri/".date("Y-m-d")."/vs.dat")); ?>
...
<title>微视短视频 - <?php echo $ming; ?>API</title>
...
<legend>微视短视频API</legend>
</fieldset>
<blockquote class="layui-elem-quote">本接口总调用：<?php echo $vs; ?>次·今日调用：<?php echo $vsx; ?>次</blockquote>
</div>
...
<span class="url" data-clipboard-text="http://<?php echo $_SERVER['HTTP_HOST'];?>/api/vs.php">http://<?php echo $_SERVER['HTTP_HOST'];?>/api/vs.php</span>
</p>
<p class="simpleTable">
...
$result = file_get_contents("http://".$_SERVER['HTTP_HOST']."/api/vs.php");
echo $result;
?></pre>
</div>
...
<pre class="layui-code"><a style="color:#fd4b5c;text-decoration:none；" target="_blank">微视短视频
$访问 http://<?php echo $_SERVER['HTTP_HOST'];?>/api/vs.php$</per>
</div>
</div>
</div>
</div>
