...
<?php @$yqcy = intval(file_get_contents("../api/tongji/jiekou/yqcy.dat")); ?>
<?php @$yqcyx = intval(file_get_contents("../api/tongji/jinri/".date("Y-m-d")."/yqcy.dat")); ?>
...
<title>全网疫情查询 - <?php echo $ming; ?>API</title>
...
<legend>全网疫情查询API</legend>
</fieldset>
<blockquote class="layui-elem-quote">本接口总调用：<?php echo $yqcy; ?>次·今日调用：<?php echo $yqcyx; ?>次</blockquote>
</div>
...
<span class="url" data-clipboard-text="http://<?php echo $_SERVER['HTTP_HOST'];?>/api/yqcy.php">http://<?php echo $_SERVER['HTTP_HOST'];?>/api/yqcy.php</span>
</p>
<p class="simpleTable">
...
<span class="url" data-clipboard-text="http://<?php echo $_SERVER['HTTP_HOST'];?>/api/yqcy.php?msg=&type=">http://<?php echo $_SERVER['HTTP_HOST'];?>/api/yqcy.php?msg=&type=</span>
</p>
...
<tbody>
<tr><td>msg</td><td>否</td><td>需要查询的地区名(默认为全国查询)</td></tr>
<tr><td>type</td><td>否</td><td>json返回(默认text返回)</td></tr>
...
$result = file_get_contents("http://".$_SERVER['HTTP_HOST']."/api/yqcy.php?msg=&type=");
echo $result;
?></pre></div>
...
<pre class="layui-code"><a style="color:#fd4b5c;text-decoration:none；" target="_blank">全网疫情查询
<?php echo $ming; ?>API全网疫情查询\n
━━━━━━━━━\n
用户:@%昵称%\n
━━━━━━━━━\n
全网疫情查询 [地区名]\n
━━━━━━━━━\n
请求示例：http://<?php echo $_SERVER['HTTP_HOST'];?>/tianyi/yqcy.php\n
━━━━━━━━━\n
...
用户:@%昵称%\n
━━━━━━━━━\n
$访问 http://<?php echo $_SERVER['HTTP_HOST'];?>/api/yqcy.php?msg=%参数1%&type=$\n
━━━━━━━━━\n
