...
<?php @$JinRiHotsearch = intval(file_get_contents("../api/tongji/jiekou/JinRiHotsearch.dat")); ?>
<?php @$JinRiHotsearchx = intval(file_get_contents("../api/tongji/jinri/".date("Y-m-d")."/JinRiHotsearch.dat")); ?>
...
<title>今日头条热搜榜获取 - <?php echo $ming; ?>API</title>
...
<legend>今日头条热搜榜获取API</legend>
</fieldset>
<blockquote class="layui-elem-quote">本接口总调用：<?php echo $JinRiHotsearch; ?>次·今日调用：<?php echo $JinRiHotsearchx; ?>次</blockquote>
</div>
...
<span class="url" data-clipboard-text="http://<?php echo $_SERVER['HTTP_HOST'];?>/api/JinRiHotsearch.php">http://<?php echo $_SERVER['HTTP_HOST'];?>/api/JinRiHotsearch.php</span>
</p>
<p class="simpleTable">
...
$result = file_get_contents("http://".$_SERVER['HTTP_HOST']."/api/JinRiHotsearch.php");
echo $result;
?></pre>
</div>
...
<pre class="layui-code"><a style="color:#fd4b5c;text-decoration:none；" target="_blank">今日头条热搜榜获取
$访问 http://<?php echo $_SERVER['HTTP_HOST'];?>/api/JinRiHotsearch.php$</per>
</div>
</div>
</div>
</div>
