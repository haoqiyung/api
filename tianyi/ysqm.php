...
<?php @$ysqm = intval(file_get_contents("../api/tongji/jiekou/ysqm.dat")); ?>
<?php @$ysqmx = intval(file_get_contents("../api/tongji/jinri/".date("Y-m-d")."/ysqm.dat")); ?>
...
<title>网络艺术签名 - <?php echo $ming; ?>API</title>
...
<legend>网络艺术签名API</legend>
</fieldset>
<blockquote class="layui-elem-quote">本接口总调用：<?php echo $ysqm; ?>次·今日调用：<?php echo $ysqmx; ?>次</blockquote>
</div>
...
<span class="url" data-clipboard-text="http://<?php echo $_SERVER['HTTP_HOST'];?>/api/ysqm.php">http://<?php echo $_SERVER['HTTP_HOST'];?>/api/ysqm.php</span>
</p>
<p class="simpleTable">
...
<span class="url" data-clipboard-text="http://<?php echo $_SERVER['HTTP_HOST'];?>/api/ysqm.php?lx=一笔商务签名&msg=吉云">http://<?php echo $_SERVER['HTTP_HOST'];?>/api/ysqm.php?lx=一笔商务签名&msg=吉云</span>
</p>
...
<tbody>
<tr><td>lx</td><td>是</td><td>输(多字单闪签名/一笔商务签名/连笔商务签名/花鸟艺术签名/可爱艺术签名/浪漫艺术签名/小丸子艺术签名/彩色蝴蝶签名/炫酷背景签名/明星艺术签名/隐形流光签名)</td></tr>
...
$result = file_get_contents("http://".$_SERVER['HTTP_HOST']."/api/ysqm.php?lx=一笔商务签名&msg=吉云");
echo $result;
?></pre>
</div>
...
<pre class="layui-code"><a style="color:#fd4b5c;text-decoration:none；" target="_blank">网络艺术签名
<?php echo $ming; ?>API网络艺术签名\n
━━━━━━━━━\n
用户:@%昵称%\n
━━━━━━━━━\n
炫酷背景签名 [内容]\n
...
花鸟艺术签名 [内容]\n
━━━━━━━━━\n
请求示例：http://<?php echo $_SERVER['HTTP_HOST'];?>/tianyi/ysqm.php\n
━━━━━━━━━\n
Tips:<?php echo $ming; ?>API技术支持

(炫酷背景|彩色蝴蝶|小丸子艺术|浪漫艺术|明星艺术|隐形流光|可爱艺术|多字单闪|一笔商务|连笔商务|花鸟艺术)签名 .*
<?php echo $ming; ?>API网络艺术签名\n
━━━━━━━━━\n
用户:@%昵称%\n
━━━━━━━━━\n
±img=$访问 http://<?php echo $_SERVER['HTTP_HOST'];?>/api/ysqm.php?lx=%括号1%签名&msg=%参数1%$±\n
━━━━━━━━━\n
