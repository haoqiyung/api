...
<?php @$Comforting = intval(file_get_contents("../api/tongji/jiekou/Comforting.dat")); ?>
<?php @$Comfortingx = intval(file_get_contents("../api/tongji/jinri/".date("Y-m-d")."/Comforting.dat")); ?>
...
<title>安慰语录 - <?php echo $ming; ?>API</title>
...
<legend>安慰语录API</legend>
</fieldset>
<blockquote class="layui-elem-quote">本接口总调用：<?php echo $Comforting; ?>次·今日调用：<?php echo $Comfortingx; ?>次</blockquote>
</div>
...
<span class="url" data-clipboard-text="http://<?php echo $_SERVER['HTTP_HOST'];?>/api/Comforting.php">http://<?php echo $_SERVER['HTTP_HOST'];?>/api/Comforting.php</span>
</p>
<p class="simpleTable">
...
$result = file_get_contents("http://".$_SERVER['HTTP_HOST']."/api/Comforting.php");
echo $result;
?></pre>
</div>
...
<pre class="layui-code"><a style="color:#fd4b5c;text-decoration:none；" target="_blank">安慰语录
$访问 http://<?php echo $_SERVER['HTTP_HOST'];?>/api/Comforting.php$</per>
</div>
</div>
</div>
</div>
