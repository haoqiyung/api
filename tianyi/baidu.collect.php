...
<?php @$baiducollect = intval(file_get_contents("../api/tongji/jiekou/baidu.collect.dat")); ?>
<?php @$baiducollectx = intval(file_get_contents("../api/tongji/jinri/".date("Y-m-d")."/baidu.collect.dat")); ?>
...
<title>百度收录信息判断 - <?php echo $ming; ?>API</title>
...
<legend>百度收录信息判断API</legend>
</fieldset>
<blockquote class="layui-elem-quote">本接口总调用：<?php echo $baiducollect; ?>次·今日调用：<?php echo $baiducollectx; ?>次</blockquote>
</div>
...
<span class="url" data-clipboard-text="http://<?php echo $_SERVER['HTTP_HOST'];?>/api/baidu.collect.php">http://<?php echo $_SERVER['HTTP_HOST'];?>/api/baidu.collect.php</span>
</p>
<p class="simpleTable">
...
<span class="url" data-clipboard-text="http://<?php echo $_SERVER['HTTP_HOST'];?>/api/baidu.collect.php?url=https://cloud.vpsidc.com.cn">http://<?php echo $_SERVER['HTTP_HOST'];?>/api/baidu.collect.php?url=https://cloud.vpsidc.com.cn</span>
</p>
...
<tbody>
<tr><td>url</td><td>是</td><td>需要查询的链接</td></tr>
...
$result = file_get_contents("http://".$_SERVER['HTTP_HOST']."/api/baidu.collect.php?url=https://cloud.vpsidc.com.cn");
echo $result;
?></pre>
</div>
...
<pre class="layui-code"><a style="color:#fd4b5c;text-decoration:none；" target="_blank">百度收录信息判断
<?php echo $ming; ?>API百度收录信息判断\n
━━━━━━━━━\n
用户:@%昵称%\n
━━━━━━━━━\n
百度收录信息判断 [网址]\n
━━━━━━━━━\n
请求示例：http://<?php echo $_SERVER['HTTP_HOST'];?>/tianyi/baidu.collect.php\n
━━━━━━━━━\n
Tips:<?php echo $ming; ?>API技术支持

百度收录信息判断 .*
$访问 http://<?php echo $_SERVER['HTTP_HOST'];?>/api/baidu.collect.php?url=%参数1%$</per>
</div>
</div>
</div>
</div>
