...
<?php @$kugou = intval(file_get_contents("../api/tongji/jiekou/kugou.dat")); ?>
<?php @$kugoux = intval(file_get_contents("../api/tongji/jinri/".date("Y-m-d")."/kugou.dat")); ?>
...
<title>酷狗铃声 - <?php echo $ming; ?>API</title>
...
<legend>酷狗铃声API</legend>
</fieldset>
<blockquote class="layui-elem-quote">本接口总调用：<?php echo $kugou; ?>次·今日调用：<?php echo $kugoux; ?>次</blockquote>
</div>
...
<span class="url" data-clipboard-text="http://<?php echo $_SERVER['HTTP_HOST'];?>/api/kugou.php">http://<?php echo $_SERVER['HTTP_HOST'];?>/api/kugou.php</span>
</p>
<p class="simpleTable">
...
<span class="url" data-clipboard-text="http://<?php echo $_SERVER['HTTP_HOST'];?>/api/kugou.php?msg=吉云&b=1">http://<?php echo $_SERVER['HTTP_HOST'];?>/api/kugou.php?msg=吉云&b=1</span>
</p>
...
$result = file_get_contents("http://".$_SERVER['HTTP_HOST']."/api/kugou.php?msg=吉云&b=1");
echo $result;
?></pre>
</div>
...
<pre class="layui-code"><a style="color:#fd4b5c;text-decoration:none；" target="_blank">酷狗铃声
<?php echo $ming; ?>API酷狗铃声\n
━━━━━━━━━\n
用户:@%昵称%\n
━━━━━━━━━\n
酷狗铃声 [名字]\n
━━━━━━━━━\n
请求示例：http://<?php echo $_SERVER['HTTP_HOST'];?>/tianyi/kugou.php\n
━━━━━━━━━\n
Tips:<?php echo $ming; ?>API技术支持

酷狗铃声 .*
$写 <?php echo $ming; ?>API/%群号%/%QQ% 酷狗铃声 %参数1%$
$访问 http://<?php echo $_SERVER['HTTP_HOST'];?>/api/kugou.php?msg=%参数1%$

选酷狗铃声 .*
t:$读 <?php echo $ming; ?>API/%群号%/%QQ% 酷狗铃声 %参数1%$
$访问 http://<?php echo $_SERVER['HTTP_HOST'];?>/api/kugou.php?msg=%t%&b=%参数1%$</per>
</div>
</div>
</div>
</div>
