...
<?php @$ks_wyyrp = intval(file_get_contents("../api/tongji/jiekou/ks_wyyrp.dat")); ?>
<?php @$ks_wyyrpx = intval(file_get_contents("../api/tongji/jinri/".date("Y-m-d")."/ks_wyyrp.dat")); ?>
...
<title>快手网易云热评 - <?php echo $ming; ?>API</title>
...
<legend>快手网易云热评API</legend>
</fieldset>
<blockquote class="layui-elem-quote">本接口总调用：<?php echo $ks_wyyrp; ?>次·今日调用：<?php echo $ks_wyyrpx; ?>次</blockquote>
</div>
...
<span class="url" data-clipboard-text="http://<?php echo $_SERVER['HTTP_HOST'];?>/api/ks_wyyrp.php">http://<?php echo $_SERVER['HTTP_HOST'];?>/api/ks_wyyrp.php</span>
</p>
<p class="simpleTable">
...
$result = file_get_contents("http://".$_SERVER['HTTP_HOST']."/api/ks_wyyrp.php");
echo $result;
?></pre>
</div>
...
<pre class="layui-code"><a style="color:#fd4b5c;text-decoration:none；" target="_blank">快手网易云热评
<?php echo $ming; ?>API快手舞蹈视频\n
━━━━━━━━━\n
用户:@%昵称%\n
━━━━━━━━━\n
$访问 http://<?php echo $_SERVER['HTTP_HOST'];?>/api/ks_wyyrp.php$\n
━━━━━━━━━\n
请求示例：http://<?php echo $_SERVER['HTTP_HOST'];?>/tianyi/ks_wyyrp.php\n
━━━━━━━━━\n
