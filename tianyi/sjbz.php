...
<?php @$sjbz = intval(file_get_contents("../api/tongji/jiekou/sjbz.dat")); ?>
<?php @$sjbzx = intval(file_get_contents("../api/tongji/jinri/".date("Y-m-d")."/sjbz.dat")); ?>
...
<title>随机壁纸 - <?php echo $ming; ?>API</title>
...
<legend>随机壁纸API</legend>
</fieldset>
<blockquote class="layui-elem-quote">本接口总调用：<?php echo $sjbz; ?>次·今日调用：<?php echo $sjbzx; ?>次</blockquote>
</div>
...
<span class="url" data-clipboard-text="http://<?php echo $_SERVER['HTTP_HOST'];?>/api/sjbz.php">http://<?php echo $_SERVER['HTTP_HOST'];?>/api/sjbz.php</span>
</p>
<p class="simpleTable">
...
<span class="url" data-clipboard-text="http://<?php echo $_SERVER['HTTP_HOST'];?>/api/sjbz.php?method=pc&lx=dongman">http://<?php echo $_SERVER['HTTP_HOST'];?>/api/sjbz.php?method=pc&lx=dongman</span>
</p>
...
<tbody>
<tr><td>method</td><td>是</td><td>输【mobiel(手机端),pc(电脑端)】</td></tr>
<tr><td>lx</td><td>是</td><td>输【dongman（动漫）,meizi（美女）,fengjing（风景）,suiji（动漫和美女随机）】</td></tr>
</tbody>
</table>
...
<pre class="layui-code"><img src="../api/sjbz.php?method=pc&lx=dongman" style="width: 45%;"></pre>
</div>
