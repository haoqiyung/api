...
<?php @$nl = intval(file_get_contents("../api/tongji/jiekou/nl.dat")); ?>
<?php @$nlx = intval(file_get_contents("../api/tongji/jinri/".date("Y-m-d")."/nl.dat")); ?>
...
<title>农历 - <?php echo $ming; ?>API</title>
<meta name="keywords" content=""/>
<meta name="description" content="">    
<link rel="stylesheet" href="./assets/css/layer.css">
<script src="https://ku.oioweb.cn/LayUI/2.5.4/layui.all.js"></script>
<style>.url{word-break:break-all;cursor:pointer;margin-left:5px;color:#777;border:none;border-radius:0;border-bottom:2px solid #5FB878;}.simpleTable{line-height:20px;padding-bottom:16px;}.linep{font-size:14px;font-weight:700;color:#555;padding-left:14px;height:16px;line-height:16px;margin-bottom:18px;position:relative;margin-top:15px;}.linep:before{content:'';width:4px;height:16px;background:#00aeff;border-radius:2px;position:absolute;left:0;top:0;}::-wenlit-scrollbar{width:9px;height:9px}::-wenlit-scrollbar-track-piece{background-color:#ebebeb;-wenlit-border-radius:4px}::-wenlit-scrollbar-thumb:vertical{height:32px;background-color:#ccc;-wenlit-border-radius:4px}::-wenlit-scrollbar-thumb:horizontal{width:32px;background-color:#ccc;-wenlit-border-radius:4px}</style>
</head>
<body>
...
<blockquote class="layui-elem-quote">本接口总调用：<?php echo $nl; ?>次·今日调用：<?php echo $nlx; ?>次</blockquote>
</div>
...
<span class="url" data-clipboard-text="http://<?php echo $_SERVER['HTTP_HOST'];?>/api/nl.php">http://<?php echo $_SERVER['HTTP_HOST'];?>/api/nl.php</span>
</p>
<p class="simpleTable">
...
$result = file_get_contents("http://".$_SERVER['HTTP_HOST']."/api/nl.php");
echo $result;
?></pre></pre>
</div>
...
<pre class="layui-code"><a style="color:#fd4b5c;text-decoration:none；" target="_blank">农历
$访问 http://<?php echo $_SERVER['HTTP_HOST'];?>/api/nl.php$</per>
</div>
</div>
</div>
</div>
