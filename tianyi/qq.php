...
<?php @$qq = intval(file_get_contents("../api/tongji/jiekou/qq.dat")); ?>
<?php @$qqx = intval(file_get_contents("../api/tongji/jinri/".date("Y-m-d")."/qq.dat")); ?>
...
<title>获取QQ头像 - <?php echo $ming; ?>API</title>
...
<legend>获取QQ头像API</legend>
</fieldset>
<blockquote class="layui-elem-quote">本接口总调用：<?php echo $qq; ?>次·今日调用：<?php echo $qqx; ?>次</blockquote>
</div>
...
<span class="url" data-clipboard-text="http://<?php echo $_SERVER['HTTP_HOST'];?>/api/qq.php">http://<?php echo $_SERVER['HTTP_HOST'];?>/api/qq.php</span>
</p>
<p class="simpleTable">
...
<span class="url" data-clipboard-text="http://<?php echo $_SERVER['HTTP_HOST'];?>/api/qq.php?qq=3189402257">http://<?php echo $_SERVER['HTTP_HOST'];?>/api/qq.php?qq=3189402257</span>
</p>
...
<pre class="layui-code"><img src="../api/qq.php?qq=3189402257" style="width: 45%;"></pre>
</div>
...
<pre class="layui-code"><a style="color:#fd4b5c;text-decoration:none；" target="_blank">获取QQ头像
<?php echo $ming; ?>API获取QQ头像\n
━━━━━━━━━\n
用户:@%昵称%\n
━━━━━━━━━\n
获取QQ头像 [QQ号]\n
━━━━━━━━━\n
请求示例：http://<?php echo $_SERVER['HTTP_HOST'];?>/tianyi/qq.php\n
━━━━━━━━━\n
...
用户:@%昵称%\n
━━━━━━━━━\n
±img=http://<?php echo $_SERVER['HTTP_HOST'];?>/api/qq.php?qq=%参数1%$±\n
━━━━━━━━━\n
