...
<?php @$bcscslcx = intval(file_get_contents("../api/tongji/jiekou/bcscslcx.dat")); ?>
<?php @$bcscslcxx = intval(file_get_contents("../api/tongji/jinri/".date("Y-m-d")."/bcscslcx.dat")); ?>
...
<title>百度收录数量查询 - <?php echo $ming; ?>API</title>
...
<legend>百度收录数量查询API</legend>
</fieldset>
<blockquote class="layui-elem-quote">本接口总调用：<?php echo $bcscslcx; ?>次·今日调用：<?php echo $bcscslcxx; ?>次</blockquote>
</div>
...
<span class="url" data-clipboard-text="http://<?php echo $_SERVER['HTTP_HOST'];?>/api/bcscslcx.php">http://<?php echo $_SERVER['HTTP_HOST'];?>/api/bcscslcx.php</span>
</p>
<p class="simpleTable">
...
<span class="url" data-clipboard-text="http://<?php echo $_SERVER['HTTP_HOST'];?>/api/bcscslcx.php?msg=https://cloud.vpsidc.com.cn">http://<?php echo $_SERVER['HTTP_HOST'];?>/api/bcscslcx.php?msg=https://cloud.vpsidc.com.cn</span>
</p>
...
<tbody>
<tr><td>msg</td><td>是</td><td>需要查询的链接</td></tr>
...
$result = file_get_contents("http://".$_SERVER['HTTP_HOST']."/api/bcscslcx.php?msg=https://cloud.vpsidc.com.cn");
echo $result;
?></pre>
</div>
...
<pre class="layui-code"><a style="color:#fd4b5c;text-decoration:none；" target="_blank">百度收录数量查询
<?php echo $ming; ?>API百度收录数量查询\n
━━━━━━━━━\n
用户:@%昵称%\n
━━━━━━━━━\n
百度收录数量查询 [网址]\n
━━━━━━━━━\n
请求示例：http://<?php echo $_SERVER['HTTP_HOST'];?>/tianyi/bcscslcx.php\n
━━━━━━━━━\n
Tips:<?php echo $ming; ?>API技术支持

百度收录数量查询 .*
$访问 http://<?php echo $_SERVER['HTTP_HOST'];?>/api/bcscslcx.php?url=%参数1%$</per>
</div>
</div>
</div>
</div>
