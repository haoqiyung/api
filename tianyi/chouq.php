...
<?php @$chouq = intval(file_get_contents("../api/tongji/jiekou/chouq.dat")); ?>
<?php @$chouqx = intval(file_get_contents("../api/tongji/jinri/".date("Y-m-d")."/chouq.dat")); ?>
...
<title>抽签 - <?php echo $ming; ?>API</title>
...
<blockquote class="layui-elem-quote">本接口总调用：<?php echo $chouq; ?>次·今日调用：<?php echo $chouqx; ?>次</blockquote>
</div>
...
<span class="url" data-clipboard-text="http://<?php echo $_SERVER['HTTP_HOST'];?>/api/chouq.php">http://<?php echo $_SERVER['HTTP_HOST'];?>/api/chouq.php</span>
</p>
<p class="simpleTable">
...
<tbody>
<tr><td>hh</td><td>豆</td><td>换行符号(默认\n)</td></tr>
</tbody>
</table>
...
$result = file_get_contents("http://".$_SERVER['HTTP_HOST']."/api/chouq.php");
echo $result;
?></pre>
</div>
...
<pre class="layui-code"><a style="color:#fd4b5c;text-decoration:none；" target="_blank">抽签
$访问 http://<?php echo $_SERVER['HTTP_HOST'];?>/api/chouq.php$</per>
</div>
</div>
</div>
</div>
