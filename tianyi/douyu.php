...
<?php @$douyu = intval(file_get_contents("../api/tongji/jiekou/douyu.dat")); ?>
<?php @$douyux = intval(file_get_contents("../api/tongji/jinri/".date("Y-m-d")."/douyu.dat")); ?>
...
<title>斗鱼直播 - <?php echo $ming; ?>API</title>
...
<legend>斗鱼直播API</legend>
</fieldset>
<blockquote class="layui-elem-quote">本接口总调用：<?php echo $douyu; ?>次·今日调用：<?php echo $douyux; ?>次</blockquote>
</div>
...
<span class="url" data-clipboard-text="http://<?php echo $_SERVER['HTTP_HOST'];?>/api/douyu.php">http://<?php echo $_SERVER['HTTP_HOST'];?>/api/douyu.php</span>
</p>
<p class="simpleTable">
...
<span class="url" data-clipboard-text="http://<?php echo $_SERVER['HTTP_HOST'];?>/api/douyu.php?msg=吉云&b=1">http://<?php echo $_SERVER['HTTP_HOST'];?>/api/douyu.php?msg=吉云&b=1</span>
</p>
...
<tbody>
<tr><td>msg</td><td>是</td><td>需要查询的主播名</td></tr>
...
$result = file_get_contents("http://".$_SERVER['HTTP_HOST']."/api/douyu.php?msg=吉云&b=1");
echo $result;
?></pre>
</div>
...
<pre class="layui-code"><a style="color:#fd4b5c;text-decoration:none；" target="_blank">斗鱼直播
<?php echo $ming; ?>API斗鱼直播\n
━━━━━━━━━\n
用户:@%昵称%\n
━━━━━━━━━\n
斗鱼直播 [名字]\n
━━━━━━━━━\n
请求示例：http://<?php echo $_SERVER['HTTP_HOST'];?>/tianyi/douyu.php\n
━━━━━━━━━\n
Tips:<?php echo $ming; ?>API技术支持

斗鱼直播 .*
$写 <?php echo $ming; ?>API/%群号%/%QQ% 斗鱼直播 %参数1%$
$访问 http://<?php echo $_SERVER['HTTP_HOST'];?>/api/douyu.php?msg=%参数1%$

选斗鱼直播 .*
W:$读 <?php echo $ming; ?>API/%群号%/%QQ% 斗鱼直播 %参数1%$
$访问 http://<?php echo $_SERVER['HTTP_HOST'];?>/api/douyu.php?msg=%W%&b=%参数1%$</per>
</div>
</div>
</div>
</div>
