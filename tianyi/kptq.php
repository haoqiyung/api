...
<?php @$kptq = intval(file_get_contents("../api/tongji/jiekou/kptq.dat")); ?>
<?php @$kptqx = intval(file_get_contents("../api/tongji/jinri/".date("Y-m-d")."/kptq.dat")); ?>
...
<title>卡片天气 - <?php echo $ming; ?>API</title>
...
<legend>卡片天气API</legend>
</fieldset>
<blockquote class="layui-elem-quote">本接口总调用：<?php echo $kptq; ?>次·今日调用：<?php echo $kptqx; ?>次</blockquote>
</div>
...
<span class="url" data-clipboard-text="http://<?php echo $_SERVER['HTTP_HOST'];?>/api/kptq.php">http://<?php echo $_SERVER['HTTP_HOST'];?>/api/kptq.php</span>
</p>
<p class="simpleTable">
...
<span class="url" data-clipboard-text="http://<?php echo $_SERVER['HTTP_HOST'];?>/api/kptq.php?msg=农安">http://<?php echo $_SERVER['HTTP_HOST'];?>/api/kptq.php?msg=农安</span>
</p>
...
$result = file_get_contents("http://".$_SERVER['HTTP_HOST']."/api/kptq.php?msg=农安");
echo $result;
?></pre>
</div>
...
<pre class="layui-code"><a style="color:#fd4b5c;text-decoration:none；" target="_blank">卡片天气
<?php echo $ming; ?>API卡片天气\n
━━━━━━━━━\n
用户:@%昵称%\n
━━━━━━━━━\n
卡片天气 [地区名]\n
━━━━━━━━━\n
请求示例：http://<?php echo $_SERVER['HTTP_HOST'];?>/tianyi/kptq.php\n
━━━━━━━━━\n
Tips:<?php echo $ming; ?>API技术支持

卡片天气 .*
$访问 http://<?php echo $_SERVER['HTTP_HOST'];?>/api/kptq.php?msg=%参数1%$</per>
</div>
</div>
</div>
</div>
