...
<?php @$bilibili2 = intval(file_get_contents("../api/tongji/jiekou/bilibili2.dat")); ?>
<?php @$bilibili2x = intval(file_get_contents("../api/tongji/jinri/".date("Y-m-d")."/bilibili2.dat")); ?>
...
<title>哔哩哔哩用户信息获取 - <?php echo $ming; ?>API</title>
...
<legend>哔哩哔哩用户信息获取API</legend>
</fieldset>
<blockquote class="layui-elem-quote">本接口总调用：<?php echo $bilibili2; ?>次·今日调用：<?php echo $bilibili2x; ?>次</blockquote>
</div>
...
<span class="url" data-clipboard-text="http://<?php echo $_SERVER['HTTP_HOST'];?>/api/bilibili2.php">http://<?php echo $_SERVER['HTTP_HOST'];?>/api/bilibili2.php</span>
</p>
<p class="simpleTable">
...
<span class="url" data-clipboard-text="http://<?php echo $_SERVER['HTTP_HOST'];?>/api/bilibili2.php?uid=1">http://<?php echo $_SERVER['HTTP_HOST'];?>/api/bilibili2.php?uid=1</span>
</p>
...
<tbody>
<tr><td>uid</td><td>是</td><td>哔哩哔哩的UID</td></tr>
...
$result = file_get_contents("http://".$_SERVER['HTTP_HOST']."/api/bilibili2.php?uid=1");
echo $result;
?></pre>
</div>
...
<pre class="layui-code"><a style="color:#fd4b5c;text-decoration:none；" target="_blank">哔哩哔哩用户信息获取
<?php echo $ming; ?>API哔哩哔哩用户信息获取\n
━━━━━━━━━\n
用户:@%昵称%\n
━━━━━━━━━\n
哔哩哔哩用户信息获取 [UID]\n
━━━━━━━━━\n
请求示例：http://<?php echo $_SERVER['HTTP_HOST'];?>/tianyi/bilibili2.php\n
━━━━━━━━━\n
Tips:<?php echo $ming; ?>API技术支持

哔哩哔哩用户信息获取 .*
$访问 http://<?php echo $_SERVER['HTTP_HOST'];?>/api/bilibili2.php?uid=%参数1%$</per>
</div>
</div>
</div>
</div>
