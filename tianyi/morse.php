...
<?php @$morse = intval(file_get_contents("../api/tongji/jiekou/morse.dat")); ?>
<?php @$morsex = intval(file_get_contents("../api/tongji/jinri/".date("Y-m-d")."/morse.dat")); ?>
...
<title>摩斯电码 - <?php echo $ming; ?>API</title>
...
<legend>摩斯电码API</legend>
</fieldset>
<blockquote class="layui-elem-quote">本接口总调用：<?php echo $morse; ?>次·今日调用：<?php echo $morsex; ?>次</blockquote>
</div>
...
<span class="url" data-clipboard-text="http://<?php echo $_SERVER['HTTP_HOST'];?>/api/morse.php">http://<?php echo $_SERVER['HTTP_HOST'];?>/api/morse.php</span>
</p>
<p class="simpleTable">
...
<span class="url" data-clipboard-text="http://<?php echo $_SERVER['HTTP_HOST'];?>/api/morse.php?id=加密&msg=吉云">http://<?php echo $_SERVER['HTTP_HOST'];?>/api/morse.php?id=加密&msg=吉云</span>
</p>
...
<tbody>
<tr><td>id</td><td>是</td><td>输加/解密</td></tr>
<tr><td>msg</td><td>是</td><td>输文字或加密后的代码</td></tr>
...
$result = file_get_contents("http://".$_SERVER['HTTP_HOST']."/api/morse.php?id=加密&msg=吉云");
echo $result;
?></pre>
</div>
...
<pre class="layui-code"><a style="color:#fd4b5c;text-decoration:none；" target="_blank">摩斯电码
<?php echo $ming; ?>API摩斯电码\n
━━━━━━━━━\n
用户:@%昵称%\n
━━━━━━━━━\n
摩斯电码加/解密 [内容]\n
━━━━━━━━━\n
请求示例：http://<?php echo $_SERVER['HTTP_HOST'];?>/tianyi/morse.php\n
━━━━━━━━━\n
Tips:<?php echo $ming; ?>API技术支持

摩斯电码(加|解)密 .*
$访问 http://<?php echo $_SERVER['HTTP_HOST'];?>/api/morse.php?id=%括号1%密&msg=%参数1%$</per>
</div>
</div>
</div>
</div>
