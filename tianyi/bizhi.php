...
<?php @$bizhi = intval(file_get_contents("../api/tongji/jiekou/bizhi.dat")); ?>
<?php @$bizhix = intval(file_get_contents("../api/tongji/jinri/".date("Y-m-d")."/bizhi.dat")); ?>
...
<title>高清壁纸 - <?php echo $ming; ?>API</title>
...
<legend>高清壁纸API</legend>
</fieldset>
<blockquote class="layui-elem-quote">本接口总调用：<?php echo $bizhi; ?>次·今日调用：<?php echo $bizhix; ?>次</blockquote>
</div>
...
<span class="url" data-clipboard-text="http://<?php echo $_SERVER['HTTP_HOST'];?>/api/bizhi.php">http://<?php echo $_SERVER['HTTP_HOST'];?>/api/bizhi.php</span>
</p>
<p class="simpleTable">
...
<span class="url" data-clipboard-text="http://<?php echo $_SERVER['HTTP_HOST'];?>/api/bizhi.php?msg=1">http://<?php echo $_SERVER['HTTP_HOST'];?>/api/bizhi.php?msg=1</span>
</p>
...
<tbody>
<tr><td>msg</td><td>是</td><td>输入数字1-30</td></tr>
...
$result = file_get_contents("http://".$_SERVER['HTTP_HOST']."/api/bizhi.php?msg=1");
echo $result;
?></pre>
</div>
...
<pre class="layui-code"><a style="color:#fd4b5c;text-decoration:none；" target="_blank">高清壁纸
Q:%随机数1-30%
$访问 http://<?php echo $_SERVER['HTTP_HOST'];?>/api/bizhi.php?msg=%Q%$</per>
</div>
</div>
</div>
</div>
