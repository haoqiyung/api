...
<?php @$Timecal2 = intval(file_get_contents("../api/tongji/jiekou/Timecal2.dat")); ?>
<?php @$Timecal2x = intval(file_get_contents("../api/tongji/jinri/".date("Y-m-d")."/Timecal2.dat")); ?>
...
<style>.url{word-break:break-all;cursor:pointer;margin-left:5px;color:#777;border:none;border-radius:0;border-bottom:2px solid #5FB878;}.simpleTable{line-height:20px;padding-bottom:16px;}.linep{font-size:14px;font-weight:700;color:#555;padding-left:14px;height:16px;line-height:16px;margin-bottom:18px;position:relative;margin-top:15px;}.linep:before{content:'';width:4px;height:16px;background:#00aeff;border-radius:2px;position:absolute;left:0;top:0;}::-weTimecal2it-scrollbar{width:9px;height:9px}::-weTimecal2it-scrollbar-track-piece{background-color:#ebebeb;-weTimecal2it-border-radius:4px}::-weTimecal2it-scrollbar-thumb:vertical{height:32px;background-color:#ccc;-weTimecal2it-border-radius:4px}::-weTimecal2it-scrollbar-thumb:horizontal{width:32px;background-color:#ccc;-weTimecal2it-border-radius:4px}</style>
</head>
<body>
...
<blockquote class="layui-elem-quote">本接口总调用：<?php echo $Timecal2; ?>次·今日调用：<?php echo $Timecal2x; ?>次</blockquote>
</div>
...
<span class="url" data-clipboard-text="http://<?php echo $_SERVER['HTTP_HOST'];?>/api/Timecal2.php">http://<?php echo $_SERVER['HTTP_HOST'];?>/api/Timecal2.php</span>
</p>
<p class="simpleTable">
...
<span class="url" data-clipboard-text="http://<?php echo $_SERVER['HTTP_HOST'];?>/api/Timecal2.php?start=00:00&end=23:00">http://<?php echo $_SERVER['HTTP_HOST'];?>/api/Timecal2.php?start=00:00&end=23:00</span>
</p>
<p class="simpleTable">
<span class="layui-badge layui-bg-green">请求示例②：</span>
<span class="url" data-clipboard-text="http://<?php echo $_SERVER['HTTP_HOST'];?>/api/Timecal22.php?start=00:00&end=23:00">http://<?php echo $_SERVER['HTTP_HOST'];?>/api/Timecal2.php?start=00:00&end=23:00</span>
</p>
...
$result = file_get_contents("http://".$_SERVER['HTTP_HOST']."/api/Timecal2.php?start=00:00&end=23:00");
echo $result;
?></pre></div>
