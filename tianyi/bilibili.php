...
<?php @$bilibili = intval(file_get_contents("../api/tongji/jiekou/bilibili.dat")); ?>
<?php @$bilibilix = intval(file_get_contents("../api/tongji/jinri/".date("Y-m-d")."/bilibili.dat")); ?>
...
<title>哔哩哔哩 - <?php echo $ming; ?>API</title>
...
<legend>哔哩哔哩API</legend>
</fieldset>
<blockquote class="layui-elem-quote">本接口总调用：<?php echo $bilibili; ?>次·今日调用：<?php echo $bilibilix; ?>次</blockquote>
</div>
...
<span class="url" data-clipboard-text="http://<?php echo $_SERVER['HTTP_HOST'];?>/api/bilibili.php">http://<?php echo $_SERVER['HTTP_HOST'];?>/api/bilibili.php</span>
</p>
<p class="simpleTable">
...
<span class="url" data-clipboard-text="http://<?php echo $_SERVER['HTTP_HOST'];?>/api/bilibili.php?msg=吉云&b=1">http://<?php echo $_SERVER['HTTP_HOST'];?>/api/bilibili.php?msg=吉云&b=1</span>
</p>
...
<tbody>
<tr><td>msg</td><td>是</td><td>需要搜索的视频内容</td></tr>
...
$result = file_get_contents("http://".$_SERVER['HTTP_HOST']."/api/bilibili.php?msg=吉云&b=1");
echo $result;
?></pre>
</div>
...
<pre class="layui-code"><a style="color:#fd4b5c;text-decoration:none；" target="_blank">哔哩哔哩
<?php echo $ming; ?>API哔哩哔哩\n
━━━━━━━━━\n
用户:@%昵称%\n
━━━━━━━━━\n
哔哩哔哩 [内容]\n
...
哔哩哔哩 .*
$写 <?php echo $ming; ?>API/%群号%/哔哩哔哩 %QQ% %参数1%$
$访问 http://<?php echo $_SERVER['HTTP_HOST'];?>/api/bilibili.php?msg=%参数1%$

选哔哩哔哩 .*
q:$读 <?php echo $ming; ?>API/%群号%/哔哩哔哩 %QQ% %参数1%$
$访问 http://<?php echo $_SERVER['HTTP_HOST'];?>/api/bilibili.php?msg=%q%&b=%参数1%$</per>
</div>
</div>
</div>
</div>
