...
<?php @$TrainTicket = intval(file_get_contents("../api/tongji/jiekou/TrainTicket.dat")); ?>
<?php @$TrainTicketx = intval(file_get_contents("../api/tongji/jinri/".date("Y-m-d")."/TrainTicket.dat")); ?>
...
<title>火车票查询 - <?php echo $ming; ?>API</title>
...
<legend>火车票查询API</legend>
</fieldset>
<blockquote class="layui-elem-quote">本接口总调用：<?php echo $TrainTicket; ?>次·今日调用：<?php echo $TrainTicketx; ?>次</blockquote>
</div>
...
<span class="url" data-clipboard-text="http://<?php echo $_SERVER['HTTP_HOST'];?>/api/TrainTicket.php">http://<?php echo $_SERVER['HTTP_HOST'];?>/api/TrainTicket.php</span>
</p>
<p class="simpleTable">
...
<span class="url" data-clipboard-text="http://<?php echo $_SERVER['HTTP_HOST'];?>/api/TrainTicket.php?departure=长春&arrival=松原&date=<?php echo date("Y-m-d");?>">http://<?php echo $_SERVER['HTTP_HOST'];?>/api/TrainTicket.php?departure=长春&arrival=松原&date=<?php echo date("Y-m-d");?></span>
</p>
...
<tbody>
<tr><td>departure</td><td>是</td><td>起点</td></tr>
<tr><td>arrival</td><td>是</td><td>终点</td></tr>
<tr><td>date</td><td>是</td><td>出发日期(格式<?php echo date("Y-m-d");?>)</td></tr>
...
$result = file_get_contents("http://".$_SERVER['HTTP_HOST']."/api/TrainTicket.php?departure=长春&arrival=松原&date=".date("Y-m-d")."");
echo $result;
?></pre>
</div>
...
<pre class="layui-code"><a style="color:#fd4b5c;text-decoration:none；" target="_blank">火车票查询
<?php echo $ming; ?>API火车票查询\n
━━━━━━━━━\n
用户:@%昵称%\n
━━━━━━━━━\n
火车票查询 [起点] [终点] [出发日期]\n
━━━━━━━━━\n
请求示例：http://<?php echo $_SERVER['HTTP_HOST'];?>/tianyi/TrainTicket.php\n
━━━━━━━━━\n
Tips:<?php echo $ming; ?>API技术支持

火车票查询 .*
$访问 http://<?php echo $_SERVER['HTTP_HOST'];?>/api/TrainTicket.php?departure=%参数1%&arrival=%参数2%&date=%参数3%$</per>
</div>
</div>
</div>
</div>
