...
<?php @$bilitop = intval(file_get_contents("../api/tongji/jiekou/bilitop.dat")); ?>
<?php @$bilitopx = intval(file_get_contents("../api/tongji/jinri/".date("Y-m-d")."/bilitop.dat")); ?>
...
<title>哔哩哔哩视频排行榜 - <?php echo $ming; ?>API</title>
...
<legend>哔哩哔哩视频排行榜API</legend>
</fieldset>
<blockquote class="layui-elem-quote">本接口总调用：<?php echo $bilitop; ?>次·今日调用：<?php echo $bilitopx; ?>次</blockquote>
</div>
...
<span class="url" data-clipboard-text="http://<?php echo $_SERVER['HTTP_HOST'];?>/api/bilitop.php">http://<?php echo $_SERVER['HTTP_HOST'];?>/api/bilitop.php</span>
</p>
<p class="simpleTable">
...
$result = file_get_contents("http://".$_SERVER['HTTP_HOST']."/api/bilitop.php");
echo $result;
?></pre>
</div>
...
<pre class="layui-code"><a style="color:#fd4b5c;text-decoration:none；" target="_blank">哔哩哔哩视频排行榜
$访问 http://<?php echo $_SERVER['HTTP_HOST'];?>/api/bilitop.php$</per>
</div>
</div>
</div>
</div>
