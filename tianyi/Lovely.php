...
<?php @$Lovely = intval(file_get_contents("../api/tongji/jiekou/Lovely.dat")); ?>
<?php @$Lovelyx = intval(file_get_contents("../api/tongji/jinri/".date("Y-m-d")."/Lovely.dat")); ?>
...
<title>动漫里那些可爱女主 - <?php echo $ming; ?>API</title>
...
<legend>动漫里那些可爱女主API</legend>
</fieldset>
<blockquote class="layui-elem-quote">本接口总调用：<?php echo $Lovely; ?>次·今日调用：<?php echo $Lovelyx; ?>次</blockquote>
</div>
...
<span class="url" data-clipboard-text="http://<?php echo $_SERVER['HTTP_HOST'];?>/api/Lovely.php">http://<?php echo $_SERVER['HTTP_HOST'];?>/api/Lovely.php</span>
</p>
<p class="simpleTable">
...
$result = file_get_contents("http://".$_SERVER['HTTP_HOST']."/api/Lovely.php");
echo $result;
?></pre>
</div>
...
<pre class="layui-code"><a style="color:#fd4b5c;text-decoration:none；" target="_blank">动漫里那些可爱女主
$访问 http://<?php echo $_SERVER['HTTP_HOST'];?>/api/Lovely.php$</per>
</div>
</div>
</div>
</div>
