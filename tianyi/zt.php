...
<?php @$zt = intval(file_get_contents("../api/tongji/jiekou/zt.dat")); ?>
<?php @$ztx = intval(file_get_contents("../api/tongji/jinri/".date("Y-m-d")."/zt.dat")); ?>
...
<title>小人举牌 - <?php echo $ming; ?>API</title>
...
<legend>小人举牌API</legend>
</fieldset>
<blockquote class="layui-elem-quote">本接口总调用：<?php echo $zt; ?>次·今日调用：<?php echo $ztx; ?>次</blockquote>
</div>
...
<span class="url" data-clipboard-text="http://<?php echo $_SERVER['HTTP_HOST'];?>/api/zt.php">http://<?php echo $_SERVER['HTTP_HOST'];?>/api/zt.php</span>
</p>
<p class="simpleTable">
...
<span class="url" data-clipboard-text="http://<?php echo $_SERVER['HTTP_HOST'];?>/api/zt.php?msg=吉云">http://<?php echo $_SERVER['HTTP_HOST'];?>/api/zt.php?msg=吉云</span>
</p>
...
<tbody>
<tr><td>msg</td><td>是</td><td>要举牌的字</td></tr>
</tbody>
</table>
...
<pre class="layui-code"><img src="../api/zt.php?msg=吉云" style="width: 45%;"></pre>
</div>
...
<pre class="layui-code"><a style="color:#fd4b5c;text-decoration:none；" target="_blank">小人举牌
<?php echo $ming; ?>API小人举牌\n
━━━━━━━━━\n
用户:@%昵称%\n
━━━━━━━━━\n
小人举牌 [内容]\n
━━━━━━━━━\n
请求示例：http://<?php echo $_SERVER['HTTP_HOST'];?>/tianyi/zt.php\n
━━━━━━━━━\n
...
用户:@%昵称%\n
━━━━━━━━━\n
±img=http://<?php echo $_SERVER['HTTP_HOST'];?>/api/zt.php?msg=%参数1%±\n
━━━━━━━━━\n
