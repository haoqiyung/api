...
<?php @$chaliwu = intval(file_get_contents("../api/tongji/jiekou/chaliwu.dat")); ?>
<?php @$chaliwux = intval(file_get_contents("../api/tongji/jinri/".date("Y-m-d")."/chaliwu.dat")); ?>
...
<title>QQ查礼物 - <?php echo $ming; ?>API</title>
<meta name="keywords" content=""/>
<meta name="description" content="">    
<link rel="stylesheet" href="./assets/css/layer.css">
<script src="https://ku.oioweb.cn/LayUI/2.5.4/layui.all.js"></script>
<style>.url{word-break:break-all;cursor:pointer;margin-left:5px;color:#777;border:none;border-radius:0;border-bottom:2px solid #5FB878;}.simpleTable{line-height:20px;padding-bottom:16px;}.linep{font-size:14px;font-weight:700;color:#555;padding-left:14px;height:16px;line-height:16px;margin-bottom:18px;position:relative;margin-top:15px;}.linep:before{content:'';width:4px;height:16px;background:#00aeff;border-radius:2px;position:absolute;left:0;top:0;}::-wechaliwuit-scrollbar{width:9px;height:9px}::-wechaliwuit-scrollbar-track-piece{background-color:#ebebeb;-wechaliwuit-border-radius:4px}::-wechaliwuit-scrollbar-thumb:vertical{height:32px;background-color:#ccc;-wechaliwuit-border-radius:4px}::-wechaliwuit-scrollbar-thumb:horizontal{width:32px;background-color:#ccc;-wechaliwuit-border-radius:4px}</style>
</head>
<body>
<div class="layui-container">
<div class="layui-row">
<fieldset class="layui-elem-field layui-field-title" style="margin-top: 20px;">
<legend>QQ查礼物API</legend>
</fieldset>
<blockquote class="layui-elem-quote">本接口总调用：<?php echo $chaliwu; ?>次·今日调用：<?php echo $chaliwux; ?>次</blockquote>
</div>
...
<span class="url" data-clipboard-text="http://<?php echo $_SERVER['HTTP_HOST'];?>/api/chaliwu.php">http://<?php echo $_SERVER['HTTP_HOST'];?>/api/chaliwu.php</span>
</p>
<p class="simpleTable">
...
<span class="url" data-clipboard-text="http://<?php echo $_SERVER['HTTP_HOST'];?>/api/chaliwu.php?qq=[QQ号]&skey=[获取的skey]">http://<?php echo $_SERVER['HTTP_HOST'];?>/api/chaliwu.php?qq=[QQ号]&skey=[获取的skey]</span>
</p>
...
<tbody>
<tr><td>skey</td><td>是</td><td>登录者的skey</td></tr>
<tr><td>qq</td><td>是</td><td>登录者的QQ号</td></tr>
...
<pre class="layui-code"><a style="color:#fd4b5c;text-decoration:none；" target="_blank">QQ查礼物
$访问 http://<?php echo $_SERVER['HTTP_HOST'];?>/api/chaliwu.php?qq=%Robot%&skey=%Skey%$</per>
</div>
</div>
</div>
</div>
