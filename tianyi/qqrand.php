...
<?php @$qqrand = intval(file_get_contents("../api/tongji/jiekou/qqrand.dat")); ?>
<?php @$qqrandx = intval(file_get_contents("../api/tongji/jinri/".date("Y-m-d")."/qqrand.dat")); ?>
...
<title>QQ音乐排行榜 - <?php echo $ming; ?>API</title>
...
<legend>QQ音乐排行榜API</legend>
</fieldset>
<blockquote class="layui-elem-quote">本接口总调用：<?php echo $qqrand; ?>次·今日调用：<?php echo $qqrandx; ?>次</blockquote>
</div>
...
<span class="url" data-clipboard-text="http://<?php echo $_SERVER['HTTP_HOST'];?>/api/qqrand.php">http://<?php echo $_SERVER['HTTP_HOST'];?>/api/qqrand.php</span>
</p>
<p class="simpleTable">
...
<span class="url" data-clipboard-text="http://<?php echo $_SERVER['HTTP_HOST'];?>/api/qqrand.php?msg=新歌榜">http://<?php echo $_SERVER['HTTP_HOST'];?>/api/qqrand.php?msg=新歌榜</span>
</p>
...
<tbody>
<tr><td>msg</td><td>是</td><td>输(新歌榜/热歌榜/彪升榜)</td></tr>
</tbody>
</table>
...
<pre class="layui-code"><a style="color:#fd4b5c;text-decoration:none；" target="_blank">QQ音乐排行榜
<?php echo $ming; ?>API♧QQ音乐排行榜\n
━━━━━━━━━\n
用户:@%昵称%\n
━━━━━━━━━\n
QQ音乐排行榜 [输(新歌榜/热歌榜/彪升榜)]\n
━━━━━━━━━\n
Tips:<?php echo $ming; ?>API技术支持

QQ音乐排行榜 .*
$访问 http://<?php echo $_SERVER['HTTP_HOST'];?>/api/qqrand.php?msg=%参数1%$
</div>
</div>
</div>
</div>
