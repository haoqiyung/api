...
<?php @$shehui = intval(file_get_contents("../api/tongji/jiekou/shehui.dat")); ?>
<?php @$shehuix = intval(file_get_contents("../api/tongji/jinri/".date("Y-m-d")."/shehui.dat")); ?>
...
<title>社会语录 - <?php echo $ming; ?>API</title>
...
<legend>社会语录API</legend>
</fieldset>
<blockquote class="layui-elem-quote">本接口总调用：<?php echo $shehui; ?>次·今日调用：<?php echo $shehuix; ?>次</blockquote>
</div>
...
<span class="url" data-clipboard-text="http://<?php echo $_SERVER['HTTP_HOST'];?>/api/shehui.php">http://<?php echo $_SERVER['HTTP_HOST'];?>/api/shehui.php</span>
</p>
<p class="simpleTable">
...
$result = file_get_contents("http://".$_SERVER['HTTP_HOST']."/api/shehui.php");
echo $result;
?></pre></div>
...
<pre class="layui-code"><a style="color:#fd4b5c;text-decoration:none；" target="_blank">社会语录
$访问 http://<?php echo $_SERVER['HTTP_HOST'];?>/api/shehui.php$</per>
</div>
</div>
</div>
</div>
