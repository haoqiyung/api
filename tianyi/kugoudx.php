...
<?php @$kugoudx = intval(file_get_contents("../api/tongji/jiekou/kugoudx.dat")); ?>
<?php @$kugoudxx = intval(file_get_contents("../api/tongji/jinri/".date("Y-m-d")."/kugoudx.dat")); ?>
...
<title>酷狗音乐 - <?php echo $ming; ?>API</title>
...
<legend>酷狗音乐API</legend>
</fieldset>
<blockquote class="layui-elem-quote">本接口总调用：<?php echo $kugoudx; ?>次·今日调用：<?php echo $kugoudxx; ?>次</blockquote>
</div>
...
<span class="url" data-clipboard-text="http://<?php echo $_SERVER['HTTP_HOST'];?>/api/kugoudx.php">http://<?php echo $_SERVER['HTTP_HOST'];?>/api/kugoudx.php</span>
</p>
<p class="simpleTable">
...
<span class="url" data-clipboard-text="http://<?php echo $_SERVER['HTTP_HOST'];?>/api/kugoudx.php?msg=吉云&b=1">http://<?php echo $_SERVER['HTTP_HOST'];?>/api/kugoudx.php?msg=吉云&b=1</span>
</p>
...
$result = file_get_contents("http://".$_SERVER['HTTP_HOST']."/api/kugoudx.php?msg=吉云&b=1");
echo $result;
?></pre>
</div>
...
<pre class="layui-code"><a style="color:#fd4b5c;text-decoration:none；" target="_blank">酷狗音乐
<?php echo $ming; ?>API酷狗音乐\n
━━━━━━━━━\n
用户:@%昵称%\n
━━━━━━━━━\n
酷狗音乐 [内容]\n
━━━━━━━━━\n
请求示例：http://<?php echo $_SERVER['HTTP_HOST'];?>/tianyi/kugoudx.php\n
━━━━━━━━━\n
Tips:<?php echo $ming; ?>API技术支持

酷狗音乐 .*
$写 <?php echo $ming; ?>API/%群号%/酷狗音乐 %QQ% %参数1%$
$访问 http://<?php echo $_SERVER['HTTP_HOST'];?>/api/kugoudx.php?msg=%参数1%$

选酷狗音乐 .*
T:$读 <?php echo $ming; ?>API/%群号%/酷狗音乐 %QQ% %参数1%$
$访问 http://<?php echo $_SERVER['HTTP_HOST'];?>/api/kugoudx.php?msg=%T%&b=%参数1%$</per>
</div>
</div>
</div>
</div>
