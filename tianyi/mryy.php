...
<?php @$mryy = intval(file_get_contents("../api/tongji/jiekou/mryy.dat")); ?>
<?php @$mryyx = intval(file_get_contents("../api/tongji/jinri/".date("Y-m-d")."/mryy.dat")); ?>
...
<title>每日一句 - <?php echo $ming; ?>API</title>
...
<legend>每日一句API</legend>
</fieldset>
<blockquote class="layui-elem-quote">本接口总调用：<?php echo $mryy; ?>次·今日调用：<?php echo $mryyx; ?>次</blockquote>
</div>
...
<span class="url" data-clipboard-text="http://<?php echo $_SERVER['HTTP_HOST'];?>/api/mryy/mryy.php">http://<?php echo $_SERVER['HTTP_HOST'];?>/api/mryy/mryy.php</span>
</p>
<p class="simpleTable">
...
<span class="url" data-clipboard-text="http://<?php echo $_SERVER['HTTP_HOST'];?>/api/mryy.php">http://<?php echo $_SERVER['HTTP_HOST'];?>/api/mryy.php</span>
</p>
...
<tbody>
<tr><td>time</td><td>否</td><td>需要查询的日期(默认今日)</td></tr>
...
$result = file_get_contents("http://".$_SERVER['HTTP_HOST']."/api/mryy.php");
echo $result;
?></pre>
</div>
...
<pre class="layui-code"><a style="color:#fd4b5c;text-decoration:none；" target="_blank">每日一句
$访问 http://<?php echo $_SERVER['HTTP_HOST'];?>/api/mryy.php$</per>
</div>
</div>
</div>
</div>
