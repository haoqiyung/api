...
<?php @$qmxh = intval(file_get_contents("../api/tongji/jiekou/qmxh.dat")); ?>
<?php @$qmxhx = intval(file_get_contents("../api/tongji/jinri/".date("Y-m-d")."/qmxh.dat")); ?>
...
<title>趣味笑话 - <?php echo $ming; ?>API</title>
...
<legend>趣味笑话API</legend>
</fieldset>
<blockquote class="layui-elem-quote">本接口总调用：<?php echo $qmxh; ?>次·今日调用：<?php echo $qmxhx; ?>次</blockquote>
</div>
...
<span class="url" data-clipboard-text="http://<?php echo $_SERVER['HTTP_HOST'];?>/api/qwxh.php">http://<?php echo $_SERVER['HTTP_HOST'];?>/api/qwxh.php</span>
</p>
<p class="simpleTable">
...
$result = file_get_contents("http://".$_SERVER['HTTP_HOST']."/api/qwxh.php");
echo $result;
?></pre></div>
...
<pre class="layui-code"><a style="color:#fd4b5c;text-decoration:none；" target="_blank">趣味笑话
$访问 http://<?php echo $_SERVER['HTTP_HOST'];?>/api/qwxh.php$</per>
</div>
</div>
</div>
</div>
