...
<?php @$xinwen = intval(file_get_contents("../api/tongji/jiekou/xinwen.dat")); ?>
<?php @$xinwenx = intval(file_get_contents("../api/tongji/jinri/".date("Y-m-d")."/xinwen.dat")); ?>
...
<title>新闻 - <?php echo $ming; ?>API</title>
...
<blockquote class="layui-elem-quote">本接口总调用：<?php echo $xinwen; ?>次·今日调用：<?php echo $xinwenx; ?>次</blockquote>
</div>
...
<span class="url" data-clipboard-text="http://<?php echo $_SERVER['HTTP_HOST'];?>/api/xinwen.php">http://<?php echo $_SERVER['HTTP_HOST'];?>/api/xinwen.php</span>
</p>
<p class="simpleTable">
...
<span class="url" data-clipboard-text="http://<?php echo $_SERVER['HTTP_HOST'];?>/api/xinwen.php?msg=财经">http://<?php echo $_SERVER['HTTP_HOST'];?>/api/xinwen.php?msg=财经</span>
</p>
...
<tbody>
<tr><td>msg</td><td>是</td><td>输(财经、科技、军事、时尚、NBA、股票、游戏、健康、知否、要闻、体育、娱乐、头条)</td></tr>
</tbody>
</table>
...
$result = file_get_contents("http://".$_SERVER['HTTP_HOST']."/api/xinwen.php?msg=财经");
echo $result;
?></pre></div>
