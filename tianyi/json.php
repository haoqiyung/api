...
<?php @$json = intval(file_get_contents("../api/tongji/jiekou/json.dat")); ?>
<?php @$jsonx = intval(file_get_contents("../api/tongji/jinri/".date("Y-m-d")."/json.dat")); ?>
...
<title>json编码转换 - <?php echo $ming; ?>API</title>
<meta name="nrwords" content=""/>
...
<legend>json编码转换API</legend>
</fieldset>
<blockquote class="layui-elem-quote">本接口总调用：<?php echo $json; ?>次·今日调用：<?php echo $jsonx; ?>次</blockquote>
</div>
...
<span class="url" data-clipboard-text="http://<?php echo $_SERVER['HTTP_HOST'];?>/api/json.php">http://<?php echo $_SERVER['HTTP_HOST'];?>/api/json.php</span>
</p>
<p class="simpleTable">
...
<span class="url" data-clipboard-text="http://<?php echo $_SERVER['HTTP_HOST'];?>/api/json.php?nr=%E5%90%89%E4%BA%91">http://<?php echo $_SERVER['HTTP_HOST'];?>/api/json.php?nr=%E5%90%89%E4%BA%91</span>
</p>
...
<tbody>
<tr><td>nr</td><td>是</td><td>需要转码内容</td></tr>
...
$result = file_get_contents("http://".$_SERVER['HTTP_HOST']."/api/json.php?nr=%E5%90%89%E4%BA%91");
echo $result;
?></pre>
</div>
...
<pre class="layui-code"><a style="color:#fd4b5c;text-decoration:none；" target="_blank">json编码转换
<?php echo $ming; ?>API♧json编码转换\n
━━━━━━━━━\n
用户:@%昵称%\n
━━━━━━━━━\n
json编码转换 [网址]\n
━━━━━━━━━\n
请求示例：http://<?php echo $_SERVER['HTTP_HOST'];?>/tianyi/json.php\n
━━━━━━━━━\n
Tips:<?php echo $ming; ?>API技术支持

json编码转换 .*
$访问 http://<?php echo $_SERVER['HTTP_HOST'];?>/api/json.php?nr=%参数1%$</per>
</div>
</div>
</div>
</div>
