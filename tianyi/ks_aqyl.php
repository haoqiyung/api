...
<?php @$ks_aqyl = intval(file_get_contents("../api/tongji/jiekou/ks_aqyl.dat")); ?>
<?php @$ks_aqylx = intval(file_get_contents("../api/tongji/jinri/".date("Y-m-d")."/ks_aqyl.dat")); ?>
...
<title>快手爱情语录 - <?php echo $ming; ?>API</title>
...
<legend>快手爱情语录API</legend>
</fieldset>
<blockquote class="layui-elem-quote">本接口总调用：<?php echo $ks_aqyl; ?>次·今日调用：<?php echo $ks_aqylx; ?>次</blockquote>
</div>
...
<span class="url" data-clipboard-text="http://<?php echo $_SERVER['HTTP_HOST'];?>/api/ks_aqyl.php">http://<?php echo $_SERVER['HTTP_HOST'];?>/api/ks_aqyl.php</span>
</p>
<p class="simpleTable">
...
$result = file_get_contents("http://".$_SERVER['HTTP_HOST']."/api/ks_aqyl.php");
echo $result;
?></pre>
</div>
...
<pre class="layui-code"><a style="color:#fd4b5c;text-decoration:none；" target="_blank">快手爱情语录
<?php echo $ming; ?>API快手爱情语录\n
━━━━━━━━━\n
用户:@%昵称%\n
━━━━━━━━━\n
$访问 http://<?php echo $_SERVER['HTTP_HOST'];?>/api/ks_aqyl.php$\n
━━━━━━━━━\n
请求示例：http://<?php echo $_SERVER['HTTP_HOST'];?>/tianyi/ks_aqyl.php\n
━━━━━━━━━\n
