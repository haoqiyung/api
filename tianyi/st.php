...
<?php @$st = intval(file_get_contents("../api/tongji/jiekou/st.dat")); ?>
<?php @$stx = intval(file_get_contents("../api/tongji/jinri/".date("Y-m-d")."/st.dat")); ?>
...
<title>搜图 - <?php echo $ming; ?>API</title>
...
<blockquote class="layui-elem-quote">本接口总调用：<?php echo $st; ?>次·今日调用：<?php echo $stx; ?>次</blockquote>
</div>
...
<p class="simpleTable">
<span class="layui-badge layui-bg-blue">360请求示例：</span>
<span class="url" data-clipboard-text="http://<?php echo $_SERVER['HTTP_HOST'];?>/api/st.php?id=360&msg=美女">http://<?php echo $_SERVER['HTTP_HOST'];?>/api/st.php?id=360&msg=美女</span>
</p>
<p class="simpleTable">
<span class="layui-badge layui-bg-blue">搜狗请求示例：</span>
<span class="url" data-clipboard-text="http://<?php echo $_SERVER['HTTP_HOST'];?>/api/st.php?id=搜狗&msg=美女">http://<?php echo $_SERVER['HTTP_HOST'];?>/api/st.php?id=搜狗&msg=美女</span>
</p>
...
<tbody>
<tr><td>id</td><td>是</td><td>输360/搜狗</td></tr>
<tr><td>msg</td><td>是</td><td>要搜索图片的内容</td></tr>
</tbody>
</table>
...
$result = file_get_contents("http://".$_SERVER['HTTP_HOST']."/api/st.php?id=搜狗&msg=美女");
echo $result;
?></pre>
</div>
...
<div class="layui-tab-item">
<p class="linep">机器人使用示例：</p>
<pre class="layui-code"><a style="color:#fd4b5c;text-decoration:none；" target="_blank">搜图
<?php echo $ming; ?>API搜图\n
━━━━━━━━━\n
用户:@%昵称%\n
━━━━━━━━━\n
360/搜狗搜图 [内容]\n
━━━━━━━━━\n
请求示例：http://<?php echo $_SERVER['HTTP_HOST'];?>/tianyi/st.php\n
━━━━━━━━━\n
...
用户:@%昵称%\n
━━━━━━━━━\n
±img=$访问 http://<?php echo $_SERVER['HTTP_HOST'];?>/api/st.php?id=%括号1%&msg=%参数1%$±\n
━━━━━━━━━\n
