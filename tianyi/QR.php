...
<?php @$QR = intval(file_get_contents("../api/tongji/jiekou/QR.dat")); ?>
<?php @$QRx = intval(file_get_contents("../api/tongji/jinri/".date("Y-m-d")."/QR.dat")); ?>
...
<title>QRSpeed授权查询 - <?php echo $ming; ?>API</title>
<meta name="keywords" content=""/>
<meta name="description" content="">    
<link rel="stylesheet" href="./assets/css/layer.css">
<script src="https://ku.oioweb.cn/LayUI/2.5.4/layui.all.js"></script>
<style>.url{word-break:break-all;cursor:pointer;margin-left:5px;color:#777;border:none;border-radius:0;border-bottom:2px solid #5FB878;}.simpleTable{line-height:20px;padding-bottom:16px;}.linep{font-size:14px;font-weight:700;color:#555;padding-left:14px;height:16px;line-height:16px;margin-bottom:18px;position:relative;margin-top:15px;}.linep:before{content:'';width:4px;height:16px;background:#00aeff;border-radius:2px;position:absolute;left:0;top:0;}::-weQRit-scrollbar{width:9px;height:9px}::-weQRit-scrollbar-track-piece{background-color:#ebebeb;-weQRit-border-radius:4px}::-weQRit-scrollbar-thumb:vertical{height:32px;background-color:#ccc;-weQRit-border-radius:4px}::-weQRit-scrollbar-thumb:horizontal{width:32px;background-color:#ccc;-weQRit-border-radius:4px}</style>
</head>
<body>
<div class="layui-container">
<div class="layui-row">
<fieldset class="layui-elem-field layui-field-title" style="margin-top: 20px;">
<legend>QRSpeed授权查询API</legend>
</fieldset>
<blockquote class="layui-elem-quote">本接口总调用：<?php echo $QR; ?>次·今日调用：<?php echo $QRx; ?>次</blockquote>
</div>
...
<span class="url" data-clipboard-text="http://<?php echo $_SERVER['HTTP_HOST'];?>/api/QR.php">http://<?php echo $_SERVER['HTTP_HOST'];?>/api/QR.php</span>
</p>
<p class="simpleTable">
...
<span class="url" data-clipboard-text="http://<?php echo $_SERVER['HTTP_HOST'];?>/api/QR.php?qq=2787273169">http://<?php echo $_SERVER['HTTP_HOST'];?>/api/QR.php?qq=2787273169</span>
</p>
...
$result = file_get_contents("http://".$_SERVER['HTTP_HOST']."/api/QR.php?qq=2787273169");
echo $result;
?></pre>
</div>
...
<pre class="layui-code"><a style="color:#fd4b5c;text-decoration:none；" target="_blank">QRSpeed授权查询
<?php echo $ming; ?>API♧QRSpeed授权查询\n
━━━━━━━━━\n
用户:@%昵称%\n
━━━━━━━━━\n
QRSpeed授权查询 [QQ号]\n
━━━━━━━━━\n
请求示例：http://<?php echo $_SERVER['HTTP_HOST'];?>/tianyi/QR.php\n
━━━━━━━━━\n
Tips:<?php echo $ming; ?>API技术支持

QRSpeed授权查询 .*
$访问 http://<?php echo $_SERVER['HTTP_HOST'];?>/api/QR.php?qq=%参数1%$</per>
</div>
</div>
</div>
</div>
