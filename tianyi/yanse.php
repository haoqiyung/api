...
<?php @$yanse = intval(file_get_contents("../api/tongji/jiekou/yanse.dat")); ?>
<?php @$yansex = intval(file_get_contents("../api/tongji/jinri/".date("Y-m-d")."/yanse.dat")); ?>
...
<title>随机颜色 - <?php echo $ming; ?>API</title>
...
<legend>随机颜色API</legend>
</fieldset>
<blockquote class="layui-elem-quote">本接口总调用：<?php echo $yanse; ?>次·今日调用：<?php echo $yansex; ?>次</blockquote>
</div>
...
<span class="url" data-clipboard-text="http://<?php echo $_SERVER['HTTP_HOST'];?>/api/yanse.php">http://<?php echo $_SERVER['HTTP_HOST'];?>/api/yanse.php</span>
</p>
<p class="simpleTable">
...
$result = file_get_contents("http://".$_SERVER['HTTP_HOST']."/api/yanse.php");
echo $result;
?></pre>
</div>
...
<pre class="layui-code"><a style="color:#fd4b5c;text-decoration:none；" target="_blank">随机颜色
<?php echo $ming; ?>API随机颜色\n
━━━━━━━━━\n
用户:@%昵称%\n
━━━━━━━━━\n
$访问 http://<?php echo $_SERVER['HTTP_HOST'];?>/api/yanse.php$\n
━━━━━━━━━\n
请求示例：http://<?php echo $_SERVER['HTTP_HOST'];?>/tianyi/yanse.php\n
━━━━━━━━━\n
