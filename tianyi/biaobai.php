...
<title>表白页生成 - <?php echo $ming; ?>API</title>
...
<span class="url" data-clipboard-text="http://<?php echo $_SERVER['HTTP_HOST'];?>/api/data/biaobai/biaobai.php">http://<?php echo $_SERVER['HTTP_HOST'];?>/api/data/biaobai/biaobai.php</span>
</p>
<p class="simpleTable">
...
<span class="url" data-clipboard-text="http://<?php echo $_SERVER['HTTP_HOST'];?>/api/data/biaobai/biaobai.php?a=<?php echo $ming; ?>&img=https://s1.ax1x.com/2020/08/21/dNdZa4.gif">http://<?php echo $_SERVER['HTTP_HOST'];?>/api/data/biaobai/biaobai.php?a=<?php echo $ming; ?>&img=https://s1.ax1x.com/2020/08/21/dNdZa4.gif</span>
</p>
...
<tbody>
<tr><td>a</td><td>是</td><td>输对象的名字</td></tr>
<tr><td>img</td><td>是</td><td>图片链接</td></tr>
</tbody>
</table>
...
<pre class="layui-code">本API直接跳转网页</pre>
</div>
