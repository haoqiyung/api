...
<?php @$szdst = intval(file_get_contents("../api/tongji/jiekou/szdst.dat")); ?>
<?php @$szdstx = intval(file_get_contents("../api/tongji/jinri/".date("Y-m-d")."/szdst.dat")); ?>
...
<title>苏州直播源获取 - <?php echo $ming; ?>API</title>
...
<legend>苏州直播源获取API</legend>
</fieldset>
<blockquote class="layui-elem-quote">本接口总调用：<?php echo $szdst; ?>次·今日调用：<?php echo $szdstx; ?>次</blockquote>
</div>
...
<span class="url" data-clipboard-text="http://<?php echo $_SERVER['HTTP_HOST'];?>/api/szdst.php">http://<?php echo $_SERVER['HTTP_HOST'];?>/api/szdst.php</span>
</p>
<p class="simpleTable">
...
<span class="url" data-clipboard-text="http://<?php echo $_SERVER['HTTP_HOST'];?>/api/szdst.php?channel=sztv1">http://<?php echo $_SERVER['HTTP_HOST'];?>/api/szdst.php?channel=sztv1</span>
</p>
...
<tbody>
<tr><td>channel</td><td>是</td><td>输sztv1-sztv5</td></tr>
</tbody>
</table>
...
<pre class="layui-code">本API直接返回电视链接</pre>
</div>
