...
<?php @$xjj = intval(file_get_contents("../api/tongji/jiekou/xjj.dat")); ?>
<?php @$xjjx = intval(file_get_contents("../api/tongji/jinri/".date("Y-m-d")."/xjj.dat")); ?>
...
<legend>随机视频API</legend>
</fieldset>
<blockquote class="layui-elem-quote">本接口总调用：<?php echo $xjj; ?>次·今日调用：<?php echo $xjjx; ?>次</blockquote>
</div>
...
<span class="url" data-clipboard-text="http://<?php echo $_SERVER['HTTP_HOST'];?>/api/xjj.php">http://<?php echo $_SERVER['HTTP_HOST'];?>/api/xjj.php</span>
</p>
<p class="simpleTable">
...
$result = file_get_contents("http://".$_SERVER['HTTP_HOST']."/api/xjj.php");
echo $result;
?></pre>
</div>
