...
<?php @$jxsp = intval(file_get_contents("../api/tongji/jiekou/jxsp.dat")); ?>
<?php @$jxspx = intval(file_get_contents("../api/tongji/jinri/".date("Y-m-d")."/jxsp.dat")); ?>
...
<blockquote class="layui-elem-quote">本接口总调用：<?php echo $jxsp; ?>次·今日调用：<?php echo $jxspx; ?>次</blockquote>
</div>
...
<span class="url" data-clipboard-text="http://<?php echo $_SERVER['HTTP_HOST'];?>/api/jxsp.php">http://<?php echo $_SERVER['HTTP_HOST'];?>/api/jxsp.php</span>
</p>
<p class="simpleTable">
...
<tbody>
<tr><td>lx</td><td>否</td><td>输(网红/明星/热舞/风景/游戏/萌宠)(默认随机)</td></tr>
...
$result = file_get_contents("http://".$_SERVER['HTTP_HOST']."/api/jxsp.php");
echo $result;
?></pre>
</div>
