...
<?php @$wzpt = intval(file_get_contents("../api/tongji/jiekou/wzpt.dat")); ?>
<?php @$wzptx = intval(file_get_contents("../api/tongji/jinri/".date("Y-m-d")."/wzpt.dat")); ?>
...
<title>文字配图 - <?php echo $ming; ?>API</title>
...
<legend>文字配图API</legend>
</fieldset>
<blockquote class="layui-elem-quote">本接口总调用：<?php echo $wzpt; ?>次·今日调用：<?php echo $wzptx; ?>次</blockquote>
</div>
...
<span class="url" data-clipboard-text="http://<?php echo $_SERVER['HTTP_HOST'];?>/api/wzpt.php">http://<?php echo $_SERVER['HTTP_HOST'];?>/api/wzpt.php</span>
</p>
<p class="simpleTable">
...
<pre class="layui-code"><img src="../api/wzpt.php" style="width: 45%;"></pre>
</div>
...
<pre class="layui-code"><a style="color:#fd4b5c;text-decoration:none；" target="_blank">文字配图
<?php echo $ming; ?>API文字配图\n
━━━━━━━━━\n
用户:@%昵称%\n
━━━━━━━━━\n
±img=http://<?php echo $_SERVER['HTTP_HOST'];?>/api/wzpt.php±\n
━━━━━━━━━\n
请求示例：http://<?php echo $_SERVER['HTTP_HOST'];?>/tianyi/wzpt.php\n
━━━━━━━━━\n
