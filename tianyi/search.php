...
<?php @$searcn = intval(file_get_contents("../api/tongji/jiekou/search.dat")); ?>
<?php @$searcnx = intval(file_get_contents("../api/tongji/jinri/".date("Y-m-d")."/search.dat")); ?>
...
<title>查字 - <?php echo $ming; ?>API</title>
<meta name="keywords" content=""/>
<meta name="description" content="">    
<link rel="stylesheet" href="./assets/css/layer.css">
<script src="https://ku.oioweb.cn/LayUI/2.5.4/layui.all.js"></script>
<style>.url{word-break:break-all;cursor:pointer;margin-left:5px;color:#777;border:none;border-radius:0;border-bottom:2px solid #5FB878;}.simpleTable{line-height:20px;padding-bottom:16px;}.linep{font-size:14px;font-weight:700;color:#555;padding-left:14px;height:16px;line-height:16px;margin-bottom:18px;position:relative;margin-top:15px;}.linep:before{content:'';width:4px;height:16px;background:#00aeff;border-radius:2px;position:absolute;left:0;top:0;}::-wesearcnit-scrollbar{width:9px;height:9px}::-wesearcnit-scrollbar-track-piece{background-color:#ebebeb;-wesearcnit-border-radius:4px}::-wesearcnit-scrollbar-thumb:vertical{height:32px;background-color:#ccc;-wesearcnit-border-radius:4px}::-wesearcnit-scrollbar-thumb:horizontal{width:32px;background-color:#ccc;-wesearcnit-border-radius:4px}</style>
</head>
<body>
...
<blockquote class="layui-elem-quote">本接口总调用：<?php echo $searcn; ?>次·今日调用：<?php echo $searcnx; ?>次</blockquote>
</div>
...
<span class="url" data-clipboard-text="http://<?php echo $_SERVER['HTTP_HOST'];?>/api/search.php">http://<?php echo $_SERVER['HTTP_HOST'];?>/api/search.php</span>
</p>
<p class="simpleTable">
...
<span class="url" data-clipboard-text="http://<?php echo $_SERVER['HTTP_HOST'];?>/api/search.php?msg=吉">http://<?php echo $_SERVER['HTTP_HOST'];?>/api/search.php?msg=吉</span>
</p>
...
<tbody>
<tr><td>msg</td><td>是</td><td>需要查询的字</td></tr>
...
$result = file_get_contents("http://".$_SERVER['HTTP_HOST']."/api/search.php?msg=吉");
echo $result;
?></pre>
</div>
...
<pre class="layui-code"><a style="color:#fd4b5c;text-decoration:none；" target="_blank">查字
<?php echo $ming; ?>API查字\n
━━━━━━━━━\n
用户:@%昵称%\n
━━━━━━━━━\n
查字 [内容]\n
━━━━━━━━━\n
请求示例：http://<?php echo $_SERVER['HTTP_HOST'];?>/tianyi/search.php\n
━━━━━━━━━\n
Tips:<?php echo $ming; ?>API技术支持

查字 .*
$访问 http://<?php echo $_SERVER['HTTP_HOST'];?>/api/search.php?msg=%参数1%$</per>
</div>
</div>
</div>
</div>
