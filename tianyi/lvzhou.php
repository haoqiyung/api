...
<?php @$lvzhou = intval(file_get_contents("../api/tongji/jiekou/lvzhou.dat")); ?>
<?php @$lvzhoux = intval(file_get_contents("../api/tongji/jinri/".date("Y-m-d")."/lvzhou.dat")); ?>
...
<title>绿洲无水印解析 - <?php echo $ming; ?>API</title>
...
<legend>绿洲无水印解析API</legend>
</fieldset>
<blockquote class="layui-elem-quote">本接口总调用：<?php echo $lvzhou; ?>次·今日调用：<?php echo $lvzhoux; ?>次</blockquote>
</div>
...
<span class="url" data-clipboard-text="http://<?php echo $_SERVER['HTTP_HOST'];?>/api/lvzhou.php">http://<?php echo $_SERVER['HTTP_HOST'];?>/api/lvzhou.php</span>
</p>
<p class="simpleTable">
...
<span class="url" data-clipboard-text="http://<?php echo $_SERVER['HTTP_HOST'];?>/api/lvzhou.php?url=https://m.oasis.weibo.cn/v1/h5/share?sid=4654553842320119">http://<?php echo $_SERVER['HTTP_HOST'];?>/api/lvzhou.php?url=https://m.oasis.weibo.cn/v1/h5/share?sid=4654553842320119</span>
</p>
...
$result = file_get_contents("http://".$_SERVER['HTTP_HOST']."/api/lvzhou.php?url=https://m.oasis.weibo.cn/v1/h5/share?sid=4654553842320119");
echo $result;
?></pre>
</div>
...
<pre class="layui-code"><a style="color:#fd4b5c;text-decoration:none；" target="_blank">绿洲无水印解析
<?php echo $ming; ?>API绿洲无水印解析\n
━━━━━━━━━\n
用户:@%昵称%\n
━━━━━━━━━\n
绿洲无水印解析 [网址]\n
━━━━━━━━━\n
请求示例：http://<?php echo $_SERVER['HTTP_HOST'];?>/tianyi/lvzhou.php\n
━━━━━━━━━\n
Tips:<?php echo $ming; ?>API技术支持

绿洲无水印解析 .*
$访问 http://<?php echo $_SERVER['HTTP_HOST'];?>/api/lvzhou.php?url=%参数1%$</per>
</div>
</div>
</div>
</div>
