...
<?php @$tj = intval(file_get_contents("../api/tongji/jiekou/tj.dat")); ?>
<?php @$tjx = intval(file_get_contents("../api/tongji/jinri/".date("Y-m-d")."/tj.dat")); ?>
...
<title>次数统计 - <?php echo $ming; ?>API</title>
...
<legend>次数统计API</legend>
</fieldset>
<blockquote class="layui-elem-quote">本接口总调用：<?php echo $tj; ?>次·今日调用：<?php echo $tjx; ?>次</blockquote>
</div>
...
<span class="url" data-clipboard-text="http://<?php echo $_SERVER['HTTP_HOST'];?>/api/tj.php">http://<?php echo $_SERVER['HTTP_HOST'];?>/api/tj.php</span>
</p>
<p class="simpleTable">
...
<span class="url" data-clipboard-text="http://<?php echo $_SERVER['HTTP_HOST'];?>/api/tj.php?name=吉云&a=0">http://<?php echo $_SERVER['HTTP_HOST'];?>/api/tj.php?name=吉云&a=0</span>
</p>
...
<tbody>
<tr><td>name</td><td>是</td><td>标题名称</td></tr>
<tr><td>a</td><td>是</td><td>0为添加标签|1为写入|2为查看</td></tr>
...
$result = file_get_contents("http://".$_SERVER['HTTP_HOST']."/api/tj.php?name=吉云&a=0");
echo $result;
?></pre>
</div>
...
<pre class="layui-code"><a style="color:#fd4b5c;text-decoration:none；" target="_blank">次数统计
<?php echo $ming; ?>API次数统计\n
━━━━━━━━━\n
用户:@%昵称%\n
━━━━━━━━━\n
添加标题 [内容]\n
...
添加标题 .*
$访问 http://<?php echo $_SERVER['HTTP_HOST'];?>/api/tj.php?name=%参数1%&a=0$

写入 .*
$访问 http://<?php echo $_SERVER['HTTP_HOST'];?>/api/tj.php?name=%参数1%&a=1$

查看 .*
$访问 http://<?php echo $_SERVER['HTTP_HOST'];?>/api/tj.php?name=%参数1%&a=2$</per>
</div>
</div>
</div>
</div>
