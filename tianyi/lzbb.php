...
<?php @$lzbb = intval(file_get_contents("../api/tongji/jiekou/lzbb.dat")); ?>
<?php @$lzbbx = intval(file_get_contents("../api/tongji/jinri/".date("Y-m-d")."/lzbb.dat")); ?>
...
<title>楼字表白 - <?php echo $ming; ?>API</title>
...
<legend>楼字表白API</legend>
</fieldset>
<blockquote class="layui-elem-quote">本接口总调用：<?php echo $lzbb; ?>次·今日调用：<?php echo $lzbbx; ?>次</blockquote>
</div>
...
<span class="url" data-clipboard-text="http://<?php echo $_SERVER['HTTP_HOST'];?>/api/lzbb.php">http://<?php echo $_SERVER['HTTP_HOST'];?>/api/lzbb.php</span>
</p>
<p class="simpleTable">
...
<span class="url" data-clipboard-text="http://<?php echo $_SERVER['HTTP_HOST'];?>/api/lzbb.php?id=1&msg=吉云">http://<?php echo $_SERVER['HTTP_HOST'];?>/api/lzbb.php?id=1&msg=吉云</span>
</p>
...
<tbody>
<tr><td>id</td><td>是</td><td>输(1-3)</td></tr>
...
<pre class="layui-code"><img src="../api/lzbb.php?id=1&msg=吉云" style="width: 45%;"></pre>
</div>
...
<pre class="layui-code"><a style="color:#fd4b5c;text-decoration:none；" target="_blank">楼字表白
<?php echo $ming; ?>API楼字表白\n
━━━━━━━━━\n
用户:@%昵称%\n
━━━━━━━━━\n
楼字表白 [数字(1-3)] [内容]\n
━━━━━━━━━\n
请求示例：http://<?php echo $_SERVER['HTTP_HOST'];?>/tianyi/lzbb.php\n
━━━━━━━━━\n
...
用户:@%昵称%\n
━━━━━━━━━\n
±img=http://<?php echo $_SERVER['HTTP_HOST'];?>/api/lzbb.php?id=%参数1%&msg=%参数2%±\n
━━━━━━━━━\n
