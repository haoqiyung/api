...
<?php @$zydsp = intval(file_get_contents("../api/tongji/jiekou/zydsp.dat")); ?>
<?php @$zydspx = intval(file_get_contents("../api/tongji/jinri/".date("Y-m-d")."/zydsp.dat")); ?>
...
<title>最右短视频 - <?php echo $ming; ?>API</title>
...
<legend>最右短视频API</legend>
</fieldset>
<blockquote class="layui-elem-quote">本接口总调用：<?php echo $zydsp; ?>次·今日调用：<?php echo $zydspx; ?>次</blockquote>
</div>
...
<span class="url" data-clipboard-text="http://<?php echo $_SERVER['HTTP_HOST'];?>/api/zydsp.php">http://<?php echo $_SERVER['HTTP_HOST'];?>/api/zydsp.php</span>
</p>
<p class="simpleTable">
...
<tbody>
<tr><td>type</td><td>否</td><td>输出方式(text/xml/json)(默认text)</td></tr>
</tbody>
</table>
...
$result = file_get_contents("http://".$_SERVER['HTTP_HOST']."/api/zydsp.php");
echo $result;
?></pre>
</div>
...
<pre class="layui-code"><a style="color:#fd4b5c;text-decoration:none；" target="_blank">最右短视频
<?php echo $ming; ?>API最右短视频\n
━━━━━━━━━\n
用户:@%昵称%\n
━━━━━━━━━\n
$访问 http://<?php echo $_SERVER['HTTP_HOST'];?>/api/zydsp.php$\n
━━━━━━━━━\n
请求示例：http://<?php echo $_SERVER['HTTP_HOST'];?>/tianyi/zydsp.php\n
━━━━━━━━━\n
