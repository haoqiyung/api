...
<?php @$kuaishou = intval(file_get_contents("../api/tongji/jiekou/kuaishou.dat")); ?>
<?php @$kuaishoux = intval(file_get_contents("../api/tongji/jinri/".date("Y-m-d")."/kuaishou.dat")); ?>
...
<title>快手短视频 - <?php echo $ming; ?>API</title>
<meta name="keywords" content=""/>
<meta name="description" content="">    
<link rel="stylesheet" href="./assets/css/layer.css">
<script src="https://ku.oioweb.cn/LayUI/2.5.4/layui.all.js"></script>
<style>.url{word-break:break-all;cursor:pointer;margin-left:5px;color:#777;border:none;border-radius:0;border-bottom:2px solid #5FB878;}.simpleTable{line-height:20px;padding-bottom:16px;}.linep{font-size:14px;font-weight:700;color:#555;padding-left:14px;height:16px;line-height:16px;margin-bottom:18px;position:relative;margin-top:15px;}.linep:before{content:'';width:4px;height:16px;background:#00aeff;border-radius:2px;position:absolute;left:0;top:0;}::-wekuaishouit-scrollbar{width:9px;height:9px}::-wekuaishouit-scrollbar-track-piece{background-color:#ebebeb;-wekuaishouit-border-radius:4px}::-wekuaishouit-scrollbar-thumb:vertical{height:32px;background-color:#ccc;-wekuaishouit-border-radius:4px}::-wekuaishouit-scrollbar-thumb:horizontal{width:32px;background-color:#ccc;-wekuaishouit-border-radius:4px}</style>
</head>
<body>
<div class="layui-container">
<div class="layui-row">
<fieldset class="layui-elem-field layui-field-title" style="margin-top: 20px;">
<legend>快手短视频API</legend>
</fieldset>
<blockquote class="layui-elem-quote">本接口总调用：<?php echo $kuaishou; ?>次·今日调用：<?php echo $kuaishoux; ?>次</blockquote>
</div>
...
<span class="url" data-clipboard-text="http://<?php echo $_SERVER['HTTP_HOST'];?>/api/kuaishou.php">http://<?php echo $_SERVER['HTTP_HOST'];?>/api/kuaishou.php</span>
</p>
<p class="simpleTable">
...
$result = file_get_contents("http://".$_SERVER['HTTP_HOST']."/api/kuaishou.php");
echo $result;
?></pre>
</div>
...
<pre class="layui-code"><a style="color:#fd4b5c;text-decoration:none；" target="_blank">快手短视频
$访问 http://<?php echo $_SERVER['HTTP_HOST'];?>/api/kuaishou.php$</per>
</div>
</div>
</div>
</div>
