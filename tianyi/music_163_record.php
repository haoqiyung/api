...
<?php @$music_163_record = intval(file_get_contents("../api/tongji/jiekou/music_163_record.dat")); ?>
<?php @$music_163_recordx = intval(file_get_contents("../api/tongji/jinri/".date("Y-m-d")."/music_163_record.dat")); ?>
...
<title>网易云听歌记录 - <?php echo $ming; ?>API</title>
<meta name="keywords" content=""/>
<meta name="description" content="">    
<link rel="stylesheet" href="./assets/css/layer.css">
<script src="https://ku.oioweb.cn/LayUI/2.5.4/layui.all.js"></script>
<style>.url{word-break:break-all;cursor:pointer;margin-left:5px;color:#777;border:none;border-radius:0;border-bottom:2px solid #5FB878;}.simpleTable{line-height:20px;padding-bottom:16px;}.linep{font-size:14px;font-weight:700;color:#555;padding-left:14px;height:16px;line-height:16px;margin-bottom:18px;position:relative;margin-top:15px;}.linep:before{content:'';width:4px;height:16px;background:#00aeff;border-radius:2px;position:absolute;left:0;top:0;}::-wemusic_163_recordit-scrollbar{width:9px;height:9px}::-wemusic_163_recordit-scrollbar-track-piece{background-color:#ebebeb;-wemusic_163_recordit-border-radius:4px}::-wemusic_163_recordit-scrollbar-thumb:vertical{height:32px;background-color:#ccc;-wemusic_163_recordit-border-radius:4px}::-wemusic_163_recordit-scrollbar-thumb:horizontal{width:32px;background-color:#ccc;-wemusic_163_recordit-border-radius:4px}</style>
</head>
<body>
<div class="layui-container">
<div class="layui-row">
<fieldset class="layui-elem-field layui-field-title" style="margin-top: 20px;">
<legend>网易云听歌记录API</legend>
</fieldset>
<blockquote class="layui-elem-quote">本接口总调用：<?php echo $music_163_record; ?>次·今日调用：<?php echo $music_163_recordx; ?>次</blockquote>
</div>
...
<span class="url" data-clipboard-text="http://<?php echo $_SERVER['HTTP_HOST'];?>/api/music_163_record.php">http://<?php echo $_SERVER['HTTP_HOST'];?>/api/music_163_record.php</span>
</p>
<p class="simpleTable">
...
<span class="url" data-clipboard-text="http://<?php echo $_SERVER['HTTP_HOST'];?>/api/music_163_record.php?UserId=1529412369&t=week">http://<?php echo $_SERVER['HTTP_HOST'];?>/api/music_163_record.php?UserId=1529412369&t=week</span>
</p>
...
<tbody>
<tr><td>UserId</td><td>是</td><td>网易云音乐用户ID</td></tr>
<tr><td>t</td><td>否</td><td>听歌排行榜时间段<br/>all：全部<br/>week：最近一周<br/>默认：all</td></tr>
...
$result = file_get_contents("http://".$_SERVER['HTTP_HOST']."/api/music_163_record.php?UserId=1529412369&t=week");
echo $result;
?></pre>
</div>
