...
<?php @$laji = intval(file_get_contents("../api/tongji/jiekou/laji.dat")); ?>
<?php @$lajix = intval(file_get_contents("../api/tongji/jinri/".date("Y-m-d")."/laji.dat")); ?>
...
<title>垃圾分类 - <?php echo $ming; ?>API</title>
...
<legend>垃圾分类API</legend>
</fieldset>
<blockquote class="layui-elem-quote">本接口总调用：<?php echo $laji; ?>次·今日调用：<?php echo $lajix; ?>次</blockquote>
</div>
...
<span class="url" data-clipboard-text="http://<?php echo $_SERVER['HTTP_HOST'];?>/api/laji.php">http://<?php echo $_SERVER['HTTP_HOST'];?>/api/laji.php</span>
</p>
<p class="simpleTable">
...
<span class="url" data-clipboard-text="http://<?php echo $_SERVER['HTTP_HOST'];?>/api/laji.php?msg=袋">http://<?php echo $_SERVER['HTTP_HOST'];?>/api/laji.php?msg=袋</span>
</p>
...
<tbody>
<tr><td>msg</td><td>是</td><td>需要查询的垃圾名</td></tr>
...
$result = file_get_contents("http://".$_SERVER['HTTP_HOST']."/api/laji.php?msg=袋");
echo $result;
?></pre>
</div>
...
<pre class="layui-code"><a style="color:#fd4b5c;text-decoration:none；" target="_blank">垃圾分类
<?php echo $ming; ?>API垃圾分类\n
━━━━━━━━━\n
用户:@%昵称%\n
━━━━━━━━━\n
垃圾分类 [内容]\n
━━━━━━━━━\n
请求示例：http://<?php echo $_SERVER['HTTP_HOST'];?>/tianyi/laji.php\n
━━━━━━━━━\n
...
用户:@%昵称%\n
━━━━━━━━━\n
$访问 http://<?php echo $_SERVER['HTTP_HOST'];?>/api/laji.php?msg=%参数1%$\n
━━━━━━━━━\n
