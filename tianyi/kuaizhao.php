...
<?php @$kuaizhao = intval(file_get_contents("../api/tongji/jiekou/kuaizhao.dat")); ?>
<?php @$kuaizhaox = intval(file_get_contents("../api/tongji/jinri/".date("Y-m-d")."/kuaizhao.dat")); ?>
...
<title>网站快照 - <?php echo $ming; ?>API</title>
...
<legend>网站快照API</legend>
</fieldset>
<blockquote class="layui-elem-quote">本接口总调用：<?php echo $kuaizhao; ?>次·今日调用：<?php echo $kuaizhaox; ?>次</blockquote>
</div>
...
<span class="url" data-clipboard-text="http://<?php echo $_SERVER['HTTP_HOST'];?>/api/kuaizhao.php">http://<?php echo $_SERVER['HTTP_HOST'];?>/api/kuaizhao.php</span>
</p>
<p class="simpleTable">
...
<span class="url" data-clipboard-text="http://<?php echo $_SERVER['HTTP_HOST'];?>/api/kuaizhao.php?url=https://cloud.vpsidc.com.cn">http://<?php echo $_SERVER['HTTP_HOST'];?>/api/kuaizhao.php?url=https://cloud.vpsidc.com.cn</span>
</p>
...
<tbody>
<tr><td>url</td><td>是</td><td>需要快照的链接</td></tr>
</tbody>
</table>
...
<pre class="layui-code"><img src="../api/kuaizhao.php?url=https://cloud.vpsidc.com.cn" style="width: 45%;"></pre>
</div>
...
<pre class="layui-code"><a style="color:#fd4b5c;text-decoration:none；" target="_blank">网站快照
<?php echo $ming; ?>API网站快照\n
━━━━━━━━━\n
用户:@%昵称%\n
━━━━━━━━━\n
网站快照 [链接]\n
━━━━━━━━━\n
请求示例：http://<?php echo $_SERVER['HTTP_HOST'];?>/tianyi/kuaizhao.php\n
━━━━━━━━━\n
...
用户:@%昵称%\n
━━━━━━━━━\n
±img=http://<?php echo $_SERVER['HTTP_HOST'];?>/api/kuaizhao.php?url=%参数1%±\n
━━━━━━━━━\n
