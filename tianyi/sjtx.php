...
<?php @$sjtx = intval(file_get_contents("../api/tongji/jiekou/sjtx.dat")); ?>
<?php @$sjtxx = intval(file_get_contents("../api/tongji/jinri/".date("Y-m-d")."/sjtx.dat")); ?>
...
<blockquote class="layui-elem-quote">本接口总调用：<?php echo $sjtx; ?>次·今日调用：<?php echo $sjtxx; ?>次</blockquote>
</div>
...
<span class="url" data-clipboard-text="http://<?php echo $_SERVER['HTTP_HOST'];?>/api/sjtx.php">http://<?php echo $_SERVER['HTTP_HOST'];?>/api/sjtx.php</span>
</p>
<p class="simpleTable">
...
<span class="url" data-clipboard-text="http://<?php echo $_SERVER['HTTP_HOST'];?>/api/sjtx.php?lx=a1">http://<?php echo $_SERVER['HTTP_HOST'];?>/api/sjtx.php?lx=a1</span>
</p>
...
<tbody>
<tr><td>lx</td><td>是</td><td>输【1.男头：a1 2.女头：b1 3.动漫：c1 4.动漫女头：c2 5.动漫男头：c3】</td></tr>
</tbody>
</table>
...
<pre class="layui-code"><img src="../api/sjtx.php?lx=a1" style="width: 45%;"></pre>
</div>
