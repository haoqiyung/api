...
<title>随机头像 - <?php echo $ming; ?>API</title>
...
<span class="url" data-clipboard-text="http://<?php echo $_SERVER['HTTP_HOST'];?>/api/sjtx2.php">http://<?php echo $_SERVER['HTTP_HOST'];?>/api/sjtx2.php</span>
</p>
<p class="simpleTable">
...
<span class="url" data-clipboard-text="http://<?php echo $_SERVER['HTTP_HOST'];?>/api/sjtx2.php?type=image">http://<?php echo $_SERVER['HTTP_HOST'];?>/api/sjtx2.php?type=image</span>
</p>
...
<tbody>
<tr><td>form</td><td>String</td><td>否</td><td>头像类型默认随机头像可选女生头像/男生头像</td></tr>
<tr><td>type</td><td>String</td><td>否</td><td>默认json可选text或image</td></tr>
</tbody>
</table>
...
<tr><td>text</td><td>String</td><td>返回数据</td></tr>
</tbody>
</table>
<p class="linep">返回示例：</p>
<pre class="layui-code"><img src="../api/sjtx2.php?type=image" style="width: 45%;"></pre>
</div>
...
<tr><td>-1</td><td>获取失败</td></tr>
</tbody>
</table>
</div>
<div class="layui-tab-item">
<p class="linep">机器人词库示例：</p>
<pre class="layui-code"><a style="color:#fd4b5c;text-decoration:none；" target="_blank">随机头像
<?php echo $ming; ?>API随机头像\n
━━━━━━━━━\n
用户:@%昵称%\n
━━━━━━━━━\n
男生头像\n
女生头像\n
━━━━━━━━━\n
请求示例：http://<?php echo $_SERVER['HTTP_HOST'];?>/tianyi/sjtx2.php\n
━━━━━━━━━\n
...
用户:@%昵称%\n
━━━━━━━━━\n
±img=$访问 http://<?php echo $_SERVER['HTTP_HOST'];?>/api/sjtx2.php?form=%括号1%头像&type=text$±\n
━━━━━━━━━\n
