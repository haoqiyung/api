...
<?php @$bz = intval(file_get_contents("../api/tongji/jiekou/bz.dat")); ?>
<?php @$bzx = intval(file_get_contents("../api/tongji/jinri/".date("Y-m-d")."/bz.dat")); ?>
...
<title>扒站 - <?php echo $ming; ?>API</title>
...
<blockquote class="layui-elem-quote">本接口总调用：<?php echo $bz; ?>次·今日调用：<?php echo $bzx; ?>次</blockquote>
</div>
...
<span class="url" data-clipboard-text="http://<?php echo $_SERVER['HTTP_HOST'];?>/api/bz.php">http://<?php echo $_SERVER['HTTP_HOST'];?>/api/bz.php</span>
</p>
<p class="simpleTable">
...
<span class="url" data-clipboard-text="http://<?php echo $_SERVER['HTTP_HOST'];?>/api/bz.php?url=http://baidu.com">http://<?php echo $_SERVER['HTTP_HOST'];?>/api/bz.php?url=http://baidu.com</span>
</p>
...
<tbody>
<tr><td>url</td><td>是</td><td>需要扒站的链接</td></tr>
</tbody>
</table>
...
$result = file_get_contents("http://".$_SERVER['HTTP_HOST']."/api/bz.php?url=http://baidu.com");
echo $result;
?></pre>
</div>
...
<tr><td>1001</td><td>请输入网站域名！</td></tr>
<tr><td>1002</td><td>请输入有效的网站地址！</td></tr>
<tr><td>1003</td><td>扒站失败！</td></tr>
</tbody>
</table>
</div>
<div class="layui-tab-item">
