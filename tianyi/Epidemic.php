...
<?php @$Epidemic = intval(file_get_contents("../api/tongji/jiekou/Epidemic.dat")); ?>
<?php @$Epidemicx = intval(file_get_contents("../api/tongji/jinri/".date("Y-m-d")."/Epidemic.dat")); ?>
...
<title>国外疫情查询 - <?php echo $ming; ?>API</title>
<meta name="keywords" content=""/>
<meta name="description" content="">    
<link rel="stylesheet" href="./assets/css/layer.css">
<script src="https://ku.oioweb.cn/LayUI/2.5.4/layui.all.js"></script>
<style>.url{word-break:break-all;cursor:pointer;margin-left:5px;color:#777;border:none;border-radius:0;border-bottom:2px solid #5FB878;}.simpleTable{line-height:20px;padding-bottom:16px;}.linep{font-size:14px;font-weight:700;color:#555;padding-left:14px;height:16px;line-height:16px;margin-bottom:18px;position:relative;margin-top:15px;}.linep:before{content:'';width:4px;height:16px;background:#00aeff;border-radius:2px;position:absolute;left:0;top:0;}::-weEpidemicit-scrollbar{width:9px;height:9px}::-weEpidemicit-scrollbar-track-piece{background-color:#ebebeb;-weEpidemicit-border-radius:4px}::-weEpidemicit-scrollbar-thumb:vertical{height:32px;background-color:#ccc;-weEpidemicit-border-radius:4px}::-weEpidemicit-scrollbar-thumb:horizontal{width:32px;background-color:#ccc;-weEpidemicit-border-radius:4px}</style>
</head>
<body>
<div class="layui-container">
<div class="layui-row">
<fieldset class="layui-elem-field layui-field-title" style="margin-top: 20px;">
<legend>国外疫情查询API</legend>
</fieldset>
<blockquote class="layui-elem-quote">本接口总调用：<?php echo $Epidemic; ?>次·今日调用：<?php echo $Epidemicx; ?>次</blockquote>
</div>
...
<span class="url" data-clipboard-text="http://<?php echo $_SERVER['HTTP_HOST'];?>/api/Epidemic.php">http://<?php echo $_SERVER['HTTP_HOST'];?>/api/Epidemic.php</span>
</p>
<p class="simpleTable">
...
<span class="url" data-clipboard-text="http://<?php echo $_SERVER['HTTP_HOST'];?>/api/Epidemic.php?country=美国">http://<?php echo $_SERVER['HTTP_HOST'];?>/api/Epidemic.php?country=美国</span>
</p>
...
<tbody>
<tr><td>country</td><td>是</td><td>需要查询的地区(必须是国外)</td></tr>
</tbody>
</table>
...
$result = file_get_contents("http://".$_SERVER['HTTP_HOST']."/api/Epidemic.php?country=美国");
echo $result;
?></pre>
</div>
...
<tr><td>1001</td><td>请输入需要查询的国外国家名称</td></tr>
<tr><td>1002</td><td>疫情查询失败!</td></tr>
<tr><td>1003</td><td>请输入正确的国外国家名称!</td></tr>
</tbody>
</table>
</div>
<div class="layui-tab-item">
