...
<?php @$qrcode = intval(file_get_contents("../api/tongji/jiekou/qrcode.dat")); ?>
<?php @$qrcodex = intval(file_get_contents("../api/tongji/jinri/".date("Y-m-d")."/qrcode.dat")); ?>
...
<title>二维码生成 - <?php echo $ming; ?>API</title>
...
<legend>二维码生成API</legend>
</fieldset>
<blockquote class="layui-elem-quote">本接口总调用：<?php echo $qrcode; ?>次·今日调用：<?php echo $qrcodex; ?>次</blockquote>
</div>
...
<span class="url" data-clipboard-text="http://<?php echo $_SERVER['HTTP_HOST'];?>/api/qrcode.php">http://<?php echo $_SERVER['HTTP_HOST'];?>/api/qrcode.php</span>
</p>
<p class="simpleTable">
...
<span class="url" data-clipboard-text="http://<?php echo $_SERVER['HTTP_HOST'];?>/api/qrcode.php?text=吉云&size=180">http://<?php echo $_SERVER['HTTP_HOST'];?>/api/qrcode.php?text=吉云&size=180</span>
</p>
...
<tbody>
<tr><td>text</td><td>是</td><td>二维码内容</td></tr>
<tr><td>size</td><td>是</td><td>二维码大小</td></tr>
</tbody>
</table>
...
<pre class="layui-code"><img src="../api/qrcode.php?text=吉云&size=180" style="width: 45%;"></pre>
</div>
...
<pre class="layui-code"><a style="color:#fd4b5c;text-decoration:none；" target="_blank">二维码生成
<?php echo $ming; ?>API二维码生成\n
━━━━━━━━━\n
用户:@%昵称%\n
━━━━━━━━━\n
二维码生成 [内容] [大小]\n
━━━━━━━━━\n
请求示例：http://<?php echo $_SERVER['HTTP_HOST'];?>/tianyi/qrcode.php\n
━━━━━━━━━\n
...
用户:@%昵称%\n
━━━━━━━━━\n
±img=http://<?php echo $_SERVER['HTTP_HOST'];?>/api/qrcode.php?text=%参数1%&size=%参数2%±\n
━━━━━━━━━\n
