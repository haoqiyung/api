...
<?php @$bbq = intval(file_get_contents("../api/tongji/jiekou/bbq.dat")); ?>
<?php @$bbqx = intval(file_get_contents("../api/tongji/jinri/".date("Y-m-d")."/bbq.dat")); ?>
...
<title>轻视频无水印解析 - <?php echo $ming; ?>API</title>
...
<legend>轻视频无水印解析API</legend>
</fieldset>
<blockquote class="layui-elem-quote">本接口总调用：<?php echo $bbq; ?>次·今日调用：<?php echo $bbqx; ?>次</blockquote>
</div>
...
<span class="url" data-clipboard-text="http://<?php echo $_SERVER['HTTP_HOST'];?>/api/bbq.php">http://<?php echo $_SERVER['HTTP_HOST'];?>/api/bbq.php</span>
</p>
<p class="simpleTable">
...
<span class="url" data-clipboard-text="http://<?php echo $_SERVER['HTTP_HOST'];?>/api/bbq.php?url=https://bbq.bilibili.com/video/?id=1593006116082649828">http://<?php echo $_SERVER['HTTP_HOST'];?>/api/bbq.php?url=https://bbq.bilibili.com/video/?id=1593006116082649828</span>
</p>
...
$result = file_get_contents("http://".$_SERVER['HTTP_HOST']."/api/bbq.php?url=https://bbq.bilibili.com/video/?id=1593006116082649828");
echo $result;
?></pre>
</div>
...
<pre class="layui-code"><a style="color:#fd4b5c;text-decoration:none；" target="_blank">轻视频无水印解析
<?php echo $ming; ?>API轻视频无水印解析\n
━━━━━━━━━\n
用户:@%昵称%\n
━━━━━━━━━\n
轻视频无水印解析 [网址]\n
━━━━━━━━━\n
请求示例：http://<?php echo $_SERVER['HTTP_HOST'];?>/tianyi/bbq.php\n
━━━━━━━━━\n
Tips:<?php echo $ming; ?>API技术支持

轻视频无水印解析 .*
$访问 http://<?php echo $_SERVER['HTTP_HOST'];?>/api/bbq.php?url=%参数1%$</per>
</div>
</div>
</div>
</div>
