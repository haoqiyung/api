...
<?php @$qmjc2 = intval(file_get_contents("../api/tongji/jiekou/qmjc2.dat")); ?>
<?php @$qmjc2x = intval(file_get_contents("../api/tongji/jinri/".date("Y-m-d")."/qmjc2.dat")); ?>
...
<blockquote class="layui-elem-quote">本接口总调用：<?php echo $qmjc2; ?>次·今日调用：<?php echo $qmjc2x; ?>次</blockquote>
</div>
...
<span class="url" data-clipboard-text="http://<?php echo $_SERVER['HTTP_HOST'];?>/api/qmjc2.php">http://<?php echo $_SERVER['HTTP_HOST'];?>/api/qmjc2.php</span>
</p>
<p class="simpleTable">
...
<span class="url" data-clipboard-text="http://<?php echo $_SERVER['HTTP_HOST'];?>/api/qmjc2.php?url=https://cloud.vpsidc.com.cn">http://<?php echo $_SERVER['HTTP_HOST'];?>/api/qmjc2.php?url=https://cloud.vpsidc.com.cn</span>
</p>
...
<tr><td>url</td><td>域名</td></tr>
<tr><td>type</td><td>域名状态</td></tr>
</tbody>
</table>
<p class="linep">返回示例：</p>
<pre class="layui-code"><?php
//header("Content-Type:text/html;charset=UTF-8");
$result = file_get_contents("http://".$_SERVER['HTTP_HOST']."/api/qmjc2.php?url=https://cloud.vpsidc.com.cn");
echo $result;
?></pre>
</div>
