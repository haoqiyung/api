...
<?php @$wp = intval(file_get_contents("../api/tongji/jiekou/wp.dat")); ?>
<?php @$wpx = intval(file_get_contents("../api/tongji/jinri/".date("Y-m-d")."/wp.dat")); ?>
...
<title>新浪随机图片 - <?php echo $ming; ?>API</title>
...
<legend>新浪随机图片API</legend>
</fieldset>
<blockquote class="layui-elem-quote">本接口总调用：<?php echo $wp; ?>次·今日调用：<?php echo $wpx; ?>次</blockquote>
</div>
...
<span class="url" data-clipboard-text="http://<?php echo $_SERVER['HTTP_HOST'];?>/api/wp.php">http://<?php echo $_SERVER['HTTP_HOST'];?>/api/wp.php</span>
</p>
<p class="simpleTable">
...
<pre class="layui-code"><img src="../api/wp.php" style="width: 45%;"></pre>
</div>
...
<pre class="layui-code"><a style="color:#fd4b5c;text-decoration:none；" target="_blank">新浪随机图片
<?php echo $ming; ?>API新浪随机图片\n
━━━━━━━━━\n
用户:@%昵称%\n
━━━━━━━━━\n
±img=http://<?php echo $_SERVER['HTTP_HOST'];?>/api/wp.php±\n
━━━━━━━━━\n
请求示例：http://<?php echo $_SERVER['HTTP_HOST'];?>/tianyi/wp.php\n
━━━━━━━━━\n
