...
<?php @$xiangua = intval(file_get_contents("../api/tongji/jiekou/xiangua.dat")); ?>
<?php @$xianguax = intval(file_get_contents("../api/tongji/jinri/".date("Y-m-d")."/xiangua.dat")); ?>
...
<title>随机笑话 - <?php echo $ming; ?>API</title>
...
<legend>随机笑话API</legend>
</fieldset>
<blockquote class="layui-elem-quote">本接口总调用：<?php echo $xiangua; ?>次·今日调用：<?php echo $xianguax; ?>次</blockquote>
</div>
...
<span class="url" data-clipboard-text="http://<?php echo $_SERVER['HTTP_HOST'];?>/api/xiangua.php">http://<?php echo $_SERVER['HTTP_HOST'];?>/api/xiangua.php</span>
</p>
<p class="simpleTable">
...
$result = file_get_contents("http://".$_SERVER['HTTP_HOST']."/api/xiangua.php");
echo $result;
?></pre>
</div>
...
<pre class="layui-code"><a style="color:#fd4b5c;text-decoration:none；" target="_blank">随机笑话
$访问 http://<?php echo $_SERVER['HTTP_HOST'];?>/api/xiangua.php$</per>
</div>
</div>
</div>
</div>
