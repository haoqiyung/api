...
<?php @$dxdy = intval(file_get_contents("../api/tongji/jiekou/dxdy.dat")); ?>
<?php @$dxdyx = intval(file_get_contents("../api/tongji/jinri/".date("Y-m-d")."/dxdy.dat")); ?>
...
<title>腾讯视频 - <?php echo $ming; ?>API</title>
...
<legend>腾讯视频API</legend>
</fieldset>
<blockquote class="layui-elem-quote">本接口总调用：<?php echo $dxdy; ?>次·今日调用：<?php echo $dxdyx; ?>次</blockquote>
</div>
...
<span class="url" data-clipboard-text="http://<?php echo $_SERVER['HTTP_HOST'];?>/api/dxdy.php">http://<?php echo $_SERVER['HTTP_HOST'];?>/api/dxdy.php</span>
</p>
<p class="simpleTable">
...
<span class="url" data-clipboard-text="http://<?php echo $_SERVER['HTTP_HOST'];?>/api/dxdy.php?msg=海绵宝宝&b=1">http://<?php echo $_SERVER['HTTP_HOST'];?>/api/dxdy.php?msg=海绵宝宝&b=1</span>
</p>
...
<tbody>
<tr><td>msg</td><td>是</td><td>需要搜索的内容</td></tr>
...
$result = file_get_contents("http://".$_SERVER['HTTP_HOST']."/api/dxdy.php?msg=海绵宝宝&b=1");
echo $result;
?></pre>
</div>
...
<pre class="layui-code"><a style="color:#fd4b5c;text-decoration:none；" target="_blank">腾讯视频
<?php echo $ming; ?>API腾讯视频\n
━━━━━━━━━\n
用户:@%昵称%\n
━━━━━━━━━\n
腾讯视频 [内容]\n
━━━━━━━━━\n
请求示例：http://<?php echo $_SERVER['HTTP_HOST'];?>/tianyi/dxdy.php\n
━━━━━━━━━\n
Tips:<?php echo $ming; ?>API技术支持

腾讯视频 .*
$写 <?php echo $ming; ?>API/%群号%/%QQ% 腾讯视频 %参数1%$
<?php echo $ming; ?>API腾讯视频\n
━━━━━━━━━\n
用户:@%昵称%\n
━━━━━━━━━\n
$访问 http://<?php echo $_SERVER['HTTP_HOST'];?>/api/dxdy.php?msg=%参数1%$\n
━━━━━━━━━\n
Tips:<?php echo $ming; ?>API技术支持

选腾讯视频 .*
e:$读 <?php echo $ming; ?>API/%群号%/%QQ% 腾讯视频 %参数1%$
<?php echo $ming; ?>API腾讯视频\n
━━━━━━━━━\n
用户:@%昵称%\n
━━━━━━━━━\n
$访问 http://<?php echo $_SERVER['HTTP_HOST'];?>/api/dxdy.php?msg=%e%&b=%参数1%$\n
━━━━━━━━━\n
