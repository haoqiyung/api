...
<?php @$ccc = intval(file_get_contents("../api/tongji/jiekou/360bz.dat")); ?>
<?php @$cccx = intval(file_get_contents("../api/tongji/jinri/".date("Y-m-d")."/360bz.dat")); ?>
...
<title>360壁纸 - <?php echo $ming; ?>API</title>
...
<legend>360壁纸API</legend>
</fieldset>
<blockquote class="layui-elem-quote">本接口总调用：<?php echo $ccc; ?>次·今日调用：<?php echo $cccx; ?>次</blockquote>
</div>
...
<span class="url" data-clipboard-text="http://<?php echo $_SERVER['HTTP_HOST'];?>/api/360bz.php">http://<?php echo $_SERVER['HTTP_HOST'];?>/api/360bz.php</span>
</p>
<p class="simpleTable">
...
$result = file_get_contents("http://".$_SERVER['HTTP_HOST']."/api/360bz.php");
echo $result;
?></pre>
</div>
...
<pre class="layui-code"><a style="color:#fd4b5c;text-decoration:none；" target="_blank">360壁纸
$访问 http://<?php echo $_SERVER['HTTP_HOST'];?>/api/360bz.php$</per>
</div>
</div>
</div>
</div>
