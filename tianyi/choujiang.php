...
<?php @$choujiang = intval(file_get_contents("../api/tongji/jiekou/choujiang.dat")); ?>
<?php @$choujiangx = intval(file_get_contents("../api/tongji/jinri/".date("Y-m-d")."/choujiang.dat")); ?>
...
<title>抽奖 - <?php echo $ming; ?>API</title>
<meta name="keywords" content=""/>
<meta name="description" content="">    
<link rel="stylesheet" href="./assets/css/layer.css">
<script src="https://ku.oioweb.cn/LayUI/2.5.4/layui.all.js"></script>
<style>.url{word-break:break-all;cursor:pointer;margin-left:5px;color:#777;border:none;border-radius:0;border-bottom:2px solid #5FB878;}.simpleTable{line-height:20px;padding-bottom:16px;}.linep{font-size:14px;font-weight:700;color:#555;padding-left:14px;height:16px;line-height:16px;margin-bottom:18px;position:relative;margin-top:15px;}.linep:before{content:'';width:4px;height:16px;background:#00aeff;border-radius:2px;position:absolute;left:0;top:0;}::-wechoujiangit-scrollbar{width:9px;height:9px}::-wechoujiangit-scrollbar-track-piece{background-color:#ebebeb;-wechoujiangit-border-radius:4px}::-wechoujiangit-scrollbar-thumb:vertical{height:32px;background-color:#ccc;-wechoujiangit-border-radius:4px}::-wechoujiangit-scrollbar-thumb:horizontal{width:32px;background-color:#ccc;-wechoujiangit-border-radius:4px}</style>
</head>
<body>
...
<blockquote class="layui-elem-quote">本接口总调用：<?php echo $choujiang; ?>次·今日调用：<?php echo $choujiangx; ?>次</blockquote>
</div>
...
<span class="url" data-clipboard-text="http://<?php echo $_SERVER['HTTP_HOST'];?>/api/choujiang.php">http://<?php echo $_SERVER['HTTP_HOST'];?>/api/choujiang.php</span>
</p>
<p class="simpleTable">
...
<span class="url" data-clipboard-text="http://<?php echo $_SERVER['HTTP_HOST'];?>/api/choujiang.php?a=天一&b=星猫&c=小二">http://<?php echo $_SERVER['HTTP_HOST'];?>/api/choujiang.php?a=天一&b=星猫c=小二</span>
</p>
...
<tbody>
<tr><td>a</td><td>是</td><td>输奖品1名字</td></tr>
<tr><td>b</td><td>是</td><td>输奖品2名字</td></tr>
<tr><td>c</td><td>是</td><td>输奖品3名字</td></tr>
...
$result = file_get_contents("http://".$_SERVER['HTTP_HOST']."/api/choujiang.php?a=天一&b=星猫&c=小二");
echo $result;
?></pre>
</div>
