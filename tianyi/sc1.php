...
<?php @$sc1 = intval(file_get_contents("../api/tongji/jiekou/sc1.dat")); ?>
<?php @$sc1x = intval(file_get_contents("../api/tongji/jinri/".date("Y-m-d")."/sc1.dat")); ?>
...
<title>诗词 - <?php echo $ming; ?>API</title>
...
<blockquote class="layui-elem-quote">本接口总调用：<?php echo $sc1; ?>次·今日调用：<?php echo $sc1x; ?>次</blockquote>
</div>
...
<span class="url" data-clipboard-text="http://<?php echo $_SERVER['HTTP_HOST'];?>/api/sc1.php">http://<?php echo $_SERVER['HTTP_HOST'];?>/api/sc1.php</span>
</p>
<p class="simpleTable">
...
$result = file_get_contents("http://".$_SERVER['HTTP_HOST']."/api/sc1.php");
echo $result;
?></pre></div>
...
<pre class="layui-code"><a style="color:#fd4b5c;text-decoration:none；" target="_blank">诗词
$访问 http://<?php echo $_SERVER['HTTP_HOST'];?>/api/sc1.php$</per>
</div>
</div>
</div>
</div>
