...
<?php @$ico = intval(file_get_contents("../api/tongji/jiekou/ico.dat")); ?>
<?php @$icox = intval(file_get_contents("../api/tongji/jinri/".date("Y-m-d")."/ico.dat")); ?>
...
<title>ico站标获取 - <?php echo $ming; ?>API</title>
...
<legend>ico站标获取API</legend>
</fieldset>
<blockquote class="layui-elem-quote">本接口总调用：<?php echo $ico; ?>次·今日调用：<?php echo $icox; ?>次</blockquote>
</div>
...
<span class="url" data-clipboard-text="http://<?php echo $_SERVER['HTTP_HOST'];?>/api/ico.php">http://<?php echo $_SERVER['HTTP_HOST'];?>/api/ico.php</span>
</p>
<p class="simpleTable">
...
<span class="url" data-clipboard-text="http://<?php echo $_SERVER['HTTP_HOST'];?>/api/ico.php?url=https://cloud.vpsidc.com.cn">http://<?php echo $_SERVER['HTTP_HOST'];?>/api/ico.php?url=https://cloud.vpsidc.com.cn</span>
</p>
...
<tbody>
<tr><td>url</td><td>是</td><td>需要获取网站图标的链接</td></tr>
</tbody>
</table>
...
<pre class="layui-code"><img src="../api/ico.php?url=https://cloud.vpsidc.com.cn" style="width: 45%;"></pre>
</div>
...
<pre class="layui-code"><a style="color:#fd4b5c;text-decoration:none；" target="_blank">ico站标获取
<?php echo $ming; ?>API♧ico站标获取\n
━━━━━━━━━\n
用户:@%昵称%\n
━━━━━━━━━\n
ico站标获取 [链接]\n
━━━━━━━━━\n
请求示例：http://<?php echo $_SERVER['HTTP_HOST'];?>/tianyi/ico.php\n
━━━━━━━━━\n
...
用户:@%昵称%\n
━━━━━━━━━\n
±img=http://<?php echo $_SERVER['HTTP_HOST'];?>/api/ico.php±\n
━━━━━━━━━\n
Tips:<?php echo $ming; ?>API技术支持</per>
</div>
</div>
