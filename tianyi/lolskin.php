...
<?php @$lolskin = intval(file_get_contents("../api/tongji/jiekou/lolskin.dat")); ?>
<?php @$lolskinx = intval(file_get_contents("../api/tongji/jinri/".date("Y-m-d")."/lolskin.dat")); ?>
...
<title>随机LOL超清人物壁纸 - <?php echo $ming; ?>API</title>
...
<legend>随机LOL超清人物壁纸API</legend>
</fieldset>
<blockquote class="layui-elem-quote">本接口总调用：<?php echo $lolskin; ?>次·今日调用：<?php echo $lolskinx; ?>次</blockquote>
</div>
...
<span class="url" data-clipboard-text="http://<?php echo $_SERVER['HTTP_HOST'];?>/api/lolskin.php">http://<?php echo $_SERVER['HTTP_HOST'];?>/api/lolskin.php</span>
</p>
<p class="simpleTable">
...
<pre class="layui-code"><img src="../api/lolskin.php" style="width: 45%;"></pre>
</div>
...
<pre class="layui-code"><a style="color:#fd4b5c;text-decoration:none；" target="_blank">随机LOL超清人物壁纸
<?php echo $ming; ?>API随机LOL超清人物壁纸\n
━━━━━━━━━\n
用户:@%昵称%\n
━━━━━━━━━\n
±img=http://<?php echo $_SERVER['HTTP_HOST'];?>/api/lolskin.php±\n
━━━━━━━━━\n
请求示例：http://<?php echo $_SERVER['HTTP_HOST'];?>/tianyi/lolskin.php\n
━━━━━━━━━\n
