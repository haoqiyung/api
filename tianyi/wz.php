...
<?php @$wz = intval(file_get_contents("../api/tongji/jiekou/wz.dat")); ?>
<?php @$wzx = intval(file_get_contents("../api/tongji/jinri/".date("Y-m-d")."/wz.dat")); ?>
...
<title>网站描述 - <?php echo $ming; ?>API</title>
...
<legend>网站描述API</legend>
</fieldset>
<blockquote class="layui-elem-quote">本接口总调用：<?php echo $wz; ?>次·今日调用：<?php echo $wzx; ?>次</blockquote>
</div>
...
<span class="url" data-clipboard-text="http://<?php echo $_SERVER['HTTP_HOST'];?>/api/wz.php">http://<?php echo $_SERVER['HTTP_HOST'];?>/api/wz.php</span>
</p>
<p class="simpleTable">
...
<span class="url" data-clipboard-text="http://<?php echo $_SERVER['HTTP_HOST'];?>/api/wz.php?url=https://cloud.vpsidc.com.cn">http://<?php echo $_SERVER['HTTP_HOST'];?>/api/wz.php?url=https://cloud.vpsidc.com.cn</span>
</p>
...
$result = file_get_contents("http://".$_SERVER['HTTP_HOST']."/api/wz.php?url=https://cloud.vpsidc.com.cn");
echo $result;
?></pre>
</div>
...
<pre class="layui-code"><a style="color:#fd4b5c;text-decoration:none；" target="_blank">网站描述
<?php echo $ming; ?>API网站描述\n
━━━━━━━━━\n
用户:@%昵称%\n
━━━━━━━━━\n
网站描述 [链接]\n
━━━━━━━━━\n
请求示例：http://<?php echo $_SERVER['HTTP_HOST'];?>/tianyi/wz.php\n
━━━━━━━━━\n
Tips:<?php echo $ming; ?>API技术支持

网站描述 .*
$访问 http://<?php echo $_SERVER['HTTP_HOST'];?>/api/wz.php?url=%参数1%$</per>
</div>
</div>
</div>
</div>
