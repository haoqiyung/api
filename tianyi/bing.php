...
<?php @$bing = intval(file_get_contents("../api/tongji/jiekou/bing.dat")); ?>
<?php @$bingx = intval(file_get_contents("../api/tongji/jinri/".date("Y-m-d")."/bing.dat")); ?>
...
<title>Bing每日图 - <?php echo $ming; ?>API</title>
...
<legend>Bing每日图API</legend>
</fieldset>
<blockquote class="layui-elem-quote">本接口总调用：<?php echo $bing; ?>次·今日调用：<?php echo $bingx; ?>次</blockquote>
</div>
...
<span class="url" data-clipboard-text="http://<?php echo $_SERVER['HTTP_HOST'];?>/api/bing.php">http://<?php echo $_SERVER['HTTP_HOST'];?>/api/bing.php</span>
</p>
<p class="simpleTable">
...
<pre class="layui-code"><img src="../api/bing.php" style="width: 45%;"></pre>
</div>
...
<pre class="layui-code"><a style="color:#fd4b5c;text-decoration:none；" target="_blank">Bing每日图
<?php echo $ming; ?>API♧Bing每日图\n
━━━━━━━━━\n
用户:@%昵称%\n
━━━━━━━━━\n
±img=http://<?php echo $_SERVER['HTTP_HOST'];?>/api/bing.php±\n
━━━━━━━━━\n
请求示例：http://<?php echo $_SERVER['HTTP_HOST'];?>/tianyi/bing.php\n
━━━━━━━━━\n
