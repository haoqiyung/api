...
<?php @$location_geocoder_address = intval(file_get_contents("../api/tongji/jiekou/location_geocoder_address.dat")); ?>
<?php @$location_geocoder_addressx = intval(file_get_contents("../api/tongji/jinri/".date("Y-m-d")."/location_geocoder_address.dat")); ?>
...
<title>经纬度解析 - <?php echo $ming; ?>API</title>
...
<legend>经纬度解析API</legend>
</fieldset>
<blockquote class="layui-elem-quote">本接口总调用：<?php echo $location_geocoder_address; ?>次·今日调用：<?php echo $location_geocoder_addressx; ?>次</blockquote>
</div>
...
<span class="url" data-clipboard-text="http://<?php echo $_SERVER['HTTP_HOST'];?>/api/location_geocoder_address.php">http://<?php echo $_SERVER['HTTP_HOST'];?>/api/location_geocoder_address.php</span>
</p>
<p class="simpleTable">
...
<span class="url" data-clipboard-text="http://<?php echo $_SERVER['HTTP_HOST'];?>/api/location_geocoder_address.php?lng=125.18512&lat=44.43195">http://<?php echo $_SERVER['HTTP_HOST'];?>/api/location_geocoder_address.php?lng=125.18512&lat=44.43195</span>
</p>
...
<tbody>
<tr><td>lng</td><td>是</td><td>需要查询的经度</td></tr>
<tr><td>lat</td><td>是</td><td>需要查询的纬度</td></tr>
...
$result = file_get_contents("http://".$_SERVER['HTTP_HOST']."/api/location_geocoder_address.php?lng=125.18512&lat=44.43195");
echo $result;
?></pre>
</div>
...
<pre class="layui-code"><a style="color:#fd4b5c;text-decoration:none；" target="_blank">经纬度解析
<?php echo $ming; ?>API经纬度解析\n
━━━━━━━━━\n
用户:@%昵称%\n
━━━━━━━━━\n
经纬度解析 [经度] [纬度]\n
━━━━━━━━━\n
请求示例：http://<?php echo $_SERVER['HTTP_HOST'];?>/tianyi/location_geocoder_address.php\n
━━━━━━━━━\n
Tips:<?php echo $ming; ?>API技术支持

经纬度解析 .*
$访问 http://<?php echo $_SERVER['HTTP_HOST'];?>/api/location_geocoder_address.php?lng=%参数1%&lat=%参数2%$</per>
</div>
</div>
</div>
</div>
