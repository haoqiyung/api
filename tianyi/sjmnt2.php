...
<?php @$sjmnt2 = intval(file_get_contents("../api/tongji/jiekou/sjmnt2.dat")); ?>
<?php @$sjmnt2x = intval(file_get_contents("../api/tongji/jinri/".date("Y-m-d")."/sjmnt2.dat")); ?>
...
<title>妹子图(PE) - <?php echo $ming; ?>API</title>
...
<legend>妹子图(PE)API</legend>
</fieldset>
<blockquote class="layui-elem-quote">本接口总调用：<?php echo $sjmnt2; ?>次·今日调用：<?php echo $sjmnt2x; ?>次</blockquote>
</div>
...
<span class="url" data-clipboard-text="http://<?php echo $_SERVER['HTTP_HOST'];?>/api/sjmnt2.php">http://<?php echo $_SERVER['HTTP_HOST'];?>/api/sjmnt2.php</span>
</p>
<p class="simpleTable">
...
<p class="simpleTable">
<span class="layui-badge layui-bg-blue">请求示例②：</span>
<span class="url" data-clipboard-text="http://<?php echo $_SERVER['HTTP_HOST'];?>/api/sjmnt22.php">http://<?php echo $_SERVER['HTTP_HOST'];?>/api/sjmnt22.php</span>
</p>
...
<pre class="layui-code"><img src="../api/sjmnt2.php" style="width: 45%;"></pre>
</div>
...
<pre class="layui-code"><a style="color:#fd4b5c;text-decoration:none；" target="_blank">妹子图(PE)
<?php echo $ming; ?>API妹子图(PE)\n
━━━━━━━━━\n
用户:@%昵称%\n
━━━━━━━━━\n
±img=http://<?php echo $_SERVER['HTTP_HOST'];?>/api/sjmnt2.php±\n
━━━━━━━━━\n
请求示例：http://<?php echo $_SERVER['HTTP_HOST'];?>/tianyi/sjmnt2.php\n
━━━━━━━━━\n
