...
<?php @$dwz = intval(file_get_contents("../api/tongji/jiekou/dwz.dat")); ?>
<?php @$dwzx = intval(file_get_contents("../api/tongji/jinri/".date("Y-m-d")."/dwz.dat")); ?>
...
<title>短网址生成 - <?php echo $ming; ?>API</title>
...
<legend>短网址生成API</legend>
</fieldset>
<blockquote class="layui-elem-quote">本接口总调用：<?php echo $dwz; ?>次·今日调用：<?php echo $dwzx; ?>次</blockquote>
</div>
...
<span class="url" data-clipboard-text="http://<?php echo $_SERVER['HTTP_HOST'];?>/api/dwz.php">http://<?php echo $_SERVER['HTTP_HOST'];?>/api/dwz.php</span>
</p>
<p class="simpleTable">
...
<span class="url" data-clipboard-text="http://<?php echo $_SERVER['HTTP_HOST'];?>/api/dwz.php?url=https://cloud.vpsidc.com.cn">http://<?php echo $_SERVER['HTTP_HOST'];?>/api/dwz.php?url=https://cloud.vpsidc.com.cn</span>
</p>
...
<tbody>
<tr><td>url</td><td>是</td><td>需要生成的链接</td></tr>
</tbody>
</table>
...
<tbody>
<tr><td>code</td><td>状态码</td></tr><tr>
<tr><td>url</td><td>获取的链接</td></tr><tr>
</table> 
<p class="linep">返回示例：</p>
<pre class="layui-code"><?php
//header("Content-Type:text/html;charset=UTF-8");
$result = file_get_contents("http://".$_SERVER['HTTP_HOST']."/api/dwz.php?url=https://cloud.vpsidc.com.cn");
echo $result;
?></pre>
</div>
...
<tr><td>1001</td><td>请输入需要缩短的网址</td></tr>                    </tbody>
<tr><td>1002</td><td>请输入正确的网址</td></tr>
</tbody>
</table>
</div>
<div class="layui-tab-item">
