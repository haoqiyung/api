...
<?php @$mobilgirl = intval(file_get_contents("../api/tongji/jiekou/mobil.girl.dat")); ?>
<?php @$mobilgirlx = intval(file_get_contents("../api/tongji/jinri/".date("Y-m-d")."/mobil.girl.dat")); ?>
...
<title>随机手机分辨率美图 - <?php echo $ming; ?>API</title>
...
<legend>随机手机分辨率美图API</legend>
</fieldset>
<blockquote class="layui-elem-quote">本接口总调用：<?php echo $mobilgirl; ?>次·今日调用：<?php echo $mobilgirlx; ?>次</blockquote>
</div>
...
<span class="url" data-clipboard-text="http://<?php echo $_SERVER['HTTP_HOST'];?>/api/mobil.girl.php">http://<?php echo $_SERVER['HTTP_HOST'];?>/api/mobil.girl.php</span>
</p>
<p class="simpleTable">
...
<pre class="layui-code"><img src="../api/mobil.girl.php" style="width: 45%;"></pre>
</div>
...
<pre class="layui-code"><a style="color:#fd4b5c;text-decoration:none；" target="_blank">随机手机分辨率美图
<?php echo $ming; ?>API随机手机分辨率美图\n
━━━━━━━━━\n
用户:@%昵称%\n
━━━━━━━━━\n
±img=http://<?php echo $_SERVER['HTTP_HOST'];?>/api/mobil.girl.php±\n
━━━━━━━━━\n
请求示例：http://<?php echo $_SERVER['HTTP_HOST'];?>/tianyi/mobil.girl.php\n
━━━━━━━━━\n
