...
<?php @$girl = intval(file_get_contents("../api/tongji/jiekou/girl.dat")); ?>
<?php @$girlx = intval(file_get_contents("../api/tongji/jinri/".date("Y-m-d")."/girl.dat")); ?>
...
<title>随机电脑分辨率美图 - <?php echo $ming; ?>API</title>
...
<legend>随机电脑分辨率美图API</legend>
</fieldset>
<blockquote class="layui-elem-quote">本接口总调用：<?php echo $girl; ?>次·今日调用：<?php echo $girlx; ?>次</blockquote>
</div>
...
<span class="url" data-clipboard-text="http://<?php echo $_SERVER['HTTP_HOST'];?>/api/girl.php">http://<?php echo $_SERVER['HTTP_HOST'];?>/api/girl.php</span>
</p>
<p class="simpleTable">
...
<pre class="layui-code"><img src="../api/girl.php" style="width: 45%;"></pre>
</div>
...
<pre class="layui-code"><a style="color:#fd4b5c;text-decoration:none；" target="_blank">随机电脑分辨率美图
<?php echo $ming; ?>API随机电脑分辨率美图\n
━━━━━━━━━\n
用户:@%昵称%\n
━━━━━━━━━\n
±img=http://<?php echo $_SERVER['HTTP_HOST'];?>/api/girl.php±\n
━━━━━━━━━\n
请求示例：http://<?php echo $_SERVER['HTTP_HOST'];?>/tianyi/girl.php\n
━━━━━━━━━\n
