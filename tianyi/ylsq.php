...
<title>亿乐社区下单 - <?php echo $ming; ?>API</title>
...
<span class="url" data-clipboard-text="http://<?php echo $_SERVER['HTTP_HOST'];?>/api/ylsq.php">http://<?php echo $_SERVER['HTTP_HOST'];?>/api/ylsq.php</span>
</p>
<p class="simpleTable">
...
<span class="url" data-clipboard-text="http://<?php echo $_SERVER['HTTP_HOST'];?>/api/ylsq.php?domain=[社区域名]&api_token=[TokenID]&key=[密匙]&gid=[商品编号]&num=[下单数量]&value1=[下单参数1]&value2=[下单参数2]&value3=[下单参数3]&value4=[下单参数4]&value5=[下单参数5]&value6=[下单参数6]">http://<?php echo $_SERVER['HTTP_HOST'];?>/api/ylsq.php?domain=[社区域名]&api_token=[TokenID]&key=[密匙]&gid=[商品编号]&num=[下单数量]&value1=[下单参数1]&value2=[下单参数2]&value3=[下单参数3]&value4=[下单参数4]&value5=[下单参数5]&value6=[下单参数6]</span>
</p>
...
<tbody>
<tr><td>domain</td><td>是</td><td>社区域名(不带http://)</td></tr>
<tr><td>api_token</td><td>是</td><td>TokenID</td></tr>
<tr><td>key</td><td>是</td><td>密钥</td></tr>
<tr><td>gid</td><td>是</td><td>商品编号</td></tr>
<tr><td>num</td><td>是</td><td>下单数量</td></tr>
<tr><td>value1</td><td>是</td><td>下单参数1</td></tr>
<tr><td>value2</td><td>是</td><td>下单参数2</td></tr>
<tr><td>value3</td><td>是</td><td>下单参数3</td></tr>
<tr><td>value4</td><td>是</td><td>下单参数4</td></tr>
<tr><td>value5</td><td>是</td><td>下单参数5</td></tr>
<tr><td>value6</td><td>是</td><td>下单参数6</td></tr>
</tbody>
</table>
