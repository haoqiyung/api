...
<?php @$txss = intval(file_get_contents("../api/tongji/jiekou/txss.dat")); ?>
<?php @$txssx = intval(file_get_contents("../api/tongji/jinri/".date("Y-m-d")."/txss.dat")); ?>
...
<blockquote class="layui-elem-quote">本接口总调用：<?php echo $txss; ?>次·今日调用：<?php echo $txssx; ?>次</blockquote>
</div>
...
<span class="url" data-clipboard-text="http://<?php echo $_SERVER['HTTP_HOST'];?>/api/txss.php">http://<?php echo $_SERVER['HTTP_HOST'];?>/api/txss.php</span>
</p>
<p class="simpleTable">
...
<span class="url" data-clipboard-text="http://<?php echo $_SERVER['HTTP_HOST'];?>/api/txss.php?msg=海绵宝宝">http://<?php echo $_SERVER['HTTP_HOST'];?>/api/txss.php?msg=海绵宝宝</span>
</p>
...
$result = file_get_contents("http://".$_SERVER['HTTP_HOST']."/api/txss.php?msg=海绵宝宝");
echo $result;
?></pre>
</div>
...
腾讯视频 [内容]\n
━━━━━━━━━\n
请求示例：http://<?php echo $_SERVER['HTTP_HOST'];?>/tianyi/txss.php\n
━━━━━━━━━\n
Tips:<?php echo $ming; ?>API技术支持

腾讯视频 .*
$访问 http://<?php echo $_SERVER['HTTP_HOST'];?>/api/txss.php?msg=%参数1%$</per>
</div>
</div>
</div>
</div>
