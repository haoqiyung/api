...
<?php @$tu = intval(file_get_contents("../api/tongji/jiekou/tu.dat")); ?>
<?php @$tux = intval(file_get_contents("../api/tongji/jinri/".date("Y-m-d")."/tu.dat")); ?>
...
<title>美腿 - <?php echo $ming; ?>API</title>
...
<blockquote class="layui-elem-quote">本接口总调用：<?php echo $tu; ?>次·今日调用：<?php echo $tux; ?>次</blockquote>
</div>
...
<span class="url" data-clipboard-text="http://<?php echo $_SERVER['HTTP_HOST'];?>/api/tu.php">http://<?php echo $_SERVER['HTTP_HOST'];?>/api/tu.php</span>
</p>
<p class="simpleTable">
...
$result = file_get_contents("http://".$_SERVER['HTTP_HOST']."/api/tu.php");
echo $result;
?></pre>
</div>
...
<pre class="layui-code"><a style="color:#fd4b5c;text-decoration:none；" target="_blank">美腿
<?php echo $ming; ?>API美腿\n
━━━━━━━━━\n
用户:@%昵称%\n
━━━━━━━━━\n
±img=$访问 http://<?php echo $_SERVER['HTTP_HOST'];?>/api/tu.php$±\n
━━━━━━━━━\n
请求示例：http://<?php echo $_SERVER['HTTP_HOST'];?>/tianyi/tu.php\n
━━━━━━━━━\n
