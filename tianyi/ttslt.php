...
<?php @$ttslt = intval(file_get_contents("../api/tongji/jiekou/ttslt.dat")); ?>
<?php @$ttsltx = intval(file_get_contents("../api/tongji/jinri/".date("Y-m-d")."/ttslt.dat")); ?>
...
<title>语音聊天 - <?php echo $ming; ?>API</title>
...
<legend>语音聊天API</legend>
</fieldset>
<blockquote class="layui-elem-quote">本接口总调用：<?php echo $ttslt; ?>次·今日调用：<?php echo $ttsltx; ?>次</blockquote>
</div>
...
<span class="url" data-clipboard-text="http://<?php echo $_SERVER['HTTP_HOST'];?>/api/ttslt.php">http://<?php echo $_SERVER['HTTP_HOST'];?>/api/ttslt.php</span>
</p>
<p class="simpleTable">
...
<span class="url" data-clipboard-text="http://<?php echo $_SERVER['HTTP_HOST'];?>/api/ttslt.php?msg=吉云">http://<?php echo $_SERVER['HTTP_HOST'];?>/api/ttslt.php?msg=吉云</span>
</p>
...
<tbody>
<tr><td>msg</td><td>是</td><td>需要生成的语音内容</td></tr>
