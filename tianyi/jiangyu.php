...
<?php @$jiangyu = intval(file_get_contents("../api/tongji/jiekou/jiangyu.dat")); ?>
<?php @$jiangyux = intval(file_get_contents("../api/tongji/jinri/".date("Y-m-d")."/jiangyu.dat")); ?>
...
<title>降雨查询 - <?php echo $ming; ?>API</title>
...
<legend>降雨查询API</legend>
</fieldset>
<blockquote class="layui-elem-quote">本接口总调用：<?php echo $jiangyu; ?>次·今日调用：<?php echo $jiangyux; ?>次</blockquote>
</div>
...
<span class="url" data-clipboard-text="http://<?php echo $_SERVER['HTTP_HOST'];?>/api/jiangyu.php">http://<?php echo $_SERVER['HTTP_HOST'];?>/api/jiangyu.php</span>
</p>
<p class="simpleTable">
...
$result = file_get_contents("http://".$_SERVER['HTTP_HOST']."/api/jiangyu.php");
echo $result;
?></pre>
</div>
...
<pre class="layui-code"><a style="color:#fd4b5c;text-decoration:none；" target="_blank">降雨查询
$访问 http://<?php echo $_SERVER['HTTP_HOST'];?>/api/jiangyu.php$</per>
</div>
</div>
</div>
</div>
