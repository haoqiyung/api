...
<?php @$wenrou = intval(file_get_contents("../api/tongji/jiekou/wenrou.dat")); ?>
<?php @$wenroux = intval(file_get_contents("../api/tongji/jinri/".date("Y-m-d")."/wenrou.dat")); ?>
...
<title>文案温柔 - <?php echo $ming; ?>API</title>
...
<legend>文案温柔API</legend>
</fieldset>
<blockquote class="layui-elem-quote">本接口总调用：<?php echo $wenrou; ?>次·今日调用：<?php echo $wenroux; ?>次</blockquote>
</div>
...
<span class="url" data-clipboard-text="http://<?php echo $_SERVER['HTTP_HOST'];?>/api/wenrou.php">http://<?php echo $_SERVER['HTTP_HOST'];?>/api/wenrou.php</span>
</p>
<p class="simpleTable">
...
$result = file_get_contents("http://".$_SERVER['HTTP_HOST']."/api/wenrou.php");
echo $result;
?></pre>
</div>
...
<pre class="layui-code"><a style="color:#fd4b5c;text-decoration:none；" target="_blank">文案温柔
$访问 http://<?php echo $_SERVER['HTTP_HOST'];?>/api/wenrou.php$</per>
</div>
</div>
</div>
</div>
