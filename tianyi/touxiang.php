...
<?php @$touxiang = intval(file_get_contents("../api/tongji/jiekou/touxiang.dat")); ?>
<?php @$touxiangx = intval(file_get_contents("../api/tongji/jinri/".date("Y-m-d")."/touxiang.dat")); ?>
...
<title>QQ头像 - <?php echo $ming; ?>API</title>
...
<legend>QQ头像API</legend>
</fieldset>
<blockquote class="layui-elem-quote">本接口总调用：<?php echo $touxiang; ?>次·今日调用：<?php echo $touxiangx; ?>次</blockquote>
</div>
...
<span class="url" data-clipboard-text="http://<?php echo $_SERVER['HTTP_HOST'];?>/api/touxiang.php">http://<?php echo $_SERVER['HTTP_HOST'];?>/api/touxiang.php</span>
</p>
<p class="simpleTable">
...
<span class="url" data-clipboard-text="http://<?php echo $_SERVER['HTTP_HOST'];?>/api/touxiang.php?msg=男生">http://<?php echo $_SERVER['HTTP_HOST'];?>/api/touxiang.php?msg=男生</span>
</p>
...
<tbody>
<tr><td>msg</td><td>是</td><td>输(女生/男生/情侣/卡通)</td></tr>
...
$result = file_get_contents("http://".$_SERVER['HTTP_HOST']."/api/touxiang.php?msg=男生");
echo $result;
?></pre>
</div>
...
<pre class="layui-code"><a style="color:#fd4b5c;text-decoration:none；" target="_blank">QQ头像
<?php echo $ming; ?>API♧QQ头像\n
━━━━━━━━━\n
用户:@%昵称%\n
━━━━━━━━━\n
男生头像\n
...
卡通头像\n
━━━━━━━━━\n
请求示例：http://<?php echo $_SERVER['HTTP_HOST'];?>/tianyi/touxiang.php\n
━━━━━━━━━\n
Tips:<?php echo $ming; ?>API技术支持

(男生|女生|情侣|卡通)头像
$访问 http://<?php echo $_SERVER['HTTP_HOST'];?>/api/touxiang.php?msg=%括号1%$</per>
</div>
</div>
</div>
</div>
