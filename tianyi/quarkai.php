...
<?php @$quarkai = intval(file_get_contents("../api/tongji/jiekou/quarkai.dat")); ?>
<?php @$quarkaix = intval(file_get_contents("../api/tongji/jinri/".date("Y-m-d")."/quarkai.dat")); ?>
...
<title>夸克AI - <?php echo $ming; ?>API</title>
...
<legend>夸克AIAPI</legend>
</fieldset>
<blockquote class="layui-elem-quote">本接口总调用：<?php echo $quarkai; ?>次·今日调用：<?php echo $quarkaix; ?>次</blockquote>
</div>
...
<span class="url" data-clipboard-text="http://<?php echo $_SERVER['HTTP_HOST'];?>/api/quarkai.php">http://<?php echo $_SERVER['HTTP_HOST'];?>/api/quarkai.php</span>
</p>
<p class="simpleTable">
...
<span class="url" data-clipboard-text="http://<?php echo $_SERVER['HTTP_HOST'];?>/api/quarkai.php?question=你好">http://<?php echo $_SERVER['HTTP_HOST'];?>/api/quarkai.php?question=你好</span>
</p>
...
<tbody>
<tr><td>question</td><td>是</td><td>聊天内容</td></tr>
...
$result = file_get_contents("http://".$_SERVER['HTTP_HOST']."/api/quarkai.php?question=你好");
echo $result;
?></pre>
</div>
...
<pre class="layui-code"><a style="color:#fd4b5c;text-decoration:none；" target="_blank">夸克AI
<?php echo $ming; ?>API夸克AI\n
━━━━━━━━━\n
用户:@%昵称%\n
━━━━━━━━━\n
夸克AI [内容]\n
━━━━━━━━━\n
请求示例：http://<?php echo $_SERVER['HTTP_HOST'];?>/tianyi/quarkai.php\n
━━━━━━━━━\n
Tips:<?php echo $ming; ?>API技术支持

夸克AI .*
$访问 http://<?php echo $_SERVER['HTTP_HOST'];?>/api/quarkai.php?question=%参数1%$</per>
</div>
</div>
</div>
</div>
