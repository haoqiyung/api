...
<?php @$qqnick = intval(file_get_contents("../api/tongji/jiekou/qqnick.dat")); ?>
<?php @$qqnickx = intval(file_get_contents("../api/tongji/jinri/".date("Y-m-d")."/qqnick.dat")); ?>
...
<title>获取QQ昵称 - <?php echo $ming; ?>API</title>
...
<legend>获取QQ昵称API</legend>
</fieldset>
<blockquote class="layui-elem-quote">本接口总调用：<?php echo $qqnick; ?>次·今日调用：<?php echo $qqnickx; ?>次</blockquote>
</div>
...
<span class="url" data-clipboard-text="http://<?php echo $_SERVER['HTTP_HOST'];?>/api/qqnick.php">http://<?php echo $_SERVER['HTTP_HOST'];?>/api/qqnick.php</span>
</p>
<p class="simpleTable">
...
<span class="url" data-clipboard-text="http://<?php echo $_SERVER['HTTP_HOST'];?>/api/qqnick.php?qq=3189402257">http://<?php echo $_SERVER['HTTP_HOST'];?>/api/qqnick.php?qq=3189402257</span>
</p>
...
$result = file_get_contents("http://".$_SERVER['HTTP_HOST']."/api/qqnick.php?qq=3189402257");
echo $result;
?></pre>
</div>
...
<pre class="layui-code"><a style="color:#fd4b5c;text-decoration:none；" target="_blank">获取QQ昵称
<?php echo $ming; ?>API获取QQ昵称\n
━━━━━━━━━\n
用户:@%昵称%\n
━━━━━━━━━\n
获取QQ昵称 [QQ号]\n
━━━━━━━━━\n
请求示例：http://<?php echo $_SERVER['HTTP_HOST'];?>/tianyi/qqnick.php\n
━━━━━━━━━\n
...
用户:@%昵称%\n
━━━━━━━━━\n
$访问 http://<?php echo $_SERVER['HTTP_HOST'];?>/api/qqnick.php?qq=%参数1%$\n
━━━━━━━━━\n
