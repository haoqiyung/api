...
<?php @$wzztp = intval(file_get_contents("../api/tongji/jiekou/wzztp.dat")); ?>
<?php @$wzztpx = intval(file_get_contents("../api/tongji/jinri/".date("Y-m-d")."/wzztp.dat")); ?>
...
<title>文字转图片 - <?php echo $ming; ?>API</title>
...
<legend>文字转图片API</legend>
</fieldset>
<blockquote class="layui-elem-quote">本接口总调用：<?php echo $wzztp; ?>次·今日调用：<?php echo $wzztpx; ?>次</blockquote>
</div>
...
<span class="url" data-clipboard-text="http://<?php echo $_SERVER['HTTP_HOST'];?>/api/wzztp.php">http://<?php echo $_SERVER['HTTP_HOST'];?>/api/wzztp.php</span>
</p>
<p class="simpleTable">
...
<span class="url" data-clipboard-text="http://<?php echo $_SERVER['HTTP_HOST'];?>/api/wzztp.php?s=325&ss=00A8FF&nr=吉云">http://<?php echo $_SERVER['HTTP_HOST'];?>/api/wzztp.php?s=325&ss=00A8FF&nr=吉云</span>
</p>
...
<tbody>
<tr><td>nr</td><td>是</td><td>需要转图片的文字</td></tr>
<tr><td>换行</td><td>是</td><td>用:\r \n | 进行换行</td></tr>
<tr><td>s</td><td>是</td><td>需要转图片的字体</td></tr>
<tr><td>ss</td><td>是</td><td>需要转图片的背景颜色</td></tr>
</tbody>
</table>
...
$result = file_get_contents("http://".$_SERVER['HTTP_HOST']."/api/wzztp.php?s=325&ss=00A8FF&nr=吉云");
echo $result;
?></pre>
</div>
