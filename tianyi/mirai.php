...
<?php @$mirai = intval(file_get_contents("../api/tongji/jiekou/mirai.dat")); ?>
<?php @$miraix = intval(file_get_contents("../api/tongji/jinri/".date("Y-m-d")."/mirai.dat")); ?>
...
<title>咪咕音乐 - <?php echo $ming; ?>API</title>
...
<legend>咪咕音乐API</legend>
</fieldset>
<blockquote class="layui-elem-quote">本接口总调用：<?php echo $mirai; ?>次·今日调用：<?php echo $miraix; ?>次</blockquote>
</div>
...
<span class="url" data-clipboard-text="http://<?php echo $_SERVER['HTTP_HOST'];?>/api/mirai.php">http://<?php echo $_SERVER['HTTP_HOST'];?>/api/mirai.php</span>
</p>
<p class="simpleTable">
...
<span class="url" data-clipboard-text="http://<?php echo $_SERVER['HTTP_HOST'];?>/api/mirai.php?msg=吉云&n=1&type=text">http://<?php echo $_SERVER['HTTP_HOST'];?>/api/mirai.php?msg=吉云&n=1&type=text</span>
</p>
...
<tr><td>n</td><td>是</td><td>选择(序号)</td></tr>
<tr><td>type</td><td>是</td><td>输出方式(text/xml/json)</td></tr>
</tbody>
</table>
...
$result = file_get_contents("http://".$_SERVER['HTTP_HOST']."/api/mirai.php?msg=吉云&n=1&type=text");
echo $result;
?></pre>
</div>
...
<pre class="layui-code"><a style="color:#fd4b5c;text-decoration:none；" target="_blank">咪咕音乐
<?php echo $ming; ?>API咪咕音乐\n
━━━━━━━━━\n
用户:@%昵称%\n
━━━━━━━━━\n
咪咕音乐 [歌曲名]\n
━━━━━━━━━\n
请求示例：http://<?php echo $_SERVER['HTTP_HOST'];?>/tianyi/mirai.php\n
━━━━━━━━━\n
Tips:<?php echo $ming; ?>API技术支持

咪咕音乐 .*
$写 <?php echo $ming; ?>API/%群号%/%QQ% 咪咕音乐 %参数1%$
<?php echo $ming; ?>API咪咕音乐\n
━━━━━━━━━\n
用户:@%昵称%\n
━━━━━━━━━\n
$访问 http://<?php echo $_SERVER['HTTP_HOST'];?>/api/mirai.php?msg=%参数1%$\n
━━━━━━━━━\n
Tips:<?php echo $ming; ?>API技术支持

选咪咕音乐 .*
u:$读 <?php echo $ming; ?>API/%群号%/%QQ% 咪咕音乐 %参数1%$
<?php echo $ming; ?>API咪咕音乐\n
━━━━━━━━━\n
用户:@%昵称%\n
━━━━━━━━━\n
$访问 http://<?php echo $_SERVER['HTTP_HOST'];?>/api/mirai.php?msg=%u%&n=%参数1%&type=text$\n
━━━━━━━━━\n
