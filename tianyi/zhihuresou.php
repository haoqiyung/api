...
<?php @$zhihuresou = intval(file_get_contents("../api/tongji/jiekou/zhihuresou.dat")); ?>
<?php @$zhihuresoux = intval(file_get_contents("../api/tongji/jinri/".date("Y-m-d")."/zhihuresou.dat")); ?>
...
<title>知乎热搜榜获取 - <?php echo $ming; ?>API</title>
...
<legend>知乎热搜榜获取API</legend>
</fieldset>
<blockquote class="layui-elem-quote">本接口总调用：<?php echo $zhihuresou; ?>次·今日调用：<?php echo $zhihuresoux; ?>次</blockquote>
</div>
...
<span class="url" data-clipboard-text="http://<?php echo $_SERVER['HTTP_HOST'];?>/api/zhihuresou.php">http://<?php echo $_SERVER['HTTP_HOST'];?>/api/zhihuresou.php</span>
</p>
<p class="simpleTable">
...
$result = file_get_contents("http://".$_SERVER['HTTP_HOST']."/api/zhihuresou.php");
echo $result;
?></pre>
</div>
...
<pre class="layui-code"><a style="color:#fd4b5c;text-decoration:none；" target="_blank">知乎热搜榜获取
$访问 http://<?php echo $_SERVER['HTTP_HOST'];?>/api/zhihuresou.php$</per>
</div>
</div>
</div>
</div>
