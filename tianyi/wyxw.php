...
<?php @$wyxw = intval(file_get_contents("../api/tongji/jiekou/wyxw.dat")); ?>
<?php @$wyxwx = intval(file_get_contents("../api/tongji/jinri/".date("Y-m-d")."/wyxw.dat")); ?>
...
<title>网易最新发布 - <?php echo $ming; ?>API</title>
...
<legend>网易最新发布API</legend>
</fieldset>
<blockquote class="layui-elem-quote">本接口总调用：<?php echo $wyxw; ?>次·今日调用：<?php echo $wyxwx; ?>次</blockquote>
</div>
...
<span class="url" data-clipboard-text="http://<?php echo $_SERVER['HTTP_HOST'];?>/api/wyxw.php">http://<?php echo $_SERVER['HTTP_HOST'];?>/api/wyxw.php</span>
</p>
<p class="simpleTable">
...
<span class="url" data-clipboard-text="http://<?php echo $_SERVER['HTTP_HOST'];?>/api/wyxw.php?id=DE0DNAFFwangning">http://<?php echo $_SERVER['HTTP_HOST'];?>/api/wyxw.php?id=DE0DNAFFwangning</span>
</p>
...
<tbody>
<tr><td>id</td><td>是</td><td>输网易云主页ID</td></tr>
</tbody>
</table>
...
$result = file_get_contents("http://".$_SERVER['HTTP_HOST']."/api/wyxw.php?id=DE0DNAFFwangning");
echo $result;
?></pre>
</div>
