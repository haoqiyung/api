...
<?php @$Receive_jd = intval(file_get_contents("../api/tongji/jiekou/Receive_jd.dat")); ?>
<?php @$Receive_jdx = intval(file_get_contents("../api/tongji/jinri/".date("Y-m-d")."/Receive_jd.dat")); ?>
...
<title>QQ会员领金豆 - <?php echo $ming; ?>API</title>
...
<legend>QQ会员领金豆API</legend>
</fieldset>
<blockquote class="layui-elem-quote">本接口总调用：<?php echo $Receive_jd; ?>次·今日调用：<?php echo $Receive_jdx; ?>次</blockquote>
</div>
...
<span class="url" data-clipboard-text="http://<?php echo $_SERVER['HTTP_HOST'];?>/api/Receive_jd.php">http://<?php echo $_SERVER['HTTP_HOST'];?>/api/Receive_jd.php</span>
</p>
<p class="simpleTable">
...
<span class="url" data-clipboard-text="http://<?php echo $_SERVER['HTTP_HOST'];?>/api/Receive_jd.php?uin=[QQ]&skey=[SKEY]&pskey=[PSKEY]&qh=[群号]">http://<?php echo $_SERVER['HTTP_HOST'];?>/api/Receive_jd.php?uin=[QQ]&skey=[SKEY]&pskey=[PSKEY]&qh=[群号]</span>
</p>
...
<tbody>
<tr><td>uin</td><td>是</td><td>登录者的QQ号</td></tr>
...
<pre class="layui-code"><a style="color:#fd4b5c;text-decoration:none；" target="_blank">QQ会员领金豆
<?php echo $ming; ?>API♧QQ会员领金豆\n
━━━━━━━━━\n
用户:@%昵称%\n
━━━━━━━━━\n
$访问 http://<?php echo $_SERVER['HTTP_HOST'];?>/api/Receive_jd.php?uin=%Robot%&skey=%Skey%&pskey=%Json%&qh=%群号%$\n
━━━━━━━━━\n
请求示例：http://<?php echo $_SERVER['HTTP_HOST'];?>/tianyi/Receive_jd.php\n
━━━━━━━━━\n
