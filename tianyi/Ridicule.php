...
<?php @$Ridicule = intval(file_get_contents("../api/tongji/jiekou/Ridicule.dat")); ?>
<?php @$Ridiculex = intval(file_get_contents("../api/tongji/jinri/".date("Y-m-d")."/Ridicule.dat")); ?>
...
<title>口吐芬芳 - <?php echo $ming; ?>API</title>
...
<legend>口吐芬芳API</legend>
</fieldset>
<blockquote class="layui-elem-quote">本接口总调用：<?php echo $Ridicule; ?>次·今日调用：<?php echo $Ridiculex; ?>次</blockquote>
</div>
...
<span class="url" data-clipboard-text="http://<?php echo $_SERVER['HTTP_HOST'];?>/api/Ridicule.php">http://<?php echo $_SERVER['HTTP_HOST'];?>/api/Ridicule.php</span>
</p>
<p class="simpleTable">
...
<span class="url" data-clipboard-text="http://<?php echo $_SERVER['HTTP_HOST'];?>/api/Ridicule.php?msg=5">http://<?php echo $_SERVER['HTTP_HOST'];?>/api/Ridicule.php?msg=5</span>
</p>
...
<tbody>
<tr><td>msg</td><td>否</td><td>输数字(1=滚刀/2=殴打/3=散扣/4=嘲讽/5=口吐)(默认1=滚刀)</td></tr>
</tbody>
</table>
...
$result = file_get_contents("http://".$_SERVER['HTTP_HOST']."/api/Ridicule.php?msg=5");
echo $result;
?></pre>
</div>
...
<pre class="layui-code"><a style="color:#fd4b5c;text-decoration:none；" target="_blank">口吐芬芳
<?php echo $ming; ?>API口吐芬芳\n
━━━━━━━━━\n
用户:@%昵称%\n
━━━━━━━━━\n
口吐芬芳 [输数字(1=滚刀/2=殴打/3=散扣/4=嘲讽/5=口吐)]\n
━━━━━━━━━\n
请求示例：http://<?php echo $_SERVER['HTTP_HOST'];?>/tianyi/Ridicule.php\n
━━━━━━━━━\n
...
用户:@%昵称%\n
━━━━━━━━━\n
$访问 http://<?php echo $_SERVER['HTTP_HOST'];?>/api/Ridicule.php?msg=%参数1%\n
━━━━━━━━━\n
