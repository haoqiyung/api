...
<?php @$dwzhy = intval(file_get_contents("../api/tongji/jiekou/dwzhy.dat")); ?>
<?php @$dwzhyx = intval(file_get_contents("../api/tongji/jinri/".date("Y-m-d")."/dwzhy.dat")); ?>
...
<title>短网址还原 - <?php echo $ming; ?>API</title>
...
<legend>短网址还原API</legend>
</fieldset>
<blockquote class="layui-elem-quote">本接口总调用：<?php echo $dwzhy; ?>次·今日调用：<?php echo $dwzhyx; ?>次</blockquote>
</div>
...
<span class="url" data-clipboard-text="http://<?php echo $_SERVER['HTTP_HOST'];?>/api/dwzhy.php">http://<?php echo $_SERVER['HTTP_HOST'];?>/api/dwzhy.php</span>
</p>
<p class="simpleTable">
...
<span class="url" data-clipboard-text="http://<?php echo $_SERVER['HTTP_HOST'];?>/api/dwzhy.php?url=http://33h.co/wqum3">http://<?php echo $_SERVER['HTTP_HOST'];?>/api/dwzhy.php?url=http://33h.co/wqum3</span>
</p>
...
<tbody>
<tr><td>url</td><td>是</td><td>需要还原的链接</td></tr>
</tbody>
</table>
...
<tr><td>msg</td><td>获取的链接</td></tr><tr>
</table> 
<p class="linep">返回示例：</p>
<pre class="layui-code"><?php
//header("Content-Type:text/html;charset=UTF-8");
$result = file_get_contents("http://".$_SERVER['HTTP_HOST']."/api/dwzhy.php?url=http://33h.co/wqum3");
echo $result;
?></pre>
</div>
...
<tr><td>1001</td><td>请输入需要还原的网址！</td></tr>
