...
<?php @$txm = intval(file_get_contents("../api/tongji/jiekou/txm.dat")); ?>
<?php @$txmx = intval(file_get_contents("../api/tongji/jinri/".date("Y-m-d")."/txm.dat")); ?>
...
<title>条形码生成 - <?php echo $ming; ?>API</title>
...
<legend>条形码生成API</legend>
</fieldset>
<blockquote class="layui-elem-quote">本接口总调用：<?php echo $txm; ?>次·今日调用：<?php echo $txmx; ?>次</blockquote>
</div>
...
<span class="url" data-clipboard-text="http://<?php echo $_SERVER['HTTP_HOST'];?>/api/txm.php">http://<?php echo $_SERVER['HTTP_HOST'];?>/api/txm.php</span>
</p>
<p class="simpleTable">
...
<span class="url" data-clipboard-text="http://<?php echo $_SERVER['HTTP_HOST'];?>/api/txm.php?msg=1234567890">http://<?php echo $_SERVER['HTTP_HOST'];?>/api/txm.php?msg=1234567890</span>
</p>
...
<tbody>
<tr><td>msg</td><td>是</td><td>需要生成的11位数字</td></tr>
</tbody>
</table>
...
<pre class="layui-code"><img src="../api/txm.php?msg=1234567890" style="width: 45%;"></pre>
</div>
...
<pre class="layui-code"><a style="color:#fd4b5c;text-decoration:none；" target="_blank">条形码生成
<?php echo $ming; ?>API条形码生成\n
━━━━━━━━━\n
用户:@%昵称%\n
━━━━━━━━━\n
条形码生成 [11个数字]\n
━━━━━━━━━\n
请求示例：http://<?php echo $_SERVER['HTTP_HOST'];?>/tianyi/txm.php\n
━━━━━━━━━\n
...
用户:@%昵称%\n
━━━━━━━━━\n
±img=http://<?php echo $_SERVER['HTTP_HOST'];?>/api/txm.php?msg=%参数1%±\n
━━━━━━━━━\n
