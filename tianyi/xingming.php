...
<?php @$xingming = intval(file_get_contents("../api/tongji/jiekou/xingming.dat")); ?>
<?php @$xingmingx = intval(file_get_contents("../api/tongji/jinri/".date("Y-m-d")."/xingming.dat")); ?>
...
<title>随机姓名 - <?php echo $ming; ?>API</title>
...
<legend>随机姓名API</legend>
</fieldset>
<blockquote class="layui-elem-quote">本接口总调用：<?php echo $xingming; ?>次·今日调用：<?php echo $xingmingx; ?>次</blockquote>
</div>
...
<span class="url" data-clipboard-text="http://<?php echo $_SERVER['HTTP_HOST'];?>/api/xingming.php">http://<?php echo $_SERVER['HTTP_HOST'];?>/api/xingming.php</span>
</p>
<p class="simpleTable">
...
$result = file_get_contents("http://".$_SERVER['HTTP_HOST']."/api/xingming.php");
echo $result;
?></pre>
</div>
...
<pre class="layui-code"><a style="color:#fd4b5c;text-decoration:none；" target="_blank">随机姓名
<?php echo $ming; ?>API随机姓名\n
━━━━━━━━━\n
用户:@%昵称%\n
━━━━━━━━━\n
$访问 http://<?php echo $_SERVER['HTTP_HOST'];?>/api/xingming.php$\n
━━━━━━━━━\n
请求示例：http://<?php echo $_SERVER['HTTP_HOST'];?>/tianyi/xingming.php\n
━━━━━━━━━\n
