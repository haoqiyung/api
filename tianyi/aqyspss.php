...
<?php @$aqyspss = intval(file_get_contents("../api/tongji/jiekou/aqyspss.dat")); ?>
<?php @$aqyspssx = intval(file_get_contents("../api/tongji/jinri/".date("Y-m-d")."/aqyspss.dat")); ?>
...
<title>爱奇艺视频搜索 - <?php echo $ming; ?>API</title>
...
<legend>爱奇艺视频搜索API</legend>
</fieldset>
<blockquote class="layui-elem-quote">本接口总调用：<?php echo $aqyspss; ?>次·今日调用：<?php echo $aqyspssx; ?>次</blockquote>
</div>
...
<span class="url" data-clipboard-text="http://<?php echo $_SERVER['HTTP_HOST'];?>/api/aqyspss.php">http://<?php echo $_SERVER['HTTP_HOST'];?>/api/aqyspss.php</span>
</p>
<p class="simpleTable">
...
<span class="url" data-clipboard-text="http://<?php echo $_SERVER['HTTP_HOST'];?>/api/aqyspss.php?s=吉云">http://<?php echo $_SERVER['HTTP_HOST'];?>/api/aqyspss.php?s=吉云</span>
</p>
...
<tbody>
<tr><td>s</td><td>是</td><td>输视频名称</td></tr>
</tbody>
</table>
...
$result = file_get_contents("http://".$_SERVER['HTTP_HOST']."/api/aqyspss.php?s=吉云");
echo $result;
?></pre>
</div>
