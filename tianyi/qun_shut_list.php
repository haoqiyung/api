...
<?php @$qun_shut_list = intval(file_get_contents("../api/tongji/jiekou/qun_shut_list.dat")); ?>
<?php @$qun_shut_listx = intval(file_get_contents("../api/tongji/jinri/".date("Y-m-d")."/qun_shut_list.dat")); ?>
...
<title>QQ群禁言列表 - <?php echo $ming; ?>API</title>
...
<legend>QQ群禁言列表API</legend>
</fieldset>
<blockquote class="layui-elem-quote">本接口总调用：<?php echo $qun_shut_list; ?>次·今日调用：<?php echo $qun_shut_listx; ?>次</blockquote>
</div>
...
<span class="url" data-clipboard-text="http://<?php echo $_SERVER['HTTP_HOST'];?>/api/qun_shut_list.php">http://<?php echo $_SERVER['HTTP_HOST'];?>/api/qun_shut_list.php</span>
</p>
<p class="simpleTable">
...
<span class="url" data-clipboard-text="http://<?php echo $_SERVER['HTTP_HOST'];?>/api/qun_shut_list.php?uin=[QQ]&skey=[SKEY]&pskey=[PSKEY]&qh=[群号]">http://<?php echo $_SERVER['HTTP_HOST'];?>/api/qun_shut_list.php?uin=[QQ]&skey=[SKEY]&pskey=[PSKEY]&qh=[群号]</span>
</p>
...
<tr><td>qh</td><td>是</td><td>操作群号</td></tr>
</tbody>
</table>
...
<pre class="layui-code"><a style="color:#fd4b5c;text-decoration:none；" target="_blank">QQ群公告查询
P:%Json%
P:@P[pskey]
P:@P[qun.qq.com]
<?php echo $ming; ?>API♧QQ禁言列表\n
━━━━━━━━━\n
用户:@%昵称%\n
━━━━━━━━━\n
$访问 http://<?php echo $_SERVER['HTTP_HOST'];?>/api/qun_shut_list.php?qq=%Robot%&skey=%Skey%&pskey=%P%&qh=%群号%$\n
━━━━━━━━━\n
请求示例：http://<?php echo $_SERVER['HTTP_HOST'];?>/tianyi/qun_shut_list.php\n
━━━━━━━━━\n
