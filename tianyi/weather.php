...
<?php @$weather = intval(file_get_contents("../api/tongji/jiekou/weather.dat")); ?>
<?php @$weatherx = intval(file_get_contents("../api/tongji/jinri/".date("Y-m-d")."/weather.dat")); ?>
...
<title>天气 - <?php echo $ming; ?>API</title>
...
<blockquote class="layui-elem-quote">本接口总调用：<?php echo $weather; ?>次·今日调用：<?php echo $weatherx; ?>次</blockquote>
</div>
...
<span class="url" data-clipboard-text="http://<?php echo $_SERVER['HTTP_HOST'];?>/api/weather.php">http://<?php echo $_SERVER['HTTP_HOST'];?>/api/weather.php</span>
</p>
<p class="simpleTable">
...
<span class="url" data-clipboard-text="http://<?php echo $_SERVER['HTTP_HOST'];?>/api/weather.php?msg=农安&type=7">http://<?php echo $_SERVER['HTTP_HOST'];?>/api/weather.php?msg=农安&type=7</span>
</p>
...
<tr><td>type</td><td>是</td><td>输数字(1-7)天</td></tr>
</tbody>
</table>
...
$result = file_get_contents("http://".$_SERVER['HTTP_HOST']."/api/weather.php?msg=农安&type=7");
echo $result;
?></pre>
</div>
...
<pre class="layui-code"><a style="color:#fd4b5c;text-decoration:none；" target="_blank">天气
<?php echo $ming; ?>API天气\n
━━━━━━━━━\n
用户:@%昵称%\n
━━━━━━━━━\n
天气 [地区名] [天数]\n
━━━━━━━━━\n
请求示例：http://<?php echo $_SERVER['HTTP_HOST'];?>/tianyi/weather.php\n
━━━━━━━━━\n
...
用户:@%昵称%\n
━━━━━━━━━\n
$访问 http://<?php echo $_SERVER['HTTP_HOST'];?>/api/weather.php?msg=%参数1%&type=%参数2%$\n
━━━━━━━━━\n
