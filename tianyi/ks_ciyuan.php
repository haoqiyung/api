...
<title>快手二次元推荐 - <?php echo $ming; ?>API</title>
...
<span class="url" data-clipboard-text="http://<?php echo $_SERVER['HTTP_HOST'];?>/api/ks_ciyuan.php">http://<?php echo $_SERVER['HTTP_HOST'];?>/api/ks_ciyuan.php</span>
</p>
<p class="simpleTable">
...
<tbody>
<tr><td>lx</td><td>否</td><td>输(推荐/男神/国风)(默认推荐)</td></tr>
...
$result = file_get_contents("http://".$_SERVER['HTTP_HOST']."/api/ks_ciyuan.php");
echo $result;
?></pre>
</div>
...
<pre class="layui-code"><a style="color:#fd4b5c;text-decoration:none；" target="_blank">快手二次元推荐
<?php echo $ming; ?>API快手二次元推荐\n
━━━━━━━━━\n
用户:@%昵称%\n
━━━━━━━━━\n
$访问 http://<?php echo $_SERVER['HTTP_HOST'];?>/api/ks_ciyuan.php$\n
━━━━━━━━━\n
请求示例：http://<?php echo $_SERVER['HTTP_HOST'];?>/tianyi/ks_ciyuan.php\n
━━━━━━━━━\n
