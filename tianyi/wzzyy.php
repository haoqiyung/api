...
<?php @$wzzyy = intval(file_get_contents("../api/tongji/jiekou/wzzyy.dat")); ?>
<?php @$wzzyyx = intval(file_get_contents("../api/tongji/jinri/".date("Y-m-d")."/wzzyy.dat")); ?>
...
<title>文字转语音 - <?php echo $ming; ?>API</title>
...
<legend>文字转语音API</legend>
</fieldset>
<blockquote class="layui-elem-quote">本接口总调用：<?php echo $wzzyy; ?>次·今日调用：<?php echo $wzzyyx; ?>次</blockquote>
</div>
...
<span class="url" data-clipboard-text="http://<?php echo $_SERVER['HTTP_HOST'];?>/api/wzzyy.php">http://<?php echo $_SERVER['HTTP_HOST'];?>/api/wzzyy.php</span>
</p>
<p class="simpleTable">
...
<span class="url" data-clipboard-text="http://<?php echo $_SERVER['HTTP_HOST'];?>/api/wzzyy.php?text=吉云&spd=1">http://<?php echo $_SERVER['HTTP_HOST'];?>/api/wzzyy.php?text=吉云&spd=1</span>
</p>
...
<tbody>
<tr><td>text</td><td>是</td><td>需要生成的内容</td></tr>
<tr><td>spd</td><td>是</td><td>语速，可以是1-9的数字，数字越大，语速越快</td></tr>
</tbody>
</table>
...
<pre class="layui-code">本API直接返回语音</pre>
</div>
