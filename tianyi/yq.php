...
<?php @$yq = intval(file_get_contents("../api/tongji/jiekou/yq.dat")); ?>
<?php @$yqx = intval(file_get_contents("../api/tongji/jinri/".date("Y-m-d")."/yq.dat")); ?>
...
<title>疫情查询 - <?php echo $ming; ?>API</title>
...
<legend>疫情查询API</legend>
</fieldset>
<blockquote class="layui-elem-quote">本接口总调用：<?php echo $yq; ?>次·今日调用：<?php echo $yqx; ?>次</blockquote>
</div>
...
<span class="url" data-clipboard-text="http://<?php echo $_SERVER['HTTP_HOST'];?>/api/yq.php">http://<?php echo $_SERVER['HTTP_HOST'];?>/api/yq.php</span>
</p>
<p class="simpleTable">
...
<span class="url" data-clipboard-text="http://<?php echo $_SERVER['HTTP_HOST'];?>/api/yq.php?msg=长春">http://<?php echo $_SERVER['HTTP_HOST'];?>/api/yq.php?msg=长春</span>
</p>
...
$result = file_get_contents("http://".$_SERVER['HTTP_HOST']."/api/yq.php?msg=长春");
echo $result;
?></pre>
</div>
...
<pre class="layui-code"><a style="color:#fd4b5c;text-decoration:none；" target="_blank">疫情查询
<?php echo $ming; ?>API疫情查询\n
━━━━━━━━━\n
用户:@%昵称%\n
━━━━━━━━━\n
疫情查询 [地区]\n
━━━━━━━━━\n
请求示例：http://<?php echo $_SERVER['HTTP_HOST'];?>/tianyi/yq.php\n
━━━━━━━━━\n
Tips:<?php echo $ming; ?>API技术支持

疫情查询 .*
$访问 http://<?php echo $_SERVER['HTTP_HOST'];?>/api/yq.php?msg=%参数1%$</per>
</div>
</div>
</div>
</div>
