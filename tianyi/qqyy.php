...
<?php @$qqyy = intval(file_get_contents("../api/tongji/jiekou/qqyy.dat")); ?>
<?php @$qqyyx = intval(file_get_contents("../api/tongji/jinri/".date("Y-m-d")."/qqyy.dat")); ?>
...
<title>QQ音乐 - <?php echo $ming; ?>API</title>
...
<legend>QQ音乐API</legend>
</fieldset>
<blockquote class="layui-elem-quote">本接口总调用：<?php echo $qqyy; ?>次·今日调用：<?php echo $qqyyx; ?>次</blockquote>
</div>
...
<span class="url" data-clipboard-text="http://<?php echo $_SERVER['HTTP_HOST'];?>/api/qqyy.php">http://<?php echo $_SERVER['HTTP_HOST'];?>/api/qqyy.php</span>
</p>
<p class="simpleTable">
...
<span class="url" data-clipboard-text="http://<?php echo $_SERVER['HTTP_HOST'];?>/api/qqyy.php?msg=我和你&b=1">http://<?php echo $_SERVER['HTTP_HOST'];?>/api/qqyy.php?msg=我和你&b=1</span>
</p>
...
<tbody>
<tr><td>msg</td><td>是</td><td>关键词</td></tr>
...
$result = file_get_contents("http://".$_SERVER['HTTP_HOST']."/api/qqyy.php?msg=我和你&b=1");
echo $result;
?></pre>
</div>
...
<pre class="layui-code"><a style="color:#fd4b5c;text-decoration:none；" target="_blank">QQ音乐
<?php echo $ming; ?>API♧QQ音乐\n
━━━━━━━━━\n
用户:@%昵称%\n
━━━━━━━━━\n
QQ音乐 [内容]\n
━━━━━━━━━\n
请求示例：http://<?php echo $_SERVER['HTTP_HOST'];?>/tianyi/qqyy.php\n
━━━━━━━━━\n
Tips:<?php echo $ming; ?>API技术支持

QQ音乐 .*
$写 <?php echo $ming; ?>API/%群号%/QQ音乐 %QQ% %参数1%$
<?php echo $ming; ?>API♧QQ音乐\n
━━━━━━━━━\n
用户:@%昵称%\n
━━━━━━━━━\n
$访问 http://<?php echo $_SERVER['HTTP_HOST'];?>/api/qqyy.php?msg=%参数1%$\n
━━━━━━━━━\n
Tips:<?php echo $ming; ?>API技术支持

选QQ音乐 .*
s:$读 <?php echo $ming; ?>API/%群号%/QQ音乐 %QQ% %参数1%$
<?php echo $ming; ?>API♧QQ音乐\n
━━━━━━━━━\n
用户:@%昵称%\n
━━━━━━━━━\n
$访问 http://<?php echo $_SERVER['HTTP_HOST'];?>/api/qqyy.php?msg=%s%&b=%参数1%$\n
━━━━━━━━━\n
