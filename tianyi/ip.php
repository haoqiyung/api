...
<?php @$ip = intval(file_get_contents("../api/tongji/jiekou/ip.dat")); ?>
<?php @$ipx = intval(file_get_contents("../api/tongji/jinri/".date("Y-m-d")."/ip.dat")); ?>
...
<title>获取自己IP - <?php echo $ming; ?>API</title>
...
<legend>获取自己IPAPI</legend>
</fieldset>
<blockquote class="layui-elem-quote">本接口总调用：<?php echo $ip; ?>次·今日调用：<?php echo $ipx; ?>次</blockquote>
</div>
...
<span class="url" data-clipboard-text="http://<?php echo $_SERVER['HTTP_HOST'];?>/api/ip.php">http://<?php echo $_SERVER['HTTP_HOST'];?>/api/ip.php</span>
</p>
<p class="simpleTable">
...
$result = file_get_contents("http://".$_SERVER['HTTP_HOST']."/api/ip.php");
echo $result;
?></pre>
</div>
...
<pre class="layui-code"><a style="color:#fd4b5c;text-decoration:none；" target="_blank">获取自己的IP
<?php echo $ming; ?>API获取自己的IP\n
━━━━━━━━━\n
用户:@%昵称%\n
━━━━━━━━━\n
$访问 http://<?php echo $_SERVER['HTTP_HOST'];?>/api/ip.php$\n
━━━━━━━━━\n
请求示例：http://<?php echo $_SERVER['HTTP_HOST'];?>/tianyi/ip.php\n
━━━━━━━━━\n
