...
<?php @$md5 = intval(file_get_contents("../api/tongji/jiekou/md5.dat")); ?>
<?php @$md5x = intval(file_get_contents("../api/tongji/jinri/".date("Y-m-d")."/md5.dat")); ?>
...
<title>MD5加解密 - <?php echo $ming; ?>API</title>
...
<legend>MD5加解密API</legend>
</fieldset>
<blockquote class="layui-elem-quote">本接口总调用：<?php echo $md5; ?>次·今日调用：<?php echo $md5x; ?>次</blockquote>
</div>
...
<span class="url" data-clipboard-text="http://<?php echo $_SERVER['HTTP_HOST'];?>/api/md5.php">http://<?php echo $_SERVER['HTTP_HOST'];?>/api/md5.php</span>
</p>
<p class="simpleTable">
...
<span class="url" data-clipboard-text="http://<?php echo $_SERVER['HTTP_HOST'];?>/api/md5.php?act=加密&md5=吉云">http://<?php echo $_SERVER['HTTP_HOST'];?>/api/md5.php?act=加密&md5=吉云</span>
</p>
...
<tbody>
<tr><td>act</td><td>是</td><td>输加/解密</td></tr>
<tr><td>md5</td><td>是</td><td>输文字或加密后的代码</td></tr>
</tbody>
</table>
...
$result = file_get_contents("http://".$_SERVER['HTTP_HOST']."/api/md5.php?act=加密&md5=吉云");
echo $result;
?></pre>
</div>
...
<pre class="layui-code"><a style="color:#fd4b5c;text-decoration:none；" target="_blank">MD5加解密
<?php echo $ming; ?>API♧MD5加解密\n
━━━━━━━━━\n
用户:@%昵称%\n
━━━━━━━━━\n
MD5加/解密 [内容]\n
━━━━━━━━━\n
请求示例：http://<?php echo $_SERVER['HTTP_HOST'];?>/tianyi/md5.php\n
━━━━━━━━━\n
Tips:<?php echo $ming; ?>API技术支持

MD5(加密|解密) .*
$访问 http://<?php echo $_SERVER['HTTP_HOST'];?>/api/md5.php?act=%括号1%&md5=%参数1%$</per>
</div>
</div>
</div>
</div>
