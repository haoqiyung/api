...
<?php @$location_address_geocoder = intval(file_get_contents("../api/tongji/jiekou/location_address_geocoder.dat")); ?>
<?php @$location_address_geocoderx = intval(file_get_contents("../api/tongji/jinri/".date("Y-m-d")."/location_address_geocoder.dat")); ?>
...
<title>地区解析 - <?php echo $ming; ?>API</title>
...
<legend>地区解析API</legend>
</fieldset>
<blockquote class="layui-elem-quote">本接口总调用：<?php echo $location_address_geocoder; ?>次·今日调用：<?php echo $location_address_geocoderx; ?>次</blockquote>
</div>
...
<span class="url" data-clipboard-text="http://<?php echo $_SERVER['HTTP_HOST'];?>/api/location_address_geocoder.php">http://<?php echo $_SERVER['HTTP_HOST'];?>/api/location_address_geocoder.php</span>
</p>
<p class="simpleTable">
...
<span class="url" data-clipboard-text="http://<?php echo $_SERVER['HTTP_HOST'];?>/api/location_address_geocoder.php?address=长春市农安县">http://<?php echo $_SERVER['HTTP_HOST'];?>/api/location_address_geocoder.php?address=长春市农安县</span>
</p>
...
<tbody>
<tr><td>address</td><td>是</td><td>需要查询的地区</td></tr>
...
$result = file_get_contents("http://".$_SERVER['HTTP_HOST']."/api/location_address_geocoder.php?address=长春市农安县");
echo $result;
?></pre>
</div>
...
<pre class="layui-code"><a style="color:#fd4b5c;text-decoration:none；" target="_blank">地区解析
<?php echo $ming; ?>API地区解析\n
━━━━━━━━━\n
用户:@%昵称%\n
━━━━━━━━━\n
地区解析 [地区名]\n
━━━━━━━━━\n
请求示例：http://<?php echo $_SERVER['HTTP_HOST'];?>/tianyi/location_address_geocoder.php\n
━━━━━━━━━\n
Tips:<?php echo $ming; ?>API技术支持

地区解析 .*
$访问 http://<?php echo $_SERVER['HTTP_HOST'];?>/api/location_address_geocoder.php?address=%参数1%$</per>
</div>
</div>
</div>
</div>
