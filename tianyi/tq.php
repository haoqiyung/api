...
<?php @$tq = intval(file_get_contents("../api/tongji/jiekou/tq.dat")); ?>
<?php @$tqx = intval(file_get_contents("../api/tongji/jinri/".date("Y-m-d")."/tq.dat")); ?>
...
<title>天气『三天版』 - <?php echo $ming; ?>API</title>
...
<legend>天气『三天版』API</legend>
</fieldset>
<blockquote class="layui-elem-quote">本接口总调用：<?php echo $tq; ?>次·今日调用：<?php echo $tqx; ?>次</blockquote>
</div>
...
<span class="url" data-clipboard-text="http://<?php echo $_SERVER['HTTP_HOST'];?>/api/tq.php">http://<?php echo $_SERVER['HTTP_HOST'];?>/api/tq.php</span>
</p>
<p class="simpleTable">
...
<span class="url" data-clipboard-text="http://<?php echo $_SERVER['HTTP_HOST'];?>/api/tq.php?msg=农安">http://<?php echo $_SERVER['HTTP_HOST'];?>/api/tq.php?msg=农安</span>
</p>
...
$result = file_get_contents("http://".$_SERVER['HTTP_HOST']."/api/tq.php?msg=农安");
echo $result;
?></pre>
</div>
...
<pre class="layui-code"><a style="color:#fd4b5c;text-decoration:none；" target="_blank">天气『三天版』
<?php echo $ming; ?>API天气『三天版』\n
━━━━━━━━━\n
用户:@%昵称%\n
━━━━━━━━━\n
天气『三天版』 [地区]\n
━━━━━━━━━\n
请求示例：http://<?php echo $_SERVER['HTTP_HOST'];?>/tianyi/tq.php\n
━━━━━━━━━\n
Tips:<?php echo $ming; ?>API技术支持

天气『三天版』 .*
$访问 http://<?php echo $_SERVER['HTTP_HOST'];?>/api/tq.php?ip=%参数1%$</per>
</div>
</div>
</div>
</div>
