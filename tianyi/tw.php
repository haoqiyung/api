...
<?php @$tw = intval(file_get_contents("../api/tongji/jiekou/tw.dat")); ?>
<?php @$twx = intval(file_get_contents("../api/tongji/jinri/".date("Y-m-d")."/tw.dat")); ?>
...
<title>图文合成 - <?php echo $ming; ?>API</title>
...
<legend>图文合成API</legend>
</fieldset>
<blockquote class="layui-elem-quote">本接口总调用：<?php echo $tw; ?>次·今日调用：<?php echo $twx; ?>次</blockquote>
</div>
...
<span class="url" data-clipboard-text="http://<?php echo $_SERVER['HTTP_HOST'];?>/api/tw.php">http://<?php echo $_SERVER['HTTP_HOST'];?>/api/tw.php</span>
</p>
<p class="simpleTable">
...
<span class="url" data-clipboard-text="http://<?php echo $_SERVER['HTTP_HOST'];?>/api/tw.php?msg=吉云/星猫&dx=46&zt=1&tm=0&x=43&y=780&hh=/">http://<?php echo $_SERVER['HTTP_HOST'];?>/api/tw.php?msg=吉云/星猫&dx=46&zt=1&tm=0&x=43&y=780&hh=/</span>
</p>
...
<tbody>
<tr><td>wb</td><td>否</td><td>自定义尾巴内容</td></tr>
<tr><td>hh</td><td>否</td><td>自定义换行符</td></tr>
<tr><td>y</td><td>否</td><td>y坐标(从上往下数)</td></tr>
<tr><td>msg</td><td>是</td><td>需要合成的内容</td></tr>
<tr><td>dx</td><td>否</td><td>字体大小</td></tr>
<tr><td>zt</td><td>否</td><td>字体类型(目前可选1)</td></tr>
<tr><td>tm</td><td>否</td><td>字体透明度</td></tr>
<tr><td>x</td><td>否</td><td>x坐标(从左往右数)</td></tr>
</tbody>
</table>
...
<pre class="layui-code"><img src="../api/tw.php?msg=吉云/星猫&dx=46&zt=1&tm=0&x=43&y=780&hh=/" style="width: 45%;"></pre>
</pre>
</div>
