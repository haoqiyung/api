...
<?php @$pcmnt = intval(file_get_contents("../api/tongji/jiekou/pcmnt.dat")); ?>
<?php @$pcmntx = intval(file_get_contents("../api/tongji/jinri/".date("Y-m-d")."/pcmnt.dat")); ?>
...
<title>妹子图(PC) - <?php echo $ming; ?>API</title>
...
<legend>妹子图(PC)API</legend>
</fieldset>
<blockquote class="layui-elem-quote">本接口总调用：<?php echo $pcmnt; ?>次·今日调用：<?php echo $pcmntx; ?>次</blockquote>
</div>
...
<span class="url" data-clipboard-text="http://<?php echo $_SERVER['HTTP_HOST'];?>/api/pcmnt.php">http://<?php echo $_SERVER['HTTP_HOST'];?>/api/pcmnt.php</span>
</p>
<p class="simpleTable">
...
<pre class="layui-code"><img src="../api/pcmnt.php" style="width: 45%;"></pre>
</div>
...
<pre class="layui-code"><a style="color:#fd4b5c;text-decoration:none；" target="_blank">妹子图(PC)
<?php echo $ming; ?>API妹子图(PC)\n
━━━━━━━━━\n
用户:@%昵称%\n
━━━━━━━━━\n
±img=http://<?php echo $_SERVER['HTTP_HOST'];?>/api/pcmnt.php±\n
━━━━━━━━━\n
请求示例：http://<?php echo $_SERVER['HTTP_HOST'];?>/tianyi/pcmnt.php\n
━━━━━━━━━\n
