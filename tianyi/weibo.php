...
<?php @$weibo = intval(file_get_contents("../api/tongji/jiekou/weibo.dat")); ?>
<?php @$weibox = intval(file_get_contents("../api/tongji/jinri/".date("Y-m-d")."/weibo.dat")); ?>
...
<title>微博用户信息获取 - <?php echo $ming; ?>API</title>
...
<span class="url" data-clipboard-text="http://<?php echo $_SERVER['HTTP_HOST'];?>/api/weibo.php">http://<?php echo $_SERVER['HTTP_HOST'];?>/api/weibo.php</span>
</p>
<p class="simpleTable">
...
<span class="url" data-clipboard-text="http://<?php echo $_SERVER['HTTP_HOST'];?>/api/weibo.php?uid=7639082670">http://<?php echo $_SERVER['HTTP_HOST'];?>/api/weibo.php?uid=7639082670</span>
</p>
...
$result = file_get_contents("http://".$_SERVER['HTTP_HOST']."/api/weibo.php?uid=7639082670");
echo $result;
?></pre>
</div>
...
<pre class="layui-code"><a style="color:#fd4b5c;text-decoration:none；" target="_blank">微博用户信息获取
<?php echo $ming; ?>API微博用户信息获取\n
━━━━━━━━━\n
用户:@%昵称%\n
━━━━━━━━━\n
微博用户信息获取 [UID]\n
━━━━━━━━━\n
请求示例：http://<?php echo $_SERVER['HTTP_HOST'];?>/tianyi/weibo.php\n
━━━━━━━━━\n
Tips:<?php echo $ming; ?>API技术支持

微博用户信息获取 .*
$访问 http://<?php echo $_SERVER['HTTP_HOST'];?>/api/weibo.php?uid=%参数1%$</per>
</div>
</div>
</div>
</div>
