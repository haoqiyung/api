...
<?php @$jdyl = intval(file_get_contents("../api/tongji/jiekou/jdyl.dat")); ?>
<?php @$jdylx = intval(file_get_contents("../api/tongji/jinri/".date("Y-m-d")."/jdyl.dat")); ?>
...
<title>经典语录 - <?php echo $ming; ?>API</title>
...
<legend>经典语录API</legend>
</fieldset>
<blockquote class="layui-elem-quote">本接口总调用：<?php echo $jdyl; ?>次·今日调用：<?php echo $jdylx; ?>次</blockquote>
</div>
...
<span class="url" data-clipboard-text="http://<?php echo $_SERVER['HTTP_HOST'];?>/api/jdyl.php">http://<?php echo $_SERVER['HTTP_HOST'];?>/api/jdyl.php</span>
</p>
<p class="simpleTable">
...
$result = file_get_contents("http://".$_SERVER['HTTP_HOST']."/api/jdyl.php");
echo $result;
?></pre>
</div>
...
<pre class="layui-code"><a style="color:#fd4b5c;text-decoration:none；" target="_blank">经典语录
$访问 http://<?php echo $_SERVER['HTTP_HOST'];?>/api/jdyl.php$</per>
</div>
</div>
</div>
</div>
