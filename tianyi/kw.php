...
<?php @$kw = intval(file_get_contents("../api/tongji/jiekou/kw.dat")); ?>
<?php @$kwx = intval(file_get_contents("../api/tongji/jinri/".date("Y-m-d")."/kw.dat")); ?>
...
<title>酷我音乐 - <?php echo $ming; ?>API</title>
...
<legend>酷我音乐API</legend>
</fieldset>
<blockquote class="layui-elem-quote">本接口总调用：<?php echo $kw; ?>次·今日调用：<?php echo $kwx; ?>次</blockquote>
</div>
...
<span class="url" data-clipboard-text="http://<?php echo $_SERVER['HTTP_HOST'];?>/api/kw.php">http://<?php echo $_SERVER['HTTP_HOST'];?>/api/kw.php</span>
</p>
<p class="simpleTable">
...
<span class="url" data-clipboard-text="http://<?php echo $_SERVER['HTTP_HOST'];?>/api/kw.php?msg=吉云&b=1&m=text">http://<?php echo $_SERVER['HTTP_HOST'];?>/api/kw.php?msg=吉云&b=1&m=text</span>
</p>
...
<tr><td>m</td><td>否</td><td>输出方式(text/xml/json)</td></tr>
...
$result = file_get_contents("http://".$_SERVER['HTTP_HOST']."/api/kw.php?msg=吉云&b=1&m=text");
echo $result;
?></pre>
</div>
...
<pre class="layui-code"><a style="color:#fd4b5c;text-decoration:none；" target="_blank">酷我音乐
<?php echo $ming; ?>API酷我音乐\n
━━━━━━━━━\n
用户:@%昵称%\n
━━━━━━━━━\n
酷我音乐 [名字]\n
━━━━━━━━━\n
请求示例：http://<?php echo $_SERVER['HTTP_HOST'];?>/tianyi/kw.php\n
━━━━━━━━━\n
Tips:<?php echo $ming; ?>API技术支持

酷我音乐 .*
$写 <?php echo $ming; ?>API/%群号%/%QQ% 酷我音乐 %参数1%$
$访问 http://<?php echo $_SERVER['HTTP_HOST'];?>/api/kw.php?msg=%参数1%$

选酷我音乐 .*
y:$读 <?php echo $ming; ?>API/%群号%/%QQ% 酷我音乐 %参数1%$
$访问 http://<?php echo $_SERVER['HTTP_HOST'];?>/api/kw.php?msg=%y%&b=%参数1%&m=text$</per>
</div>
</div>
</div>
</div>
