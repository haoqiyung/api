...
<?php @$baoshi = intval(file_get_contents("../api/tongji/jiekou/baoshi.dat")); ?>
<?php @$baoshix = intval(file_get_contents("../api/tongji/jinri/".date("Y-m-d")."/baoshi.dat")); ?>
...
<title>报时音乐 - <?php echo $ming; ?>API</title>
<meta name="keywords" content=""/>
<meta name="description" content="">    
<link rel="stylesheet" href="./assets/css/layer.css">
<script src="https://ku.oioweb.cn/LayUI/2.5.4/layui.all.js"></script>
<style>.url{word-break:break-all;cursor:pointer;margin-left:5px;color:#777;border:none;border-radius:0;border-bottom:2px solid #5FB878;}.simpleTable{line-height:20px;padding-bottom:16px;}.linep{font-size:14px;font-weight:700;color:#555;padding-left:14px;height:16px;line-height:16px;margin-bottom:18px;position:relative;margin-top:15px;}.linep:before{content:'';width:4px;height:16px;background:#00aeff;border-radius:2px;position:absolute;left:0;top:0;}::-webaoshiit-scrollbar{width:9px;height:9px}::-webaoshiit-scrollbar-track-piece{background-color:#ebebeb;-webaoshiit-border-radius:4px}::-webaoshiit-scrollbar-thumb:vertical{height:32px;background-color:#ccc;-webaoshiit-border-radius:4px}::-webaoshiit-scrollbar-thumb:horizontal{width:32px;background-color:#ccc;-webaoshiit-border-radius:4px}</style>
</head>
<body>
<div class="layui-container">
<div class="layui-row">
<fieldset class="layui-elem-field layui-field-title" style="margin-top: 20px;">
<legend>报时音乐API</legend>
</fieldset>
<blockquote class="layui-elem-quote">本接口总调用：<?php echo $baoshi; ?>次·今日调用：<?php echo $baoshix; ?>次</blockquote>
</div>
...
<span class="url" data-clipboard-text="http://<?php echo $_SERVER['HTTP_HOST'];?>/api/baoshi.php">http://<?php echo $_SERVER['HTTP_HOST'];?>/api/baoshi.php</span>
</p>
<p class="simpleTable">
...
<span class="url" data-clipboard-text="http://<?php echo $_SERVER['HTTP_HOST'];?>/api/baoshi.php?msg=19:00">http://<?php echo $_SERVER['HTTP_HOST'];?>/api/baoshi.php?msg=19:00</span>
</p>
...
<tbody>
<tr><td>msg</td><td>是</td><td>输整点时间(默认19:00)</td></tr>
</tbody>
</table>
...
$result = file_get_contents("http://".$_SERVER['HTTP_HOST']."/api/baoshi.php?msg=19:00");
echo $result;
?></pre>
</div>
