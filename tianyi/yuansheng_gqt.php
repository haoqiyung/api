...
<?php @$yuansheng_gqt = intval(file_get_contents("../api/tongji/jiekou/yuansheng_gqt.dat")); ?>
<?php @$yuansheng_gqtx = intval(file_get_contents("../api/tongji/jinri/".date("Y-m-d")."/yuansheng_gqt.dat")); ?>
...
<title>原神随机图 - <?php echo $ming; ?>API</title>
...
<legend>原神随机图API</legend>
</fieldset>
<blockquote class="layui-elem-quote">本接口总调用：<?php echo $yuansheng_gqt; ?>次·今日调用：<?php echo $yuansheng_gqtx; ?>次</blockquote>
</div>
...
<span class="url" data-clipboard-text="http://<?php echo $_SERVER['HTTP_HOST'];?>/api/yuansheng_gqt.php">http://<?php echo $_SERVER['HTTP_HOST'];?>/api/yuansheng_gqt.php</span>
</p>
<p class="simpleTable">
...
<pre class="layui-code"><img src="../api/yuansheng_gqt.php" style="width: 45%;"></pre>
</div>
...
<pre class="layui-code"><a style="color:#fd4b5c;text-decoration:none；" target="_blank">原神随机图
<?php echo $ming; ?>API原神随机图\n
━━━━━━━━━\n
用户:@%昵称%\n
━━━━━━━━━\n
±img=http://<?php echo $_SERVER['HTTP_HOST'];?>/api/yuansheng_gqt.php±\n
━━━━━━━━━\n
请求示例：http://<?php echo $_SERVER['HTTP_HOST'];?>/tianyi/yuansheng_gqt.php\n
━━━━━━━━━\n
