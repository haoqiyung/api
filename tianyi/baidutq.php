...
<?php @$baidutq = intval(file_get_contents("../api/tongji/jiekou/baidutq.dat")); ?>
<?php @$baidutqx = intval(file_get_contents("../api/tongji/jinri/".date("Y-m-d")."/baidutq.dat")); ?>
...
<title>百度天气 - <?php echo $ming; ?>API</title>
...
<legend>百度天气API</legend>
</fieldset>
<blockquote class="layui-elem-quote">本接口总调用：<?php echo $baidutq; ?>次·今日调用：<?php echo $baidutqx; ?>次</blockquote>
</div>
...
<span class="url" data-clipboard-text="http://<?php echo $_SERVER['HTTP_HOST'];?>/api/baidutq.php">http://<?php echo $_SERVER['HTTP_HOST'];?>/api/baidutq.php</span>
</p>
<p class="simpleTable">
...
<span class="url" data-clipboard-text="http://<?php echo $_SERVER['HTTP_HOST'];?>/api/baidutq.php?msg=农安&type=text">http://<?php echo $_SERVER['HTTP_HOST'];?>/api/baidutq.php?msg=农安&type=text</span>
</p>
...
<tbody>
<tr><td>msg</td><td>是</td><td>需要查询的地区</td></tr>
<tr><td>type</td><td>是</td><td>返回格式(可选text、json)</td></tr>
</tbody>
</table>
...
$result = file_get_contents("http://".$_SERVER['HTTP_HOST']."/api/baidutq.php?msg=农安&type=text");
echo $result;
?></pre>
</div>
...
<pre class="layui-code"><a style="color:#fd4b5c;text-decoration:none；" target="_blank">百度天气
<?php echo $ming; ?>API百度天气\n
━━━━━━━━━\n
用户:@%昵称%\n
━━━━━━━━━\n
百度天气 [地区名]\n
━━━━━━━━━\n
请求示例：http://<?php echo $_SERVER['HTTP_HOST'];?>/tianyi/baidutq.php\n
━━━━━━━━━\n
...
用户:@%昵称%\n
━━━━━━━━━\n
$访问 http://<?php echo $_SERVER['HTTP_HOST'];?>/api/baidutq.php?msg=%参数1%&type=text$\n
━━━━━━━━━\n
