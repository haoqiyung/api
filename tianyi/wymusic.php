...
<?php @$wymusic = intval(file_get_contents("../api/tongji/jiekou/wymusic.dat")); ?>
<?php @$wymusicx = intval(file_get_contents("../api/tongji/jinri/".date("Y-m-d")."/wymusic.dat")); ?>
...
<title>网易云音乐解析 - <?php echo $ming; ?>API</title>
...
<legend>网易云音乐解析API</legend>
</fieldset>
<blockquote class="layui-elem-quote">本接口总调用：<?php echo $wymusic; ?>次·今日调用：<?php echo $wymusicx; ?>次</blockquote>
</div>
...
<span class="url" data-clipboard-text="http://<?php echo $_SERVER['HTTP_HOST'];?>/api/wymusic.php">http://<?php echo $_SERVER['HTTP_HOST'];?>/api/wymusic.php</span>
</p>
<p class="simpleTable">
...
<span class="url" data-clipboard-text="http://<?php echo $_SERVER['HTTP_HOST'];?>/api/wymusic.php?id=277382">http://<?php echo $_SERVER['HTTP_HOST'];?>/api/wymusic.php?id=277382</span>
</p>
...
<tbody>
<tr><td>id</td><td>是</td><td>输网易云音乐的歌曲ID</td></tr>
</tbody>
</table>
...
<pre class="layui-code">本API直接跳转音乐</pre>
</div>
