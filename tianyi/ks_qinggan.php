...
<title>快手情感视频 - <?php echo $ming; ?>API</title>
...
<span class="url" data-clipboard-text="http://<?php echo $_SERVER['HTTP_HOST'];?>/api/ks_qinggan.php">http://<?php echo $_SERVER['HTTP_HOST'];?>/api/ks_qinggan.php</span>
</p>
<p class="simpleTable">
...
<tbody>
<tr><td>lx</td><td>否</td><td>输(推荐/生活/课堂/语录)(默认推荐)</td></tr>
<tr><td>type</td><td>否</td><td>输出方式(text/xml/json/js/jsx)(默认text)</td></tr>
...
$result = file_get_contents("http://".$_SERVER['HTTP_HOST']."/api/ks_qinggan.php");
echo $result;
?></pre>
</div>
...
<pre class="layui-code"><a style="color:#fd4b5c;text-decoration:none；" target="_blank">快手情感视频
<?php echo $ming; ?>API快手情感视频\n
━━━━━━━━━\n
用户:@%昵称%\n
━━━━━━━━━\n
$访问 http://<?php echo $_SERVER['HTTP_HOST'];?>/api/ks_qinggan.php$\n
━━━━━━━━━\n
请求示例：http://<?php echo $_SERVER['HTTP_HOST'];?>/tianyi/ks_qinggan.php\n
━━━━━━━━━\n
