...
<?php @$yyb = intval(file_get_contents("../api/tongji/jiekou/yyb.dat")); ?>
<?php @$yybx = intval(file_get_contents("../api/tongji/jinri/".date("Y-m-d")."/yyb.dat")); ?>
...
<title>应用宝 - <?php echo $ming; ?>API</title>
...
<legend>应用宝API</legend>
</fieldset>
<blockquote class="layui-elem-quote">本接口总调用：<?php echo $yyb; ?>次·今日调用：<?php echo $yybx; ?>次</blockquote>
</div>
...
<span class="url" data-clipboard-text="http://<?php echo $_SERVER['HTTP_HOST'];?>/api/yyb.php">http://<?php echo $_SERVER['HTTP_HOST'];?>/api/yyb.php</span>
</p>
<p class="simpleTable">
...
<span class="url" data-clipboard-text="http://<?php echo $_SERVER['HTTP_HOST'];?>/api/yyb.php?msg=QQ&b=1">http://<?php echo $_SERVER['HTTP_HOST'];?>/api/yyb.php?msg=QQ&b=1</span>
</p>
...
<tbody>
<tr><td>msg</td><td>是</td><td>需要搜索的应用名</td></tr>
...
$result = file_get_contents("http://".$_SERVER['HTTP_HOST']."/api/yyb.php?msg=QQ&b=1");
echo $result;
?></pre></div>
...
<pre class="layui-code"><a style="color:#fd4b5c;text-decoration:none；" target="_blank">应用宝
<?php echo $ming; ?>API应用宝\n
━━━━━━━━━\n
用户:@%昵称%\n
━━━━━━━━━\n
应用宝 [内容]\n
━━━━━━━━━\n
请求示例：http://<?php echo $_SERVER['HTTP_HOST'];?>/tianyi/yyb.php\n
━━━━━━━━━\n
Tips:<?php echo $ming; ?>API技术支持

应用宝 .*
$写 <?php echo $ming; ?>API/%群号%/%QQ% 应用宝 %参数1%$
$访问 http://<?php echo $_SERVER['HTTP_HOST'];?>/api/yyb.php?msg=%参数1%$

选应用宝 .*
p:$读 <?php echo $ming; ?>API/%群号%/%QQ% 应用宝 %参数1%$
$访问 http://<?php echo $_SERVER['HTTP_HOST'];?>/api/yyb.php?msg=%p%&b=%参数1%$</per>
</div>
</div>
</div>
</div>
