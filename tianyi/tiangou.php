...
<?php @$tiangou = intval(file_get_contents("../api/tongji/jiekou/tiangou.dat")); ?>
<?php @$tiangoux = intval(file_get_contents("../api/tongji/jinri/".date("Y-m-d")."/tiangou.dat")); ?>
...
<title>舔狗日记 - <?php echo $ming; ?>API</title>
...
<legend>舔狗日记API</legend>
</fieldset>
<blockquote class="layui-elem-quote">本接口总调用：<?php echo $tiangou; ?>次·今日调用：<?php echo $tiangoux; ?>次</blockquote>
</div>
...
<span class="url" data-clipboard-text="http://<?php echo $_SERVER['HTTP_HOST'];?>/api/tiangou.php">http://<?php echo $_SERVER['HTTP_HOST'];?>/api/tiangou.php</span>
</p>
<p class="simpleTable">
...
$result = file_get_contents("http://".$_SERVER['HTTP_HOST']."/api/tiangou.php");
echo $result;
?></pre></div>
...
<pre class="layui-code"><a style="color:#fd4b5c;text-decoration:none；" target="_blank">舔狗日记
$访问 http://<?php echo $_SERVER['HTTP_HOST'];?>/api/tiangou.php$</per>
</div>
</div>
</div>
</div>
