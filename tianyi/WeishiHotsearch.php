...
<?php @$WeishiHotsearch = intval(file_get_contents("../api/tongji/jiekou/WeishiHotsearch.dat")); ?>
<?php @$WeishiHotsearchx = intval(file_get_contents("../api/tongji/jinri/".date("Y-m-d")."/WeishiHotsearch.dat")); ?>
...
<title>微视热搜榜获取 - <?php echo $ming; ?>API</title>
...
<legend>微视热搜榜获取API</legend>
</fieldset>
<blockquote class="layui-elem-quote">本接口总调用：<?php echo $WeishiHotsearch; ?>次·今日调用：<?php echo $WeishiHotsearchx; ?>次</blockquote>
</div>
...
<span class="url" data-clipboard-text="http://<?php echo $_SERVER['HTTP_HOST'];?>/api/WeishiHotsearch.php">http://<?php echo $_SERVER['HTTP_HOST'];?>/api/WeishiHotsearch.php</span>
</p>
<p class="simpleTable">
...
$result = file_get_contents("http://".$_SERVER['HTTP_HOST']."/api/WeishiHotsearch.php");
echo $result;
?></pre>
</div>
...
<pre class="layui-code"><a style="color:#fd4b5c;text-decoration:none；" target="_blank">微视热搜榜获取
$访问 http://<?php echo $_SERVER['HTTP_HOST'];?>/api/WeishiHotsearch.php$</per>
</div>
</div>
</div>
</div>
