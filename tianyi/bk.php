...
<?php @$bk = intval(file_get_contents("../api/tongji/jiekou/bk.dat")); ?>
<?php @$bkx = intval(file_get_contents("../api/tongji/jinri/".date("Y-m-d")."/bk.dat")); ?>
...
<title>百度百科 - <?php echo $ming; ?>API</title>
...
<legend>百度百科API</legend>
</fieldset>
<blockquote class="layui-elem-quote">本接口总调用：<?php echo $bk; ?>次·今日调用：<?php echo $bkx; ?>次</blockquote>
</div>
...
<span class="url" data-clipboard-text="http://<?php echo $_SERVER['HTTP_HOST'];?>/api/bk.php">http://<?php echo $_SERVER['HTTP_HOST'];?>/api/bk.php</span>
</p>
<p class="simpleTable">
...
<span class="url" data-clipboard-text="http://<?php echo $_SERVER['HTTP_HOST'];?>/api/bk.php?msg=星座">http://<?php echo $_SERVER['HTTP_HOST'];?>/api/bk.php?msg=星座</span>
</p>
...
<tbody>
<tr><td>msg</td><td>是</td><td>需要百科的问题</td></tr>
...
$result = file_get_contents("http://".$_SERVER['HTTP_HOST']."/api/bk.php?msg=星座");
echo $result;
?></pre>
</div>
...
<pre class="layui-code"><a style="color:#fd4b5c;text-decoration:none；" target="_blank">百度百科
<?php echo $ming; ?>API百度百科\n
━━━━━━━━━\n
用户:@%昵称%\n
━━━━━━━━━\n
百度百科 [内容]\n
━━━━━━━━━\n
请求示例：http://<?php echo $_SERVER['HTTP_HOST'];?>/tianyi/bk.php\n
━━━━━━━━━\n
Tips:<?php echo $ming; ?>API技术支持

百度百科 .*
$访问 http://<?php echo $_SERVER['HTTP_HOST'];?>/api/bk.php?msg=%参数1%$</per>
</div>
</div>
</div>
</div>
