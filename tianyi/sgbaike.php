...
<?php @$sgbaike = intval(file_get_contents("../api/tongji/jiekou/sgbaike.dat")); ?>
<?php @$sgbaikex = intval(file_get_contents("../api/tongji/jinri/".date("Y-m-d")."/sgbaike.dat")); ?>
...
<title>搜狗百科 - <?php echo $ming; ?>API</title>
...
<legend>搜狗百科API</legend>
</fieldset>
<blockquote class="layui-elem-quote">本接口总调用：<?php echo $sgbaike; ?>次·今日调用：<?php echo $sgbaikex; ?>次</blockquote>
</div>
...
<span class="url" data-clipboard-text="http://<?php echo $_SERVER['HTTP_HOST'];?>/api/sgbaike.php">http://<?php echo $_SERVER['HTTP_HOST'];?>/api/sgbaike.php</span>
</p>
<p class="simpleTable">
...
<span class="url" data-clipboard-text="http://<?php echo $_SERVER['HTTP_HOST'];?>/api/sgbaike.php?msg=星座">http://<?php echo $_SERVER['HTTP_HOST'];?>/api/sgbaike.php?msg=星座</span>
</p>
...
<tbody>
<tr><td>msg</td><td>是</td><td>要查询的词条名</td></tr>
<tr><td>type</td><td>否</td><td>返回格式，默认json，可选text</td></tr>
...
$result = file_get_contents("http://".$_SERVER['HTTP_HOST']."/api/sgbaike.php?msg=星座");
echo $result;
?></pre>
</div>
...
<pre class="layui-code"><a style="color:#fd4b5c;text-decoration:none；" target="_blank">搜狗百科
<?php echo $ming; ?>API搜狗百科\n
━━━━━━━━━\n
用户:@%昵称%\n
━━━━━━━━━\n
搜狗百科 [内容]\n
━━━━━━━━━\n
请求示例：http://<?php echo $_SERVER['HTTP_HOST'];?>/tianyi/sgbaike.php\n
━━━━━━━━━\n
Tips:<?php echo $ming; ?>API技术支持

搜狗百科 .*
$访问 http://<?php echo $_SERVER['HTTP_HOST'];?>/api/sgbaike.php?msg=%参数1%$</per>
</div>
</div>
</div>
</div>
