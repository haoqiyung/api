...
<?php @$hct = intval(file_get_contents("../api/tongji/jiekou/hct.dat")); ?>
<?php @$hctx = intval(file_get_contents("../api/tongji/jinri/".date("Y-m-d")."/hct.dat")); ?>
...
<blockquote class="layui-elem-quote">本接口总调用：<?php echo $hct; ?>次·今日调用：<?php echo $hctx; ?>次</blockquote>
</div>
...
<span class="url" data-clipboard-text="http://<?php echo $_SERVER['HTTP_HOST'];?>/api/dongman.php">http://<?php echo $_SERVER['HTTP_HOST'];?>/api/dongman.php</span>
</p>
<p class="simpleTable">
...
<span class="url" data-clipboard-text="http://<?php echo $_SERVER['HTTP_HOST'];?>/api/hct.php?id=美女&msg=吉云[换行]星猫">http://<?php echo $_SERVER['HTTP_HOST'];?>/api/hct.php?id=美女&msg=吉云[换行]星猫</span>
</p>
...
<tbody>
<tr><td>id</td><td>是</td><td>输(动漫/美女/风景)</td></tr>
<tr><td>msg</td><td>是</td><td>需要合成的输内容</td></tr>
</tbody>
</table>
...
<pre class="layui-code"><img src="../api/hct.php?id=美女&msg=吉云[换行]星猫" style="width: 45%;"></pre>
</div>
