...
<?php @$mjx = intval(file_get_contents("../api/tongji/jiekou/mjx.dat")); ?>
<?php @$mjxx = intval(file_get_contents("../api/tongji/jinri/".date("Y-m-d")."/mjx.dat")); ?>
...
<title>随机买家秀 - <?php echo $ming; ?>API</title>
...
<legend>随机买家秀API</legend>
</fieldset>
<blockquote class="layui-elem-quote">本接口总调用：<?php echo $mjx; ?>次·今日调用：<?php echo $mjxx; ?>次</blockquote>
</div>
...
<span class="url" data-clipboard-text="http://<?php echo $_SERVER['HTTP_HOST'];?>/api/mjx.php">http://<?php echo $_SERVER['HTTP_HOST'];?>/api/mjx.php</span>
</p>
<p class="simpleTable">
...
$result = file_get_contents("http://".$_SERVER['HTTP_HOST']."/api/mjx.php");
echo $result;
?></pre>
</div>
...
<pre class="layui-code"><a style="color:#fd4b5c;text-decoration:none；" target="_blank">随机买家秀
<?php echo $ming; ?>API随机买家秀\n
━━━━━━━━━\n
用户:@%昵称%\n
━━━━━━━━━\n
±img=$访问 http://<?php echo $_SERVER['HTTP_HOST'];?>/api/mjx.php$±\n
━━━━━━━━━\n
请求示例：http://<?php echo $_SERVER['HTTP_HOST'];?>/tianyi/mjx.php\n
━━━━━━━━━\n
