...
<?php @$LookIdiom = intval(file_get_contents("../api/tongji/jiekou/LookIdiom.dat")); ?>
<?php @$LookIdiomx = intval(file_get_contents("../api/tongji/jinri/".date("Y-m-d")."/LookIdiom.dat")); ?>
...
<title>看图猜成语 - <?php echo $ming; ?>API</title>
...
<legend>看图猜成语API</legend>
</fieldset>
<blockquote class="layui-elem-quote">本接口总调用：<?php echo $LookIdiom; ?>次·今日调用：<?php echo $LookIdiomx; ?>次</blockquote>
</div>
...
<span class="url" data-clipboard-text="http://<?php echo $_SERVER['HTTP_HOST'];?>/api/LookIdiom.php">http://<?php echo $_SERVER['HTTP_HOST'];?>/api/LookIdiom.php</span>
</p>
<p class="simpleTable">
...
$result = file_get_contents("http://".$_SERVER['HTTP_HOST']."/api/LookIdiom.php");
echo $result;
?></pre>
</div>
...
<pre class="layui-code"><a style="color:#fd4b5c;text-decoration:none；" target="_blank">看图猜成语
$访问 http://<?php echo $_SERVER['HTTP_HOST'];?>/api/LookIdiom.php</per>
</div>
</div>
</div>
</div>
