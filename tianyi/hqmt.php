...
<?php @$hqmt = intval(file_get_contents("../api/tongji/jiekou/hqmt.dat")); ?>
<?php @$hqmtx = intval(file_get_contents("../api/tongji/jinri/".date("Y-m-d")."/hqmt.dat")); ?>
...
<title>小妖精随机精选图 - <?php echo $ming; ?>API</title>
...
<legend>小妖精随机精选图API</legend>
</fieldset>
<blockquote class="layui-elem-quote">本接口总调用：<?php echo $hqmt; ?>次·今日调用：<?php echo $hqmtx; ?>次</blockquote>
</div>
...
<span class="url" data-clipboard-text="http://<?php echo $_SERVER['HTTP_HOST'];?>/api/hqmt.php">http://<?php echo $_SERVER['HTTP_HOST'];?>/api/hqmt.php</span>
</p>
<p class="simpleTable">
...
<tbody>
<tr><td>m</td><td>否</td><td>输0-362</td></tr>
...
$result = file_get_contents("http://".$_SERVER['HTTP_HOST']."/api/hqmt.php");
echo $result;
?></pre>
</div>
...
<pre class="layui-code"><a style="color:#fd4b5c;text-decoration:none；" target="_blank">小妖精随机精选图
$访问 http://<?php echo $_SERVER['HTTP_HOST'];?>/api/hqmt.php$</per>
</div>
</div>
</div>
</div>
