...
<?php @$check = intval(file_get_contents("../api/tongji/jiekou/check.dat")); ?>
<?php @$checkx = intval(file_get_contents("../api/tongji/jinri/".date("Y-m-d")."/check.dat")); ?>
...
<title>域名报毒检测 - <?php echo $ming; ?>API</title>
...
<legend>域名报毒检测API</legend>
</fieldset>
<blockquote class="layui-elem-quote">本接口总调用：<?php echo $check; ?>次·今日调用：<?php echo $checkx; ?>次</blockquote>
</div>
...
<span class="url" data-clipboard-text="http://<?php echo $_SERVER['HTTP_HOST'];?>/api/check.php">http://<?php echo $_SERVER['HTTP_HOST'];?>/api/check.php</span>
</p>
<p class="simpleTable">
...
<span class="url" data-clipboard-text="http://<?php echo $_SERVER['HTTP_HOST'];?>/api/check.php?url=https://cloud.vpsidc.com.cn">http://<?php echo $_SERVER['HTTP_HOST'];?>/api/check.php?url=https://cloud.vpsidc.com.cn</span>
</p>
...
$result = file_get_contents("http://".$_SERVER['HTTP_HOST']."/api/check.php?url=https://cloud.vpsidc.com.cn");
echo $result;
?></pre>
</div>
...
<pre class="layui-code"><a style="color:#fd4b5c;text-decoration:none；" target="_blank">域名报毒检测
<?php echo $ming; ?>API域名报毒检测\n
━━━━━━━━━\n
用户:@%昵称%\n
━━━━━━━━━\n
域名报毒检测 [网址]\n
━━━━━━━━━\n
请求示例：http://<?php echo $_SERVER['HTTP_HOST'];?>/tianyi/check.php\n
━━━━━━━━━\n
Tips:<?php echo $ming; ?>API技术支持

域名报毒检测 .*
$访问 http://<?php echo $_SERVER['HTTP_HOST'];?>/api/check.php?url=%参数1%$</per>
</div>
</div>
</div>
</div>
