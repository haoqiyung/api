...
<?php @$dog = intval(file_get_contents("../api/tongji/jiekou/dog.dat")); ?>
<?php @$dogx = intval(file_get_contents("../api/tongji/jinri/".date("Y-m-d")."/dog.dat")); ?>
...
<title>狗屁不通文章生成 - <?php echo $ming; ?>API</title>
...
<legend>狗屁不通文章生成API</legend>
</fieldset>
<blockquote class="layui-elem-quote">本接口总调用：<?php echo $dog; ?>次·今日调用：<?php echo $dogx; ?>次</blockquote>
</div>
...
<span class="url" data-clipboard-text="http://<?php echo $_SERVER['HTTP_HOST'];?>/api/dog.php">http://<?php echo $_SERVER['HTTP_HOST'];?>/api/dog.php</span>
</p>
<p class="simpleTable">
...
<span class="url" data-clipboard-text="http://<?php echo $_SERVER['HTTP_HOST'];?>/api/dog.php?msg=吉云&num=257">http://<?php echo $_SERVER['HTTP_HOST'];?>/api/dog.php?msg=吉云&num=257</span>
</p>
...
<tbody>
<tr><td>msg</td><td>是</td><td>文章主题</td></tr>
<tr><td>num</td><td>是</td><td>字数(默认200)</td></tr>
...
$result = file_get_contents("http://".$_SERVER['HTTP_HOST']."/api/dog.php?msg=吉云&num=257");
echo $result;
?></pre>
</div>
...
<pre class="layui-code"><a style="color:#fd4b5c;text-decoration:none；" target="_blank">狗屁不通文章生成
<?php echo $ming; ?>API狗屁不通文章生成\n
━━━━━━━━━\n
用户:@%昵称%\n
━━━━━━━━━\n
狗屁不通文章生成 [内容] [字数]\n
━━━━━━━━━\n
请求示例：http://<?php echo $_SERVER['HTTP_HOST'];?>/tianyi/dog.php\n
━━━━━━━━━\n
Tips:<?php echo $ming; ?>API技术支持</per>

狗屁不通文章生成 .*
$访问 http://<?php echo $_SERVER['HTTP_HOST'];?>/api/dog.php?msg=%参数1%&num=%参数2%$</per>
</div>
</div>
</div>
</div>
