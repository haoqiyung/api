...
<?php @$sjfc = intval(file_get_contents("../api/tongji/jiekou/sjfc.dat")); ?>
<?php @$sjfcx = intval(file_get_contents("../api/tongji/jinri/".date("Y-m-d")."/sjfc.dat")); ?>
...
<title>随机翻唱音乐 - <?php echo $ming; ?>API</title>
...
<legend>随机翻唱音乐API</legend>
</fieldset>
<blockquote class="layui-elem-quote">本接口总调用：<?php echo $sjfc; ?>次·今日调用：<?php echo $sjfcx; ?>次</blockquote>
</div>
...
<span class="url" data-clipboard-text="http://<?php echo $_SERVER['HTTP_HOST'];?>/api/sjfc.php">http://<?php echo $_SERVER['HTTP_HOST'];?>/api/sjfc.php</span>
</p>
<p class="simpleTable">
...
<tbody>
<tr><td>type</td><td>否</td><td>输出方式(text/xml/json/json1)(默认text)</td></tr>
...
$result = file_get_contents("http://".$_SERVER['HTTP_HOST']."/api/sjfc.php");
echo $result;
?></pre>
</div>
...
<pre class="layui-code"><a style="color:#fd4b5c;text-decoration:none；" target="_blank">随机翻唱音乐
$访问 http://<?php echo $_SERVER['HTTP_HOST'];?>/api/sjfc.php$</per>
</div>
</div>
</div>
</div>
