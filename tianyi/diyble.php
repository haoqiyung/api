...
<?php @$diyble = intval(file_get_contents("../api/tongji/jiekou/diyble.dat")); ?>
<?php @$diyblex = intval(file_get_contents("../api/tongji/jinri/".date("Y-m-d")."/diyble.dat")); ?>
...
<title>DIY超长气泡 - <?php echo $ming; ?>API</title>
...
<legend>DIY超长气泡API</legend>
</fieldset>
<blockquote class="layui-elem-quote">本接口总调用：<?php echo $diyble; ?>次·今日调用：<?php echo $diyblex; ?>次</blockquote>
</div>
...
<span class="url" data-clipboard-text="http://<?php echo $_SERVER['HTTP_HOST'];?>/api/diyble.php">http://<?php echo $_SERVER['HTTP_HOST'];?>/api/diyble.php</span>
</p>
<p class="simpleTable">
...
<span class="url" data-clipboard-text="http://<?php echo $_SERVER['HTTP_HOST'];?>/api/diyble.php?id=1&msg=吉云：https://cloud.vpsidc.com.cn">http://<?php echo $_SERVER['HTTP_HOST'];?>/api/diyble.php?id=1&msg=吉云：https://cloud.vpsidc.com.cn</span>
</p>
...
<tbody>
<tr><td>id</td><td>是</td><td>输数字(1-23)</td></tr>
<tr><td>msg</td><td>是</td><td>需要生成的文字</td></tr>
...
$result = file_get_contents("http://".$_SERVER['HTTP_HOST']."/api/diyble.php?id=1&msg=吉云：https://cloud.vpsidc.com.cn");
echo $result;
?></pre>
</div>
...
<pre class="layui-code"><a style="color:#fd4b5c;text-decoration:none；" target="_blank">DIY超长气泡
<?php echo $ming; ?>API♧DIY气泡\n
━━━━━━━━━\n
DIY超长气泡 [文字]\n
━━━━━━━━━\n
请求示例：http://<?php echo $_SERVER['HTTP_HOST'];?>/tianyi/diyble.php\n
━━━━━━━━━\n
Tips:<?php echo $ming; ?>API技术支持

DIY超长气泡 .*
w:%随机数1-23%
$访问 http://<?php echo $_SERVER['HTTP_HOST'];?>/api/diyble.php?id=%w%&msg=%参数1%$</per>
</div>
</div>
</div>
</div>
