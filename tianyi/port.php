...
<?php @$port = intval(file_get_contents("../api/tongji/jiekou/port.dat")); ?>
<?php @$portx = intval(file_get_contents("../api/tongji/jinri/".date("Y-m-d")."/port.dat")); ?>
...
<title>端口扫描 - <?php echo $ming; ?>API</title>
...
<legend>端口扫描API</legend>
</fieldset>
<blockquote class="layui-elem-quote">本接口总调用：<?php echo $port; ?>次·今日调用：<?php echo $portx; ?>次</blockquote>
</div>
...
<span class="url" data-clipboard-text="http://<?php echo $_SERVER['HTTP_HOST'];?>/api/port.php">http://<?php echo $_SERVER['HTTP_HOST'];?>/api/port.php</span>
</p>
<p class="simpleTable">
...
<span class="url" data-clipboard-text="http://<?php echo $_SERVER['HTTP_HOST'];?>/api/port.php?ip=cloud.vpsidc.com.cn">http://<?php echo $_SERVER['HTTP_HOST'];?>/api/port.php?ip=cloud.vpsidc.com.cn</span>
</p>
...
<tbody>
<tr><td>ip</td><td>是</td><td>需要查询的IP/域名</td></tr>
...
$result = file_get_contents("http://".$_SERVER['HTTP_HOST']."/api/port.php?ip=cloud.vpsidc.com.cn");
echo $result;
?></pre>
</div>
...
<pre class="layui-code"><a style="color:#fd4b5c;text-decoration:none；" target="_blank">端口扫描
<?php echo $ming; ?>API端口扫描\n
━━━━━━━━━\n
用户:@%昵称%\n
━━━━━━━━━\n
端口扫描 [域名/IP]\n
━━━━━━━━━\n
请求示例：http://<?php echo $_SERVER['HTTP_HOST'];?>/tianyi/port.php\n
━━━━━━━━━\n
Tips:<?php echo $ming; ?>API技术支持

端口扫描
$访问 http://<?php echo $_SERVER['HTTP_HOST'];?>/api/port.php?ip=%参数1%$</per>
</div>
</div>
</div>
</div>
