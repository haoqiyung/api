...
<title>堆糖随机图片 - <?php echo $ming; ?>API</title>
...
<span class="url" data-clipboard-text="http://<?php echo $_SERVER['HTTP_HOST'];?>/api/duitang.php">http://<?php echo $_SERVER['HTTP_HOST'];?>/api/duitang.php</span>
</p>
<p class="simpleTable">
...
<tbody>
<tr><td>lx</td><td>否</td><td>输(壁纸/风景/头像/动漫/动图/文字/萌宠/时尚/婚礼/旅行/摄影)</td></tr>
<tr><td>type</td><td>否</td><td>输出方式text.xml.json.json1</td></tr>
...
$result = file_get_contents("http://".$_SERVER['HTTP_HOST']."/api/duitang.php");
echo $result;
?></pre>
</div>
...
<pre class="layui-code"><a style="color:#fd4b5c;text-decoration:none；" target="_blank">堆糖随机图片
<?php echo $ming; ?>API堆糖随机图片\n
━━━━━━━━━\n
用户:@%昵称%\n
━━━━━━━━━\n
$访问 http://<?php echo $_SERVER['HTTP_HOST'];?>/api/duitang.php$\n
━━━━━━━━━\n
请求示例：http://<?php echo $_SERVER['HTTP_HOST'];?>/tianyi/duitang.php\n
━━━━━━━━━\n
