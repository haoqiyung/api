...
<?php @$sgyl = intval(file_get_contents("../api/tongji/jiekou/sgyl.dat")); ?>
<?php @$sgylx = intval(file_get_contents("../api/tongji/jinri/".date("Y-m-d")."/sgyl.dat")); ?>
...
<title>伤感语录 - <?php echo $ming; ?>API</title>
...
<legend>伤感语录API</legend>
</fieldset>
<blockquote class="layui-elem-quote">本接口总调用：<?php echo $sgyl; ?>次·今日调用：<?php echo $sgylx; ?>次</blockquote>
</div>
...
<span class="url" data-clipboard-text="http://<?php echo $_SERVER['HTTP_HOST'];?>/api/sgyl.php">http://<?php echo $_SERVER['HTTP_HOST'];?>/api/sgyl.php</span>
</p>
<p class="simpleTable">
...
$result = file_get_contents("http://".$_SERVER['HTTP_HOST']."/api/sgyl.php");
echo $result;
?></pre></div>
...
<pre class="layui-code"><a style="color:#fd4b5c;text-decoration:none；" target="_blank">伤感语录
$访问 http://<?php echo $_SERVER['HTTP_HOST'];?>/api/sgyl.php$</per>
</div>
</div>
</div>
</div>
