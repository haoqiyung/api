...
<?php @$meinv = intval(file_get_contents("../api/tongji/jiekou/meinv.dat")); ?>
<?php @$meinvx = intval(file_get_contents("../api/tongji/jinri/".date("Y-m-d")."/meinv.dat")); ?>
...
<title>美女图片大全 - <?php echo $ming; ?>API</title>
...
<legend>美女图片大全API</legend>
</fieldset>
<blockquote class="layui-elem-quote">本接口总调用：<?php echo $meinv; ?>次·今日调用：<?php echo $meinvx; ?>次</blockquote>
</div>
...
<span class="url" data-clipboard-text="http://<?php echo $_SERVER['HTTP_HOST'];?>/api/meinv.php">http://<?php echo $_SERVER['HTTP_HOST'];?>/api/meinv.php</span>
</p>
<p class="simpleTable">
...
<span class="url" data-clipboard-text="http://<?php echo $_SERVER['HTTP_HOST'];?>/api/meinv.php?msg=美女">http://<?php echo $_SERVER['HTTP_HOST'];?>/api/meinv.php?msg=美女</span>
</p>
...
<tbody>
<tr><td>msg</td><td>是</td><td>输(美女/粉色/清新/熊/可爱)</td></tr>
...
$result = file_get_contents("http://".$_SERVER['HTTP_HOST']."/api/meinv.php?msg=美女");
echo $result;
?></pre>
</div>
...
<pre class="layui-code"><a style="color:#fd4b5c;text-decoration:none；" target="_blank">美女图片大全
<?php echo $ming; ?>API美女图片大全\n
━━━━━━━━━\n
用户:@%昵称%\n
━━━━━━━━━\n
美女图片大全 [输(美女, 粉色, 清新, 熊, 可爱)]\n
━━━━━━━━━\n
请求示例：http://<?php echo $_SERVER['HTTP_HOST'];?>/tianyi/meinv.php\n
━━━━━━━━━\n
Tips:<?php echo $ming; ?>API技术支持

美女图片大全 .*
$访问 http://<?php echo $_SERVER['HTTP_HOST'];?>/api/meinv.php?msg=%参数1%$</per>
</div>
</div>
</div>
</div>
