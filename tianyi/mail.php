...
<title>邮件发送 - <?php echo $ming; ?>API</title>
...
<span class="url" data-clipboard-text="http://<?php echo $_SERVER['HTTP_HOST'];?>/api/mail.php">http://<?php echo $_SERVER['HTTP_HOST'];?>/api/mail.php</span>
</p>
<p class="simpleTable">
...
<span class="url" data-clipboard-text="http://<?php echo $_SERVER['HTTP_HOST'];?>/api/mail/mail.php?address=3189402257@qq.com&name=你好,世界&certno=天一API邮件发送<br>━━━━━━━━━<br>天一API发信成功<br>━━━━━━━━━<br>Tips:天一API技术支持">http://<?php echo $_SERVER['HTTP_HOST'];?>/api/mail/mail.php?address=3189402257@qq.com&name=你好,世界&certno=天一API邮件发送<br>━━━━━━━━━<br>天一API发信成功<br>━━━━━━━━━<br>Tips:天一API技术支持</span>
</p>
<p class="simpleTable">
<span class="layui-badge layui-bg-blue">备注：</span>
<span class="url" data-clipboard-text="公共API邮件接口，请勿频繁发送垃圾邮件，此外邮件可能在垃圾箱里面，此API邮件含IP记录+邮件统计，一经发现频繁灌水拉黑邮箱和IP！">公共API邮件接口，请勿频繁发送垃圾邮件，此外邮件可能在垃圾箱里面，此API邮件含IP记录+邮件统计，一经发现频繁灌水拉黑邮箱和IP！</span>
</p>
...
<tbody>
<tr><td>address</td><td>是</td><td>收件人邮箱地址</td></tr>
<tr><td>name</td><td>是</td><td>邮箱标题</td></tr>
<tr><td>certno</td><td>是</td><td>邮件内容(支持HTML格式)</td></tr>
</tbody>
</table>
...
$result = file_get_contents("http://".$_SERVER['HTTP_HOST']."/api/mail/mail.php?address=3189402257@qq.com&name=你好,世界&certno=天一API邮件发送<br>━━━━━━━━━<br>天一API发信成功<br>━━━━━━━━━<br>Tips:天一API技术支持");
echo $result;
?></pre>
</div>
