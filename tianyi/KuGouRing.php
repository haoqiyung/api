...
<?php @$KuGouRing = intval(file_get_contents("../api/tongji/jiekou/KuGouRing.dat")); ?>
<?php @$KuGouRingx = intval(file_get_contents("../api/tongji/jinri/".date("Y-m-d")."/KuGouRing.dat")); ?>
...
<blockquote class="layui-elem-quote">本接口总调用：<?php echo $KuGouRing; ?>次·今日调用：<?php echo $KuGouRingx; ?>次</blockquote>
</div>
...
<span class="url" data-clipboard-text="http://<?php echo $_SERVER['HTTP_HOST'];?>/api/KuGouRing.php">http://<?php echo $_SERVER['HTTP_HOST'];?>/api/KuGouRing.php</span>
</p>
<p class="simpleTable">
...
<span class="url" data-clipboard-text="http://<?php echo $_SERVER['HTTP_HOST'];?>/api/KuGouRing.php?msg=吉云&b=1">http://<?php echo $_SERVER['HTTP_HOST'];?>/api/KuGouRing.php?msg=吉云&b=1</span>
</p>
...
<tr><td>songname</td><td>歌曲名</td></tr>
<tr><td>singer</td><td>作者名</td></tr>
<tr><td>url</td><td>播放链接</td></tr>
</tbody>
</table>
<p class="linep">返回示例：</p>
<pre class="layui-code"><?php
//header("Content-Type:text/html;charset=UTF-8");
$result = file_get_contents("http://".$_SERVER['HTTP_HOST']."/api/KuGouRing.php?msg=吉云&b=1");
echo $result;
?></pre>
</div>
...
<tr><td>1001</td><td>请输入关键词</td></tr>
<tr><td>1002</td><td>抱歉，找不到相关内容</td></tr>
</tbody>
</table>
</div>
<div class="layui-tab-item">
