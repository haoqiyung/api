...
<?php @$dujitang = intval(file_get_contents("../api/tongji/jiekou/dujitang.dat")); ?>
<?php @$dujitangx = intval(file_get_contents("../api/tongji/jinri/".date("Y-m-d")."/dujitang.dat")); ?>
...
<title>毒鸡汤 - <?php echo $ming; ?>API</title>
...
<legend>毒鸡汤API</legend>
</fieldset>
<blockquote class="layui-elem-quote">本接口总调用：<?php echo $dujitang; ?>次·今日调用：<?php echo $dujitangx; ?>次</blockquote>
</div>
...
<span class="url" data-clipboard-text="http://<?php echo $_SERVER['HTTP_HOST'];?>/api/dujitang.php">http://<?php echo $_SERVER['HTTP_HOST'];?>/api/dujitang.php</span>
</p>
<p class="simpleTable">
...
$result = file_get_contents("http://".$_SERVER['HTTP_HOST']."/api/dujitang.php");
echo $result;
?></pre>
</div>
...
<pre class="layui-code"><a style="color:#fd4b5c;text-decoration:none；" target="_blank">毒鸡汤
$访问 http://<?php echo $_SERVER['HTTP_HOST'];?>/api/dujitang.php$</per>
</div>
</div>
</div>
</div>
